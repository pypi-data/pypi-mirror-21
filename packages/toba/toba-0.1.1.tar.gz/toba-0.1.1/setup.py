...
setup(
    ...
    version='0.1.1',
    license='Apache2',
    description='Timeliness Ordered Byzantine Agreement',
    long_description='%s\n%s' % (
    ...
    url='https://smithsamuelm@bitbucket.org/prosapien/toba.git',
    ...
    keywords=[
        'Timeliness Ordered Byzantine Agreement', 'BFT', 'Ansynchronous',
    ],
    install_requires=[
        'click',
    ],

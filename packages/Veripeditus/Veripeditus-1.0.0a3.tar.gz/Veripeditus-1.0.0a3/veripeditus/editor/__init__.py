...
DIR_LIVE = os.path.join(current_app.config['CODE_EDITOR_PATH'], 'live')
DIR_WORK = os.path.join(current_app.config['CODE_EDITOR_PATH'], 'work')

if current_app.config['ENABLE_CODE_EDITOR']:

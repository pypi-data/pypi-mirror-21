...
class BebopFlightDataManager():
    ...
    def display_diagnostic_information_debug(self):
        ...
        diagnostic_information.append('City nearby: ' + str(self.get_nearest_city()))
    ...
    def diagnostic_information_raw(self):
        ...
        # city nearby - string
        diagnostic_information_list.append(self.get_nearest_city())
    ...
    def get_nearest_city(self):
        ...
        coordinates_as_string = str(self.controller_position).strip('[]')
        try:

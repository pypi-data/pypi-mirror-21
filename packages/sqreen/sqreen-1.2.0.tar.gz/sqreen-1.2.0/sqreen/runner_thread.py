...
from sqreen.frameworks.django_framework import DjangoRequest
from sqreen.frameworks.flask_framework import FlaskRequest
from sqreen.frameworks.pyramid_framework import PyramidRequest

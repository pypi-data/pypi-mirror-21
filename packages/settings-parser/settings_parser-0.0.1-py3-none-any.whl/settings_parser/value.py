...
class Value():
    ...
    def _check_val_max_min(self, value: T) -> None:
        ...
        try:
            ...
            msg = ('Value {} of type {}'.format(value,_get_clean_type_name(type(value))) +
    ...
    def _raise_wrong_type_error(self, value: ValType, val_type: ValType,
...
class DictValue():
    ...
    def __init__(self, values_list: List[ValType],
...
#                print(val)
                ...
                msg = 'Mandatory value "{}" not found in {}.'.format(val.name,
    ...
    def _check_extra_and_exclusive(self, config_dict: Dict) -> None:
        ...
        try:
            ...
            msg = 'Section is empty or otherwise invalid!'

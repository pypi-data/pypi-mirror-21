...
class Sensor(DynamicNumber):
    ...
    """
    def __init__(self, sensor_id, name, device=None, use_thread=True, parent=None, index=None, reading_interval=1):
        ...
        if use_thread:
            self._sensor_thread = _SensorThread(self, reading_interval)
        else:

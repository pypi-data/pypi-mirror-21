...
class LogicIOChannel(DynamicBoolean):
    ...
    def _input_rising(self):
        self.set(True)

    def _input_falling(self):
        self.set(False)

    def define_as_input(self, pullup=False, bounce_time=200):
        self.is_input = False
        self._device.define_as_input(self._channel, pullup)
        self._device.listen_rising(self._channel, self._input_rising, bounce_time)
        self._device.listen_falling(self._channel, self._input_falling, bounce_time)

...
class Base(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            '--save_report_for_later', action="store_true",
            dest='save_report_for_later',
            default=False,
    ...
    def configure(self, options, conf):
        ...
        self.save_report_for_later = options.save_report_for_later
    ...
    def add_fails_or_errors(self, test, err):
        ...
        self.page_results_list.append(
            report_helper.process_failures(test, err, self.test_count))

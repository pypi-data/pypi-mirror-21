...
class SegmentSparseMatrix32(object):
    ...
    def nCells(self):
        """nCells(self) -> nupic::SegmentMatrixAdapter< nupic::SparseMatrix< unsigned long,float,long,double,nupic::DistanceToZero< float > > >::size_type"""
        return _math.SegmentSparseMatrix32_nCells(self)


    def nSegments(self):
        """nSegments(self) -> nupic::SegmentMatrixAdapter< nupic::SparseMatrix< unsigned long,float,long,double,nupic::DistanceToZero< float > > >::size_type"""
        return _math.SegmentSparseMatrix32_nSegments(self)


    def createSegment(self, cell):
        """createSegment(self, cell) -> nupic::SegmentMatrixAdapter< nupic::SparseMatrix< unsigned long,float,long,double,nupic::DistanceToZero< float > > >::size_type"""

...
__version__ = '$Id: f99972e649010e4fd0822021c8af9666e0d94c9a $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: f99972e649010e4fd0822021c8af9666e0d94c9a $`
        # or `$Id: f99972e649010e4fd0822021c8af9666e0d94c9a $`.
        m = re.search(r"\$Id"

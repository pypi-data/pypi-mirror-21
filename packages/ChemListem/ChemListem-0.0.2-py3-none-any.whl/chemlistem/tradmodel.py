...
class TradModel(object):
	...
	def train(self, textfile, annotfile, glovefile, runname):
		...
		bll = Bidirectional(LSTM(64, return_sequences=True, dropout=0.5, recurrent_dropout=0.5, kernel_regularizer=l1_l2(l1=0.000001, l2=0.000001)), merge_mode="concat", name="lstm")(ml)

...
ma = 7.3581046900000002
mi = -0.31801041000000002
...
def main():
    ...
    extractor = EyeGraph(distances = [50, 75, 100, 125, 150, 175, 200, 225, 250, 275],
                         n_points  = 20,
                         landmark_offset=20)
    
    background_model_path = pkg_resources.resource_filename("bob.bio.pericrosseye_competition.test", 'data/background_gfk_10d.hdf5')

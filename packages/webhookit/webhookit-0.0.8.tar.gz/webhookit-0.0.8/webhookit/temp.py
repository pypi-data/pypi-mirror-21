...
<body>
  ...
  <pre>Trigger count <strong>{{count}}</strong>. Last trigger at <strong>{{date or 'None'}}</strong> on <strong>{{repo or 'None'}}</strong>.</pre>
  ...
  <script type="text/javascript">
    document.getElementById("webhook_url").innerHTML = location.href + "webhookit"
  </script>

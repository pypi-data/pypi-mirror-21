...
# Subtract by 1, to account for feeder node being deleted.
true_branches = np.delete(true_branches, len(true_branches[:,1])-1, 0 )
...
#print('the estimated branches:' + str(node8_randPF_solar.est_branches))
#print('the true branches:' + str(node8_randPF_solar.true_branches))
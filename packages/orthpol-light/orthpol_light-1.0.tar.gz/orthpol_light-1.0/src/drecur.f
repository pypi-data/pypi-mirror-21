...
cf2py double precision intent(in) :: dal
cf2py double precision intent(in) :: dbe
cf2py double precision intent(out,out=a),depend(n),dimension(n) :: da
cf2py double precision intent(out,out=b),depend(n),dimension(n) :: db

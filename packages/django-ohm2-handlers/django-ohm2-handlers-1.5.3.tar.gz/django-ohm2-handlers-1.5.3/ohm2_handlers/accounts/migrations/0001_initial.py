...
import ohm2_handlers.accounts.managers
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original', models.ImageField(upload_to=ohm2_handlers.accounts.managers.avatars_upload_to)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=django.utils.timezone.now)),
                ('last_update', models.DateTimeField(default=django.utils.timezone.now)),
                ('key_16', models.CharField(max_length=2048)),
                ('mode_16', models.IntegerField(default=3)),
                ('iv_16', models.CharField(max_length=2048)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=django.utils.timezone.now)),
                ('last_update', models.DateTimeField(default=django.utils.timezone.now)),
                ('private_1024', models.CharField(max_length=2048, unique=True)),
                ('public_1024', models.CharField(max_length=2048, unique=True)),
                ('private_2048', models.CharField(max_length=2048, unique=True)),
                ('public_2048', models.CharField(max_length=2048, unique=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,

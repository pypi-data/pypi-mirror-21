...
"""
    Molecular Structure File Converter
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    Employs the Murdock API to convert between molecular structure files. Use
    the command-line option ``--help`` for more information.

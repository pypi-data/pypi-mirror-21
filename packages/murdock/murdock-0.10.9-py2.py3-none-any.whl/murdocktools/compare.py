...
"""
    Screening Comparison Report Creator
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    Employs the Murdock API to create a report comparing multiple Murdock
    screenings. Use the command-line option ``--help`` for more information.

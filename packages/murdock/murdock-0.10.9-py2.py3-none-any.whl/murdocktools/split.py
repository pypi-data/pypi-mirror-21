...
"""
    ...
    Creates individual configuration files for each docking within an existing
    screening result directory, e.g. for manual parallelization. Use the
    command-line option ``--help`` for more information.

...
class Density(Distribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.Density", "2.0.0",
...
class ParametricDensity(ParametricDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.ParametricDensity", "2.0.0",
...
class TransportMapDensity(TransportMapDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.TransportMapDensity", "2.0.0",
...
class PushForwardTransportMapDensity(PushForwardTransportMapDistribution):
    def __init__(self, *args, **kwargs):
        deprecate(
            "TransportMaps.Densities.PushForwardTransportMapDensity", "2.0.0",
...
class PullBackTransportMapDensity(PullBackTransportMapDistribution):
    def __init__(self, *args, **kwargs):
        deprecate(
            "TransportMaps.Densities.PullBackTransportMapDensity", "2.0.0",
...
class FrozenDensity_1d(FrozenDistribution_1d):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.FrozenDensity_1d", "2.0.0",
...
class GaussianDensity(GaussianDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.GaussianDensity", "2.0.0",
...
class StandardNormalDensity(StandardNormalDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.StandardNormalDensity", "2.0.0",
...
class LogNormalDensity(LogNormalDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.LogNormalDensity", "2.0.0",
...
class LogisticDensity(LogisticDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.LogisticDensity", "2.0.0",
...
class GammaDensity(GammaDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.GammaDensity", "2.0.0",
...
class BetaDensity(BetaDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.BetaDensity", "2.0.0",
...
class WeibullDensity(WeibullDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.WeibullDensity", "2.0.0",
...
class GumbelDensity(GumbelDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.GumbelDensity", "2.0.0",
...
class BananaDensity(BananaDistribution):
    def __init__(self, *args, **kwargs):
        deprecate("TransportMaps.Densities.BananaDensity", "2.0.0",

...
setup(
    ...
    # endereco do projeto
    url = 'https://github.com/JaineBudke/BIOME_pacotePython_vTeste.git',
    ...
    keywords='bioinformatics neuroscience teste',
    ...
    # como projeto eh instalado com pip, a especificacao eh a 'peppercorn'

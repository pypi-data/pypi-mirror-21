...
def create_config(
        ...
        redis_host_arg, redis_port_arg, redis_db_arg, project_dir_arg, force
):
    ...
    project_dir = (
        click.prompt(
            u'Project directory (For PYTHON_PATH)', default=default_path, type=click.Path(
    ...
    cfg = Config()
    cfg.make_default()
    cfg[Config.SHIRE_SECTION][Config.SHIRE_PROJECT_DIR] = project_dir

...
class TestGzipHandler(unittest.TestCase):
    ...
    def test_init_no_opt(self):
        ...
        cacheblob.handlers.gzip.Gzip({'directory': self.TEST_DIRECTORY})

    def test_init_wrong_memoize_max_length_type(self):
        import cacheblob.handlers.gzip as handler

        self.assertRaises(
            TypeError, handler.Gzip, {
    ...
    def test_init_memoize_max_length_default(self):
        ...
        self.test_handler = handler.Gzip({'directory': self.TEST_DIRECTORY})
        self.assertEqual(
    ...
    def test_set_directory(self):
        ...
        self.test_handler = handler.Gzip({'directory': self.TEST_DIRECTORY2})
    ...
    def test_fetch(self):
        ...
        self.assertEqual('value'.encode('utf-8'), result.encode('utf-8'))
    ...
    def test_overwrite_true(self):
        ...
        result = self.test_handler.fetch('index').value
        self.assertEqual('value2'.encode('utf-8'), result.encode('utf-8'))
    ...
    def test_overwrite_true_no_memoize(self):
        ...
        self.test_handler.store(test_item2)
        result = self.test_handler.fetch('index').value
        self.assertEqual('value2'.encode('utf-8'), result)
    ...
    def test_fetch_all(self):
        ...
        if all_items and len(all_items) == 2:
            self.assertEqual(set([test_item.value.encode('utf-8'),
                                  test_item2.value.encode('utf-8')]),
    ...
    def test_fetch_all_with_expired(self):
        ...
        if all_items and len(all_items) == 1:
            self.assertEqual(test_item2.value.encode('utf-8'),
                             all_items[0].value)
    ...
    def test_purge_if_expired_false(self):
        ...
        self.test_handler = handler.Gzip({'may_purge_if_expired': False,
                                          'directory': self.TEST_DIRECTORY})
        test_item = item.CacheItem(index='index',
                                   value='value',
                                   duration=datetime.timedelta(milliseconds=1))
    ...
    def test_purge_any_expired_true(self):
        ...
        self.test_handler = handler.Gzip({'may_purge_if_expired': True,
                                          'directory': self.TEST_DIRECTORY})
        test_item = item.CacheItem(index='index',
                                   value='value',
                                   duration=datetime.timedelta(milliseconds=1))
        test_item2 = item.CacheItem(index='index2',
                                    value='value2',

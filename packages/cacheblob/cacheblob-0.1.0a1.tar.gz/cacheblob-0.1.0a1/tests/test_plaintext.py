...
class TestPlaintextHandler(unittest.TestCase):
    ...
    def test_init_no_opt(self):
        import cacheblob.handlers.plaintext as handler

        handler.Plaintext({'directory': self.TEST_DIRECTORY})

    def test_init_wrong_memoize_max_length_type(self):
        import cacheblob.handlers.plaintext as handler

        self.assertRaises(
            TypeError, handler.Plaintext, {
    ...
    def test_set_directory(self):
        ...
        self.test_handler = handler.Plaintext(
            {'directory': self.TEST_DIRECTORY2})

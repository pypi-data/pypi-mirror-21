...
class Command(object):
    def __init__(self, *args, **kwargs):
        ...
        certificate = self._profile.ssl_certificate
        trust_all = self.get_bool_val(self._profile.ssl_trust_all, not bool(certificate))
        port = self._profile.port or httpclient.SECURED_PORT

...
_irfft_outputs = ["output"]


def irfft(input, fft_length, name=None):
  r"""Compute the inverse 1-dimensional discrete Fourier Transform of a real-valued
...
_irfft2d_outputs = ["output"]


def irfft2d(input, fft_length, name=None):
  r"""Compute the inverse 2-dimensional discrete Fourier Transform of a real-valued
...
_irfft3d_outputs = ["output"]


def irfft3d(input, fft_length, name=None):
  r"""Compute the inverse 3-dimensional discrete Fourier Transform of a real-valued
...
_rfft_outputs = ["output"]


def rfft(input, fft_length, name=None):
  r"""Compute the 1-dimensional discrete Fourier Transform of a real-valued signal
...
_rfft2d_outputs = ["output"]


def rfft2d(input, fft_length, name=None):
  r"""Compute the 2-dimensional discrete Fourier Transform of a real-valued signal
...
_rfft3d_outputs = ["output"]


def rfft3d(input, fft_length, name=None):
  r"""Compute the 3-dimensional discrete Fourier Transform of a real-valued signal

...
class Controller(QtCore.QObject):
    ...
    def connectConfigSignals(self):
        ...
        self.woptions.sigConfig.connect(self.wlakeshore.setConfig)
    ...
    def connectLakeshoreSignals(self):
        ...
        self.diffractometer.lakeshore.sigParams.connect(self.scipts['lakeshore']._setParams)
        self.diffractometer.lakeshore.sigStatus.connect(self.wlakeshore.updateTemp)
        self.diffractometer.lakeshore.sigStatus.connect(self.scipts['lakeshore']._setStatus)
    ...
    def connectSequenceSignals(self):
        ...
        self.diffractometer.sigExperimentPaused.connect(self.wlakeshore.pause)
        self.diffractometer.sigExperimentResumed.connect(self.wlakeshore.resume)

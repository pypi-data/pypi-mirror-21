...
class WOptions(QtWidgets.QDialog, Ui_Ui_Settings):
    ...
    def setUI(self):
        ...
        self.editCommTimeout.setValidator(QtGui.QIntValidator())
    ...
    def loadSettings(self):
        ...
        self.editCommTimeout.setText(s.value('WOptions/CommTimeout', '3000'))
    ...
    def saveSettings(self):
        ...
        s.setValue('WOptions/CommTimeout', self.editCommTimeout.text())

...
class Controller(QtCore.QObject):
    ...
    def createWindows(self):
        ...
        self.wlogging = wlogging.WLogging(self.wmain)
        ...
        self.wlakeshore = wlakeshore.WLakeshore(self.wmain)
        self.wblower = wblower.WBlower(self.wmain)
        self.wcryo = wcryo.WCryo(self.wmain)
        self.wseq = wseq.WSeq(self.wmain)
        self.wscripted = wscripted.WScriptEd(self.wmain, self.scipts)
    ...
    def connectInternalSignals(self):
        ...
        self.woptions.sigConfig.connect(logger.Logger.logger.setConfig)
        logger.Logger.logger.sigPostLogMessage.connect(self.wlogging.postLogMessage)
    ...
    def connectSequenceSignals(self):
        ...
        self.wseq.sigDiffractometerSleep.connect(self.scipts['diffractometer'].sleep)

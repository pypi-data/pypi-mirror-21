...
class WSeq(QtWidgets.QDialog, Ui_WSeq):
    ...
    sigDiffractometerSleep = QtCore.pyqtSignal(int)
    ...
    def loadSettings(self):
        s = Config.Settings
        self.restoreGeometry(s.value('WSeq/Geometry', Config.QBA))

    @QtCore.pyqtSlot()
    def on_addActionButton_clicked(self):
        {
            0: partial(self.sigDiffractometerSleep.emit, self.actionSpinBox.value()),

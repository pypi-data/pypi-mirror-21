...
from ..controller.utils import pyqt2bool as _
...
class WLakeshore(QtWidgets.QDialog, Ui_WLakeshore):
    ...
    def loadSettings(self):
        s = Config.Settings
        self.restoreGeometry(s.value('WLakeshore/Geometry', Config.QBA))
        self.splitter.restoreGeometry(s.value('WLakeshore/SplitterGeometry', Config.QBA))
        self.splitter.restoreState(s.value('WLakeshore/SplitterState', Config.QBA))

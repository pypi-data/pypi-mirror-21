...
class Event(Data):
    ...
    def event_type_string(self):
        ...
        return self.raw['event_type_string']
    ...
    def webcasts(self):
        ...
        modified_return = self.raw['webcasts']
        modified_return['event'] = '{} ({})'.format(self.name, self.key)
        return DataList([Webcast(webcast_item) for webcast_item in modified_return], self.raw['webcasts'])
    ...
    def first_event_id(self):
        ...
        return self.raw['first_event_id']
...
class Webcast(Data):
    ...
    def __repr__(self):
        ...
        return '<tbapi.Webcast: Webcast for {}>'.format(self.raw['event'])
...
class Parser:
    ...
    def get_team_events(self, year=None, *, force_new=False, force_cache=False, log_cache=False):
        """Get a list of Events attended by a given team"""
        if not year:
            ...
            return DataList([Event(event_item) for event_item in event_list])
        else:

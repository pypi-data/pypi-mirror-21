...
def request_transaction(client, language, entranceCode, expirationPeriod, mandate_document):
    # Create XML message
    ...
    transaction.append(client._element('entranceCode', entranceCode))
    transaction.append(client._element('expirationPeriod', expirationPeriod))

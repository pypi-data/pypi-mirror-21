...
class Backslashes(OutputTest):
    ...
    def setUp(self):
        with open('backslashes.txt', 'w') as fp:
...
class EncodingDirective(OutputTest):
    ...
    def test3(self):
        ...
        self.verify(source if PY2 else source.decode('utf-8'),
                    u'\u1234', outputEncoding='utf8')

    def test4(self):
        """basic #encoding """
        source = b"#encoding latin-1\n\xe1\x88\xb4"
        self.verify(source if PY2 else source.decode('latin-1'),
                    u"\xe1\x88\xb4")
...
class IncludeDirective(OutputTest):
    ...
    def setUp(self):
        with open('parseTest.txt', 'w') as fp:

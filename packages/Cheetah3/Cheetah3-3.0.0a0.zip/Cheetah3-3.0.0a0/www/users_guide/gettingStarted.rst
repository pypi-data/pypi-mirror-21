...
Cheetah requires Python release 2.7 or greater or 3.3 or greater,
and has been tested with Python 2.7, 3.3, 3.4, 3.5 and 3.6.
It is known to run on Linux, Windows, FreeBSD and Solaris, and should
...
#. If you cannot login as as an administrator install Cheetah as user
   to your own home directory: add option {--user} to commands: either

...
#ifdef IS_PYTHON3
static struct PyModuleDef namemapper_module = {
...
{
    PyObject *module = PyModule_Create(&namemapper_module);
#else
PyMODINIT_FUNC init_namemapper(void)
{
    PyObject *module = Py_InitModule3("_namemapper", namemapper_methods, NULL);
#endif

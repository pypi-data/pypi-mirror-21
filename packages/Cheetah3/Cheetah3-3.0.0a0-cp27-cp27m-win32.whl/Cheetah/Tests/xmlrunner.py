...
class _XMLTestResult(unittest.TestResult):
    ...
    def __init__(self, classname):
        super(_XMLTestResult, self).__init__()
    ...
    def startTest(self, test):
        super(_XMLTestResult, self).startTest(test)
        self._error = None
        self._failure = None
    ...
    def stopTest(self, test):
        ...
        super(_XMLTestResult, self).stopTest(test)
        if self._error:
    ...
    def addError(self, test, err):
        super(_XMLTestResult, self).addError(test, err)
        self._error = err

    def addFailure(self, test, err):
        super(_XMLTestResult, self).addFailure(test, err)
        self._failure = err

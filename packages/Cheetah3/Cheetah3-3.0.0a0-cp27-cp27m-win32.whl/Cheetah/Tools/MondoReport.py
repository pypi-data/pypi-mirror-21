...
try:
    from ..NameMapper import valueForKey as lookup_func
except ImportError:
...
class ValuesGetterMixin(object):
...
class Summary(ValuesGetterMixin):
    ...
    """
    def __init__(self, origList):
        super(Summary, self).__init__(origList)

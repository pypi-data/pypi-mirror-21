...
# twine upload dist/SMART_BS_Seq-2.1.3-py2-none-any.whl dist/SMART-BS-Seq-2.1.3.tar.gz
# ------------------------------------
...
def main():
    ...
    setup(name="SMART-BS-Seq",
          ...
          packages=['SMART'],
          package_data={'SMART':['Example/MethylMatrix_Test.txt','Example/CpGisland_hg19.bed']},

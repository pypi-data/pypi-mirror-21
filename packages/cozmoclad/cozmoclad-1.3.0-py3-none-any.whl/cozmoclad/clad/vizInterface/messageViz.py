...
class ObjectConnectionState(object):
  ...
  def __init__(self, activeID=0, objectType=Anki.Cozmo.ObjectType.Invalid, connected=False):
...
class ObjectAccelState(object):
  ...
  def activeID(self, value):
    self._activeID = msgbuffers.validate_integer(
      'ObjectAccelState.activeID', value, 0, 4294967295)
  ...
  def __init__(self, activeID=0, accel=Anki.Cozmo.ActiveAccel()):
    self.activeID = activeID
    self.accel = accel
  ...
  def __str__(self):
    return '{type}(activeID={activeID}, accel={accel})'.format(
      type=type(self).__name__,
      activeID=self._activeID,
      accel=self._accel)
...
class MessageViz(object):
  ...
  class Tag(object):
    ...
    CameraRect                   = 16 # Anki.Cozmo.VizInterface.CameraRect
    CameraLine                   = 17 # Anki.Cozmo.VizInterface.CameraLine
    CameraOval                   = 18 # Anki.Cozmo.VizInterface.CameraOval
    CameraText                   = 19 # Anki.Cozmo.VizInterface.CameraText
    EraseObject                  = 20 # Anki.Cozmo.VizInterface.EraseObject
    EraseSegmentPrimitives       = 21 # Anki.Cozmo.VizInterface.EraseSegmentPrimitives
    EraseQuad                    = 22 # Anki.Cozmo.VizInterface.EraseQuad
    SetRobot                     = 23 # Anki.Cozmo.VizInterface.SetRobot
    AppendPathSegmentLine        = 24 # Anki.Cozmo.VizInterface.AppendPathSegmentLine
    AppendPathSegmentArc         = 25 # Anki.Cozmo.VizInterface.AppendPathSegmentArc
    SetPathColor                 = 26 # Anki.Cozmo.VizInterface.SetPathColor
    ErasePath                    = 27 # Anki.Cozmo.VizInterface.ErasePath
    DefineColor                  = 28 # Anki.Cozmo.VizInterface.DefineColor
    SetLabel                     = 29 # Anki.Cozmo.VizInterface.SetLabel
    DockingErrorSignal           = 30 # Anki.Cozmo.VizInterface.DockingErrorSignal
    CameraInfo                   = 31 # Anki.Cozmo.VizInterface.CameraInfo
    VisionMarker                 = 32 # Anki.Cozmo.VizInterface.VisionMarker
    ShowObjects                  = 33 # Anki.Cozmo.VizInterface.ShowObjects
    TrackerQuad                  = 34 # Anki.Cozmo.VizInterface.TrackerQuad
    FaceDetection                = 35 # Anki.Cozmo.VizInterface.FaceDetection
    RobotMood                    = 36 # Anki.Cozmo.VizInterface.RobotMood
    RobotBehaviorSelectData      = 37 # Anki.Cozmo.VizInterface.RobotBehaviorSelectData
    NewBehaviorSelected          = 38 # Anki.Cozmo.VizInterface.NewBehaviorSelected
    StartRobotUpdate             = 39 # Anki.Cozmo.VizInterface.StartRobotUpdate
    EndRobotUpdate               = 40 # Anki.Cozmo.VizInterface.EndRobotUpdate
    SaveImages                   = 41 # Anki.Cozmo.VizInterface.SaveImages
    SaveState                    = 42 # Anki.Cozmo.VizInterface.SaveState
    ObjectConnectionState        = 43 # Anki.Cozmo.VizInterface.ObjectConnectionState
    ObjectMovingState            = 44 # Anki.Cozmo.VizInterface.ObjectMovingState
    ObjectUpAxisState            = 45 # Anki.Cozmo.VizInterface.ObjectUpAxisState
    ObjectAccelState             = 46 # Anki.Cozmo.VizInterface.ObjectAccelState
  ...
  _tags_by_name = dict(
    ...
    CameraText=19,
    EraseObject=20,
    EraseSegmentPrimitives=21,
    EraseQuad=22,
    SetRobot=23,
    AppendPathSegmentLine=24,
    AppendPathSegmentArc=25,
    SetPathColor=26,
    ErasePath=27,
    DefineColor=28,
    SetLabel=29,
    DockingErrorSignal=30,
    CameraInfo=31,
    VisionMarker=32,
    ShowObjects=33,
    TrackerQuad=34,
    FaceDetection=35,
    RobotMood=36,
    RobotBehaviorSelectData=37,
    NewBehaviorSelected=38,
    StartRobotUpdate=39,
    EndRobotUpdate=40,
    SaveImages=41,
    SaveState=42,
    ObjectConnectionState=43,
    ObjectMovingState=44,
    ObjectUpAxisState=45,
    ObjectAccelState=46,
  )
  ...
  _tags_by_value[16] = 'CameraRect'
  _tags_by_value[17] = 'CameraLine'
  _tags_by_value[18] = 'CameraOval'
  _tags_by_value[19] = 'CameraText'
  _tags_by_value[20] = 'EraseObject'
  _tags_by_value[21] = 'EraseSegmentPrimitives'
  _tags_by_value[22] = 'EraseQuad'
  _tags_by_value[23] = 'SetRobot'
  _tags_by_value[24] = 'AppendPathSegmentLine'
  _tags_by_value[25] = 'AppendPathSegmentArc'
  _tags_by_value[26] = 'SetPathColor'
  _tags_by_value[27] = 'ErasePath'
  _tags_by_value[28] = 'DefineColor'
  _tags_by_value[29] = 'SetLabel'
  _tags_by_value[30] = 'DockingErrorSignal'
  _tags_by_value[31] = 'CameraInfo'
  _tags_by_value[32] = 'VisionMarker'
  _tags_by_value[33] = 'ShowObjects'
  _tags_by_value[34] = 'TrackerQuad'
  _tags_by_value[35] = 'FaceDetection'
  _tags_by_value[36] = 'RobotMood'
  _tags_by_value[37] = 'RobotBehaviorSelectData'
  _tags_by_value[38] = 'NewBehaviorSelected'
  _tags_by_value[39] = 'StartRobotUpdate'
  _tags_by_value[40] = 'EndRobotUpdate'
  _tags_by_value[41] = 'SaveImages'
  _tags_by_value[42] = 'SaveState'
  _tags_by_value[43] = 'ObjectConnectionState'
  _tags_by_value[44] = 'ObjectMovingState'
  _tags_by_value[45] = 'ObjectUpAxisState'
  _tags_by_value[46] = 'ObjectAccelState'
  ...
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraRect.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraLine.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraOval.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraText.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseObject.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseSegmentPrimitives.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetRobot.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentLine.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.AppendPathSegmentArc.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetPathColor.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ErasePath.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DefineColor.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SetLabel.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.DockingErrorSignal.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.CameraInfo.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.VisionMarker.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ShowObjects.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.TrackerQuad.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.FaceDetection.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotMood.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.RobotBehaviorSelectData.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.NewBehaviorSelected.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.StartRobotUpdate.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.EndRobotUpdate.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveImages.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.SaveState.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectConnectionState.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectMovingState.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectUpAxisState.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.VizInterface.ObjectAccelState.unpack_from)
  ...
  _type_by_tag_value[16] = lambda : Anki.Cozmo.VizInterface.CameraRect
  _type_by_tag_value[17] = lambda : Anki.Cozmo.VizInterface.CameraLine
  _type_by_tag_value[18] = lambda : Anki.Cozmo.VizInterface.CameraOval
  _type_by_tag_value[19] = lambda : Anki.Cozmo.VizInterface.CameraText
  _type_by_tag_value[20] = lambda : Anki.Cozmo.VizInterface.EraseObject
  _type_by_tag_value[21] = lambda : Anki.Cozmo.VizInterface.EraseSegmentPrimitives
  _type_by_tag_value[22] = lambda : Anki.Cozmo.VizInterface.EraseQuad
  _type_by_tag_value[23] = lambda : Anki.Cozmo.VizInterface.SetRobot
  _type_by_tag_value[24] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentLine
  _type_by_tag_value[25] = lambda : Anki.Cozmo.VizInterface.AppendPathSegmentArc
  _type_by_tag_value[26] = lambda : Anki.Cozmo.VizInterface.SetPathColor
  _type_by_tag_value[27] = lambda : Anki.Cozmo.VizInterface.ErasePath
  _type_by_tag_value[28] = lambda : Anki.Cozmo.VizInterface.DefineColor
  _type_by_tag_value[29] = lambda : Anki.Cozmo.VizInterface.SetLabel
  _type_by_tag_value[30] = lambda : Anki.Cozmo.VizInterface.DockingErrorSignal
  _type_by_tag_value[31] = lambda : Anki.Cozmo.VizInterface.CameraInfo
  _type_by_tag_value[32] = lambda : Anki.Cozmo.VizInterface.VisionMarker
  _type_by_tag_value[33] = lambda : Anki.Cozmo.VizInterface.ShowObjects
  _type_by_tag_value[34] = lambda : Anki.Cozmo.VizInterface.TrackerQuad
  _type_by_tag_value[35] = lambda : Anki.Cozmo.VizInterface.FaceDetection
  _type_by_tag_value[36] = lambda : Anki.Cozmo.VizInterface.RobotMood
  _type_by_tag_value[37] = lambda : Anki.Cozmo.VizInterface.RobotBehaviorSelectData
  _type_by_tag_value[38] = lambda : Anki.Cozmo.VizInterface.NewBehaviorSelected
  _type_by_tag_value[39] = lambda : Anki.Cozmo.VizInterface.StartRobotUpdate
  _type_by_tag_value[40] = lambda : Anki.Cozmo.VizInterface.EndRobotUpdate
  _type_by_tag_value[41] = lambda : Anki.Cozmo.VizInterface.SaveImages
  _type_by_tag_value[42] = lambda : Anki.Cozmo.VizInterface.SaveState
  _type_by_tag_value[43] = lambda : Anki.Cozmo.VizInterface.ObjectConnectionState
  _type_by_tag_value[44] = lambda : Anki.Cozmo.VizInterface.ObjectMovingState
  _type_by_tag_value[45] = lambda : Anki.Cozmo.VizInterface.ObjectUpAxisState
  _type_by_tag_value[46] = lambda : Anki.Cozmo.VizInterface.ObjectAccelState

...
class PerRobotSettings(object):
  ...
  def robotID(self, value):
    self._robotID = msgbuffers.validate_integer(
      'PerRobotSettings.robotID', value, 0, 4294967295)
  ...
  def __init__(self, robotID=0, serialNumberHead=0, serialNumberBody=0, modelNumber=0, hwVersion=0, cameraConfig=Anki.Cozmo.ExternalInterface.CameraConfig()):
    self.robotID = robotID
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_robotID, _serialNumberHead, _serialNumberBody, _modelNumber, _hwVersion, _cameraConfig)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._robotID == other._robotID and
        self._serialNumberHead == other._serialNumberHead and
  ...
  def __len__(self):
    return (msgbuffers.size(self._robotID, 'I') +
      msgbuffers.size(self._serialNumberHead, 'I') +
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, serialNumberHead={serialNumberHead}, serialNumberBody={serialNumberBody}, modelNumber={modelNumber}, hwVersion={hwVersion}, cameraConfig={cameraConfig})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
...
class RobotObservedFace(object):
  ...
  def __init__(self, faceID=0, robotID=0, timestamp=0, pose=Anki.PoseStruct3d(), img_rect=Anki.CladRect(), name='', expression=Anki.Vision.FacialExpression.Unknown, smileAmount=Anki.Vision.SmileAmount(), gaze=Anki.Vision.Gaze(), blinkAmount=Anki.Vision.BlinkAmount(), expressionValues=(0,) * Anki.Vision.FacialExpression.Count, leftEye=(), rightEye=(), nose=(), mouth=()):
    self.faceID = faceID
    self.robotID = robotID
    self.timestamp = timestamp
    self.pose = pose
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_faceID, _robotID, _timestamp, _pose, _img_rect, _name, _expression, _smileAmount, _gaze, _blinkAmount, _expressionValues, _leftEye, _rightEye, _nose, _mouth)
  ...
  def __str__(self):
    return '{type}(faceID={faceID}, robotID={robotID}, timestamp={timestamp}, pose={pose}, img_rect={img_rect}, name={name}, expression={expression}, smileAmount={smileAmount}, gaze={gaze}, blinkAmount={blinkAmount}, expressionValues={expressionValues}, leftEye={leftEye}, rightEye={rightEye}, nose={nose}, mouth={mouth})'.format(
      type=type(self).__name__,
      faceID=self._faceID,
      robotID=self._robotID,
      timestamp=self._timestamp,
...
class DefinedCustomObject(object):
  ...
  def __init__(self, robotID=0, success=False):
    self.robotID = robotID
    self.success = success
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, success={success})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
      success=self._success)
...
class ObjectState(object):
  ...
  def objectID(self, value):
    self._objectID = msgbuffers.validate_integer(
      'ObjectState.objectID', value, 0, 4294967295)
  ...
  def lastObservedTimestamp(self, value):
    self._lastObservedTimestamp = msgbuffers.validate_integer(
      'ObjectState.lastObservedTimestamp', value, 0, 4294967295)
  ...
  def objectFamily(self, value):
    self._objectFamily = msgbuffers.validate_integer(
      'ObjectState.objectFamily', value, -2147483648, 2147483647)
  ...
  def objectType(self, value):
    self._objectType = msgbuffers.validate_integer(
      'ObjectState.objectType', value, -2147483648, 2147483647)
  ...
  def pose(self, value):
    self._pose = msgbuffers.validate_object(
      'ObjectState.pose', value, Anki.PoseStruct3d)
  ...
  def poseState(self, value):
    self._poseState = msgbuffers.validate_integer(
      'ObjectState.poseState', value, 0, 255)
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new ObjectState from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('ObjectState.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new ObjectState from the given BinaryReader."
    _objectID = reader.read('I')
  ...
  def pack(self):
    "Writes the current ObjectState, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current ObjectState to the given BinaryWriter."
    writer.write(self._objectID, 'I')
...
Anki.Cozmo.ExternalInterface.ObjectState = ObjectState
del ObjectState
...
class ObjectStates(object):
  ...
  __slots__ = (
    '_objects', # ObjectState[uint_8]
  )

  @property
  def objects(self):
    "ObjectState[uint_8] objects struct property."
    return self._objects

  @objects.setter
  def objects(self, value):
    self._objects = msgbuffers.validate_varray(
      'ObjectStates.objects', value, 255,
      lambda name, value_inner: msgbuffers.validate_object(
        name, value_inner, Anki.Cozmo.ExternalInterface.ObjectState))
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new ObjectStates from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('ObjectStates.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new ObjectStates from the given BinaryReader."
    _objects = reader.read_object_varray(Anki.Cozmo.ExternalInterface.ObjectState.unpack_from, 'B')
    return cls(_objects)

  def pack(self):
    "Writes the current ObjectStates, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current ObjectStates to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.ObjectStates = ObjectStates
del ObjectStates
...
class RobotCompletedAction(object):
  ...
  def __init__(self, robotID=0, idTag=0, actionType=Anki.Cozmo.RobotActionType.COMPOUND, result=Anki.Cozmo.ActionResult.SUCCESS, subActionResults=(), completionInfo=Anki.Cozmo.ActionCompletedUnion()):
    self.robotID = robotID
    self.idTag = idTag
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_robotID, _idTag, _actionType, _result, _subActionResults, _completionInfo)
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, idTag={idTag}, actionType={actionType}, result={result}, subActionResults={subActionResults}, completionInfo={completionInfo})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
      idTag=self._idTag,
...
class BehaviorTransition(object):
  ...
  __slots__ = (
    '_oldBehaviorName',       # string[uint_8]
    '_newBehaviorName',       # string[uint_8]
  ...
  @property
  def oldBehaviorName(self):
    "string[uint_8] oldBehaviorName struct property."
    return self._oldBehaviorName

  @oldBehaviorName.setter
  def oldBehaviorName(self, value):
    self._oldBehaviorName = msgbuffers.validate_string(
      'BehaviorTransition.oldBehaviorName', value, 255)

  @property
  def newBehaviorName(self):
    "string[uint_8] newBehaviorName struct property."
    return self._newBehaviorName

  @newBehaviorName.setter
  def newBehaviorName(self, value):
    self._newBehaviorName = msgbuffers.validate_string(
      'BehaviorTransition.newBehaviorName', value, 255)
  ...
  def __init__(self, oldBehaviorName='', newBehaviorName='', oldBehaviorClass=Anki.Cozmo.BehaviorClass.NoneBehavior, oldBehaviorExecType=Anki.Cozmo.ExecutableBehaviorType.NoneBehavior, newBehaviorClass=Anki.Cozmo.BehaviorClass.NoneBehavior, newBehaviorExecType=Anki.Cozmo.ExecutableBehaviorType.NoneBehavior, newBehaviorDisplayKey=''):
    self.oldBehaviorName = oldBehaviorName
    self.newBehaviorName = newBehaviorName
  ...
  def unpack_from(cls, reader):
    ...
    _oldBehaviorName = reader.read_string('B')
    _newBehaviorName = reader.read_string('B')
    ...
    return cls(_oldBehaviorName, _newBehaviorName, _oldBehaviorClass, _oldBehaviorExecType, _newBehaviorClass, _newBehaviorExecType, _newBehaviorDisplayKey)
  ...
  def pack_to(self, writer):
    ...
    writer.write_string(self._oldBehaviorName, 'B')
    writer.write_string(self._newBehaviorName, 'B')
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._oldBehaviorName == other._oldBehaviorName and
        self._newBehaviorName == other._newBehaviorName and
  ...
  def __len__(self):
    return (msgbuffers.size_string(self._oldBehaviorName, 'B') +
      msgbuffers.size_string(self._newBehaviorName, 'B') +
  ...
  def __str__(self):
    return '{type}(oldBehaviorName={oldBehaviorName}, newBehaviorName={newBehaviorName}, oldBehaviorClass={oldBehaviorClass}, oldBehaviorExecType={oldBehaviorExecType}, newBehaviorClass={newBehaviorClass}, newBehaviorExecType={newBehaviorExecType}, newBehaviorDisplayKey={newBehaviorDisplayKey})'.format(
      type=type(self).__name__,
      oldBehaviorName=msgbuffers.shorten_string(self._oldBehaviorName),
      newBehaviorName=msgbuffers.shorten_string(self._newBehaviorName),
  ...
  def __repr__(self):
    return '{type}(oldBehaviorName={oldBehaviorName}, newBehaviorName={newBehaviorName}, oldBehaviorClass={oldBehaviorClass}, oldBehaviorExecType={oldBehaviorExecType}, newBehaviorClass={newBehaviorClass}, newBehaviorExecType={newBehaviorExecType}, newBehaviorDisplayKey={newBehaviorDisplayKey})'.format(
      type=type(self).__name__,
      oldBehaviorName=repr(self._oldBehaviorName),
      newBehaviorName=repr(self._newBehaviorName),
...
class ReactionTriggerTransition(object):
  ...
  def __init__(self, oldTrigger=Anki.Cozmo.ReactionTrigger.NoneTrigger, newTrigger=Anki.Cozmo.ReactionTrigger.NoneTrigger):
...
class BuildPyramidPreReqsChanged(object):
  "Generated message-passing message."
  ...
  def areCubesUpright(self, value):
    self._areCubesUpright = msgbuffers.validate_bool(
      'BuildPyramidPreReqsChanged.areCubesUpright', value)
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new BuildPyramidPreReqsChanged from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('BuildPyramidPreReqsChanged.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new BuildPyramidPreReqsChanged from the given BinaryReader."
    _areCubesUpright = bool(reader.read('b'))
    return cls(_areCubesUpright)

  def pack(self):
    "Writes the current BuildPyramidPreReqsChanged, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current BuildPyramidPreReqsChanged to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged = BuildPyramidPreReqsChanged
del BuildPyramidPreReqsChanged
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    ObjectDiscovered               = 0xb  # Anki.Cozmo.ObjectDiscovered
    ObjectConnectionState          = 0xc  # Anki.Cozmo.ObjectConnectionState
    ObjectConnectionStateToRobot   = 0xd  # Anki.Cozmo.ObjectConnectionStateToRobot
    ObjectMoved                    = 0xe  # Anki.Cozmo.ObjectMoved
    ObjectStoppedMoving            = 0xf  # Anki.Cozmo.ObjectStoppedMoving
    ObjectUpAxisChanged            = 0x10 # Anki.Cozmo.ObjectUpAxisChanged
    ObjectTappedFiltered           = 0x11 # Anki.Cozmo.ObjectTappedFiltered
    ObjectTapped                   = 0x12 # Anki.Cozmo.ObjectTapped
    ObjectPowerLevel               = 0x13 # Anki.Cozmo.ObjectPowerLevel
    ObjectAccel                    = 0x14 # Anki.Cozmo.ObjectAccel
    FactoryTestResultEntry         = 0x15 # Anki.Cozmo.FactoryTestResultEntry
    ImageChunk                     = 0x16 # Anki.Cozmo.ImageChunk
    ImageImuData                   = 0x17 # Anki.Cozmo.ImageImuData
    CameraCalibration              = 0x18 # Anki.Cozmo.CameraCalibration
    IMURequest                     = 0x19 # Anki.Cozmo.IMURequest
    LoadedKnownFace                = 0x1a # Anki.Vision.LoadedKnownFace
    RobotRenamedEnrolledFace       = 0x1b # Anki.Vision.RobotRenamedEnrolledFace
    MotorCalibration               = 0x1c # Anki.Cozmo.MotorCalibration
    MotorAutoEnabled               = 0x1d # Anki.Cozmo.MotorAutoEnabled
    CliffEvent                     = 0x1e # Anki.Cozmo.CliffEvent
    PotentialCliff                 = 0x1f # Anki.Cozmo.PotentialCliff
    ProxObstacle                   = 0x20 # Anki.Cozmo.ProxObstacle
    CarryStateUpdate               = 0x21 # Anki.Cozmo.CarryStateUpdate
    SetBodyRadioMode               = 0x22 # Anki.Cozmo.SetBodyRadioMode
    AnimationState                 = 0x23 # Anki.Cozmo.RobotInterface.AnimationState
    UiDeviceAvailable              = 0x24 # Anki.Cozmo.ExternalInterface.UiDeviceAvailable
    RobotConnectionResponse        = 0x25 # Anki.Cozmo.ExternalInterface.RobotConnectionResponse
    RobotDisconnected              = 0x26 # Anki.Cozmo.ExternalInterface.RobotDisconnected
    EngineRobotCLADVersionMismatch = 0x27 # Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
    ObjectAvailable                = 0x28 # Anki.Cozmo.ExternalInterface.ObjectAvailable
    ObjectUnavailable              = 0x29 # Anki.Cozmo.ExternalInterface.ObjectUnavailable
    FeatureToggles                 = 0x2a # Anki.Cozmo.ExternalInterface.FeatureToggles
    GoingToSleep                   = 0x2b # Anki.Cozmo.ExternalInterface.GoingToSleep
    EngineLoadingDataStatus        = 0x2c # Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
    CurrentCameraParams            = 0x2d # Anki.Cozmo.ExternalInterface.CurrentCameraParams
    PerRobotSettings               = 0x2e # Anki.Cozmo.ExternalInterface.PerRobotSettings
    RobotState                     = 0x2f # Anki.Cozmo.ExternalInterface.RobotState
    RobotDelocalized               = 0x30 # Anki.Cozmo.ExternalInterface.RobotDelocalized
    RobotPoked                     = 0x31 # Anki.Cozmo.ExternalInterface.RobotPoked
    RobotStopped                   = 0x32 # Anki.Cozmo.ExternalInterface.RobotStopped
    RobotOffTreadsStateChanged     = 0x33 # Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
    RobotCliffEventFinished        = 0x34 # Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
    RobotOnChargerPlatformEvent    = 0x35 # Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
    ChargerEvent                   = 0x36 # Anki.Cozmo.ExternalInterface.ChargerEvent
    UnexpectedMovement             = 0x37 # Anki.Cozmo.ExternalInterface.UnexpectedMovement
    RestoreRobotStatus             = 0x38 # Anki.Cozmo.ExternalInterface.RestoreRobotStatus
    RestoreRobotOptions            = 0x39 # Anki.Cozmo.ExternalInterface.RestoreRobotOptions
    DebugString                    = 0x3a # Anki.Cozmo.ExternalInterface.DebugString
    DebugAnimationString           = 0x3b # Anki.Cozmo.ExternalInterface.DebugAnimationString
    RobotProcessedImage            = 0x3c # Anki.Cozmo.ExternalInterface.RobotProcessedImage
    RobotObservedObject            = 0x3d # Anki.Cozmo.ExternalInterface.RobotObservedObject
    RobotObservedPossibleObject    = 0x3e # Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
    ObjectProjectsIntoFOV          = 0x3f # Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV
    RobotObservedFace              = 0x40 # Anki.Cozmo.ExternalInterface.RobotObservedFace
    RobotChangedObservedFaceID     = 0x41 # Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
    RobotObservedPet               = 0x42 # Anki.Cozmo.ExternalInterface.RobotObservedPet
    RobotObservedMotion            = 0x43 # Anki.Cozmo.ExternalInterface.RobotObservedMotion
    RobotDeletedFace               = 0x44 # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedObject             = 0x45 # Anki.Cozmo.ExternalInterface.RobotDeletedObject
    RobotDeletedAllObjects         = 0x46 # Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects
    RobotDeletedAllCustomObjects   = 0x47 # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    CreatedFixedCustomObject       = 0x48 # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject            = 0x49 # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown   = 0x4a # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    ObjectStates                   = 0x4b # Anki.Cozmo.ExternalInterface.ObjectStates
    RobotReadToolCode              = 0x4c # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted        = 0x4d # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace        = 0x4e # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces    = 0x4f # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest   = 0x50 # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction           = 0x51 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                  = 0x52 # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                    = 0x53 # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable             = 0x54 # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable        = 0x55 # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted               = 0x56 # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                 = 0x57 # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                      = 0x58 # Anki.Cozmo.ExternalInterface.MoodState
    RequestSetUnlockResult         = 0x59 # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                   = 0x5a # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults               = 0x5b # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InitDebugConsoleVarMessage     = 0x5c # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage              = 0x5d # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage       = 0x5e # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage  = 0x5f # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage   = 0x60 # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine      = 0x61 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                 = 0x62 # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage              = 0x63 # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus           = 0x64 # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState              = 0x65 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage         = 0x66 # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition      = 0x67 # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage           = 0x68 # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult              = 0x69 # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress         = 0x6a # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete         = 0x6b # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart               = 0x6c # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkEndedByEngine         = 0x6d # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus            = 0x6e # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                      = 0x6f # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition             = 0x70 # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition      = 0x71 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondEnabledBehaviorList     = 0x72 # Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
    BehaviorObjectiveAchieved      = 0x73 # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    BuildPyramidPreReqsChanged     = 0x74 # Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
    OnboardingState                = 0x75 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin          = 0x76 # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage               = 0x77 # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd            = 0x78 # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                    = 0x79 # Anki.Cozmo.ExternalInterface.SupportInfo
    EndOfMessage                   = 0x7a # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  @property
  def ObjectStates(self):
    "Anki.Cozmo.ExternalInterface.ObjectStates ObjectStates union property."
    msgbuffers.safety_check_tag('ObjectStates', self._tag, self.Tag.ObjectStates, self._tags_by_value)
    return self._data

  @ObjectStates.setter
  def ObjectStates(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.ObjectStates', value, Anki.Cozmo.ExternalInterface.ObjectStates)
    self._tag = self.Tag.ObjectStates
  ...
  @property
  def BuildPyramidPreReqsChanged(self):
    "Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged BuildPyramidPreReqsChanged union property."
    msgbuffers.safety_check_tag('BuildPyramidPreReqsChanged', self._tag, self.Tag.BuildPyramidPreReqsChanged, self._tags_by_value)
    return self._data

  @BuildPyramidPreReqsChanged.setter
  def BuildPyramidPreReqsChanged(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.BuildPyramidPreReqsChanged', value, Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged)
    self._tag = self.Tag.BuildPyramidPreReqsChanged
  ...
  _tags_by_name = dict(
    ...
    ObjectDiscovered=11,
    ObjectConnectionState=12,
    ObjectConnectionStateToRobot=13,
    ObjectMoved=14,
    ObjectStoppedMoving=15,
    ObjectUpAxisChanged=16,
    ObjectTappedFiltered=17,
    ObjectTapped=18,
    ObjectPowerLevel=19,
    ObjectAccel=20,
    FactoryTestResultEntry=21,
    ImageChunk=22,
    ImageImuData=23,
    CameraCalibration=24,
    IMURequest=25,
    LoadedKnownFace=26,
    RobotRenamedEnrolledFace=27,
    MotorCalibration=28,
    MotorAutoEnabled=29,
    CliffEvent=30,
    PotentialCliff=31,
    ...
    SetBodyRadioMode=34,
    AnimationState=35,
    UiDeviceAvailable=36,
    RobotConnectionResponse=37,
    RobotDisconnected=38,
    EngineRobotCLADVersionMismatch=39,
    ObjectAvailable=40,
    ObjectUnavailable=41,
    FeatureToggles=42,
    GoingToSleep=43,
    EngineLoadingDataStatus=44,
    CurrentCameraParams=45,
    PerRobotSettings=46,
    RobotState=47,
    RobotDelocalized=48,
    RobotPoked=49,
    RobotStopped=50,
    RobotOffTreadsStateChanged=51,
    RobotCliffEventFinished=52,
    RobotOnChargerPlatformEvent=53,
    ChargerEvent=54,
    UnexpectedMovement=55,
    RestoreRobotStatus=56,
    RestoreRobotOptions=57,
    DebugString=58,
    DebugAnimationString=59,
    RobotProcessedImage=60,
    RobotObservedObject=61,
    RobotObservedPossibleObject=62,
    ObjectProjectsIntoFOV=63,
    RobotObservedFace=64,
    RobotChangedObservedFaceID=65,
    RobotObservedPet=66,
    RobotObservedMotion=67,
    RobotDeletedFace=68,
    RobotDeletedObject=69,
    RobotDeletedAllObjects=70,
    RobotDeletedAllCustomObjects=71,
    CreatedFixedCustomObject=72,
    DefinedCustomObject=73,
    RobotMarkedObjectPoseUnknown=74,
    ObjectStates=75,
    RobotReadToolCode=76,
    FaceEnrollmentCompleted=77,
    RobotErasedEnrolledFace=78,
    RobotErasedAllEnrolledFaces=79,
    RobotCompletedFactoryDotTest=80,
    RobotCompletedAction=81,
    BlockPickedUp=82,
    BlockPlaced=83,
    AnimationAvailable=84,
    AnimationGroupAvailable=85,
    AnimationAborted=86,
    AnimationEvent=87,
    MoodState=88,
    RequestSetUnlockResult=89,
    UnlockStatus=90,
    UnlockedDefaults=91,
    InitDebugConsoleVarMessage=92,
    JsonDasLogMessage=93,
    JsonDasLogAllSentMessage=94,
    VerifyDebugConsoleFuncMessage=95,
    VerifyDebugConsoleVarMessage=96,
    DebugAppendConsoleLogLine=97,
    LatencyMessage=98,
    DeviceDataMessage=99,
    BlockTapFilterStatus=100,
    UpdateEngineState=101,
    EngineErrorCodeMessage=102,
    CubeLightsStateTransition=103,
    BlockPoolDataMessage=104,
    NVStorageOpResult=105,
    FirmwareUpdateProgress=106,
    FirmwareUpdateComplete=107,
    RequestGameStart=108,
    HardSparkEndedByEngine=109,
    SdkConnectionStatus=110,
    SdkStatus=111,
    BehaviorTransition=112,
    ReactionTriggerTransition=113,
    RespondEnabledBehaviorList=114,
    BehaviorObjectiveAchieved=115,
    BuildPyramidPreReqsChanged=116,
    OnboardingState=117,
    MemoryMapMessageBegin=118,
    MemoryMapMessage=119,
    MemoryMapMessageEnd=120,
    SupportInfo=121,
    EndOfMessage=122,
  )
  ...
  _tags_by_value[11] = 'ObjectDiscovered'
  _tags_by_value[12] = 'ObjectConnectionState'
  _tags_by_value[13] = 'ObjectConnectionStateToRobot'
  _tags_by_value[14] = 'ObjectMoved'
  _tags_by_value[15] = 'ObjectStoppedMoving'
  _tags_by_value[16] = 'ObjectUpAxisChanged'
  _tags_by_value[17] = 'ObjectTappedFiltered'
  _tags_by_value[18] = 'ObjectTapped'
  _tags_by_value[19] = 'ObjectPowerLevel'
  _tags_by_value[20] = 'ObjectAccel'
  _tags_by_value[21] = 'FactoryTestResultEntry'
  _tags_by_value[22] = 'ImageChunk'
  _tags_by_value[23] = 'ImageImuData'
  _tags_by_value[24] = 'CameraCalibration'
  _tags_by_value[25] = 'IMURequest'
  _tags_by_value[26] = 'LoadedKnownFace'
  _tags_by_value[27] = 'RobotRenamedEnrolledFace'
  _tags_by_value[28] = 'MotorCalibration'
  _tags_by_value[29] = 'MotorAutoEnabled'
  _tags_by_value[30] = 'CliffEvent'
  _tags_by_value[31] = 'PotentialCliff'
  _tags_by_value[32] = 'ProxObstacle'
  _tags_by_value[33] = 'CarryStateUpdate'
  _tags_by_value[34] = 'SetBodyRadioMode'
  _tags_by_value[35] = 'AnimationState'
  _tags_by_value[36] = 'UiDeviceAvailable'
  _tags_by_value[37] = 'RobotConnectionResponse'
  _tags_by_value[38] = 'RobotDisconnected'
  _tags_by_value[39] = 'EngineRobotCLADVersionMismatch'
  _tags_by_value[40] = 'ObjectAvailable'
  _tags_by_value[41] = 'ObjectUnavailable'
  _tags_by_value[42] = 'FeatureToggles'
  _tags_by_value[43] = 'GoingToSleep'
  _tags_by_value[44] = 'EngineLoadingDataStatus'
  _tags_by_value[45] = 'CurrentCameraParams'
  _tags_by_value[46] = 'PerRobotSettings'
  _tags_by_value[47] = 'RobotState'
  _tags_by_value[48] = 'RobotDelocalized'
  _tags_by_value[49] = 'RobotPoked'
  _tags_by_value[50] = 'RobotStopped'
  _tags_by_value[51] = 'RobotOffTreadsStateChanged'
  _tags_by_value[52] = 'RobotCliffEventFinished'
  _tags_by_value[53] = 'RobotOnChargerPlatformEvent'
  _tags_by_value[54] = 'ChargerEvent'
  _tags_by_value[55] = 'UnexpectedMovement'
  _tags_by_value[56] = 'RestoreRobotStatus'
  _tags_by_value[57] = 'RestoreRobotOptions'
  _tags_by_value[58] = 'DebugString'
  _tags_by_value[59] = 'DebugAnimationString'
  _tags_by_value[60] = 'RobotProcessedImage'
  _tags_by_value[61] = 'RobotObservedObject'
  _tags_by_value[62] = 'RobotObservedPossibleObject'
  _tags_by_value[63] = 'ObjectProjectsIntoFOV'
  _tags_by_value[64] = 'RobotObservedFace'
  _tags_by_value[65] = 'RobotChangedObservedFaceID'
  _tags_by_value[66] = 'RobotObservedPet'
  _tags_by_value[67] = 'RobotObservedMotion'
  _tags_by_value[68] = 'RobotDeletedFace'
  _tags_by_value[69] = 'RobotDeletedObject'
  _tags_by_value[70] = 'RobotDeletedAllObjects'
  _tags_by_value[71] = 'RobotDeletedAllCustomObjects'
  _tags_by_value[72] = 'CreatedFixedCustomObject'
  _tags_by_value[73] = 'DefinedCustomObject'
  _tags_by_value[74] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[75] = 'ObjectStates'
  _tags_by_value[76] = 'RobotReadToolCode'
  _tags_by_value[77] = 'FaceEnrollmentCompleted'
  _tags_by_value[78] = 'RobotErasedEnrolledFace'
  _tags_by_value[79] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[80] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[81] = 'RobotCompletedAction'
  _tags_by_value[82] = 'BlockPickedUp'
  _tags_by_value[83] = 'BlockPlaced'
  _tags_by_value[84] = 'AnimationAvailable'
  _tags_by_value[85] = 'AnimationGroupAvailable'
  _tags_by_value[86] = 'AnimationAborted'
  _tags_by_value[87] = 'AnimationEvent'
  _tags_by_value[88] = 'MoodState'
  _tags_by_value[89] = 'RequestSetUnlockResult'
  _tags_by_value[90] = 'UnlockStatus'
  _tags_by_value[91] = 'UnlockedDefaults'
  _tags_by_value[92] = 'InitDebugConsoleVarMessage'
  _tags_by_value[93] = 'JsonDasLogMessage'
  _tags_by_value[94] = 'JsonDasLogAllSentMessage'
  _tags_by_value[95] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[96] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[97] = 'DebugAppendConsoleLogLine'
  _tags_by_value[98] = 'LatencyMessage'
  _tags_by_value[99] = 'DeviceDataMessage'
  _tags_by_value[100] = 'BlockTapFilterStatus'
  _tags_by_value[101] = 'UpdateEngineState'
  _tags_by_value[102] = 'EngineErrorCodeMessage'
  _tags_by_value[103] = 'CubeLightsStateTransition'
  _tags_by_value[104] = 'BlockPoolDataMessage'
  _tags_by_value[105] = 'NVStorageOpResult'
  _tags_by_value[106] = 'FirmwareUpdateProgress'
  _tags_by_value[107] = 'FirmwareUpdateComplete'
  _tags_by_value[108] = 'RequestGameStart'
  _tags_by_value[109] = 'HardSparkEndedByEngine'
  _tags_by_value[110] = 'SdkConnectionStatus'
  _tags_by_value[111] = 'SdkStatus'
  _tags_by_value[112] = 'BehaviorTransition'
  _tags_by_value[113] = 'ReactionTriggerTransition'
  _tags_by_value[114] = 'RespondEnabledBehaviorList'
  _tags_by_value[115] = 'BehaviorObjectiveAchieved'
  _tags_by_value[116] = 'BuildPyramidPreReqsChanged'
  _tags_by_value[117] = 'OnboardingState'
  _tags_by_value[118] = 'MemoryMapMessageBegin'
  _tags_by_value[119] = 'MemoryMapMessage'
  _tags_by_value[120] = 'MemoryMapMessageEnd'
  _tags_by_value[121] = 'SupportInfo'
  _tags_by_value[122] = 'EndOfMessage'
  ...
  _tag_unpack_methods[11] = lambda reader: reader.read_object(Anki.Cozmo.ObjectDiscovered.unpack_from)
  _tag_unpack_methods[12] = lambda reader: reader.read_object(Anki.Cozmo.ObjectConnectionState.unpack_from)
  _tag_unpack_methods[13] = lambda reader: reader.read_object(Anki.Cozmo.ObjectConnectionStateToRobot.unpack_from)
  _tag_unpack_methods[14] = lambda reader: reader.read_object(Anki.Cozmo.ObjectMoved.unpack_from)
  _tag_unpack_methods[15] = lambda reader: reader.read_object(Anki.Cozmo.ObjectStoppedMoving.unpack_from)
  _tag_unpack_methods[16] = lambda reader: reader.read_object(Anki.Cozmo.ObjectUpAxisChanged.unpack_from)
  _tag_unpack_methods[17] = lambda reader: reader.read_object(Anki.Cozmo.ObjectTappedFiltered.unpack_from)
  _tag_unpack_methods[18] = lambda reader: reader.read_object(Anki.Cozmo.ObjectTapped.unpack_from)
  _tag_unpack_methods[19] = lambda reader: reader.read_object(Anki.Cozmo.ObjectPowerLevel.unpack_from)
  _tag_unpack_methods[20] = lambda reader: reader.read_object(Anki.Cozmo.ObjectAccel.unpack_from)
  _tag_unpack_methods[21] = lambda reader: reader.read_object(Anki.Cozmo.FactoryTestResultEntry.unpack_from)
  _tag_unpack_methods[22] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[23] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[24] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[25] = lambda reader: reader.read_object(Anki.Cozmo.IMURequest.unpack_from)
  _tag_unpack_methods[26] = lambda reader: reader.read_object(Anki.Vision.LoadedKnownFace.unpack_from)
  _tag_unpack_methods[27] = lambda reader: reader.read_object(Anki.Vision.RobotRenamedEnrolledFace.unpack_from)
  _tag_unpack_methods[28] = lambda reader: reader.read_object(Anki.Cozmo.MotorCalibration.unpack_from)
  _tag_unpack_methods[29] = lambda reader: reader.read_object(Anki.Cozmo.MotorAutoEnabled.unpack_from)
  _tag_unpack_methods[30] = lambda reader: reader.read_object(Anki.Cozmo.CliffEvent.unpack_from)
  _tag_unpack_methods[31] = lambda reader: reader.read_object(Anki.Cozmo.PotentialCliff.unpack_from)
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.ProxObstacle.unpack_from)
  _tag_unpack_methods[33] = lambda reader: reader.read_object(Anki.Cozmo.CarryStateUpdate.unpack_from)
  _tag_unpack_methods[34] = lambda reader: reader.read_object(Anki.Cozmo.SetBodyRadioMode.unpack_from)
  _tag_unpack_methods[35] = lambda reader: reader.read_object(Anki.Cozmo.RobotInterface.AnimationState.unpack_from)
  _tag_unpack_methods[36] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UiDeviceAvailable.unpack_from)
  _tag_unpack_methods[37] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotConnectionResponse.unpack_from)
  _tag_unpack_methods[38] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDisconnected.unpack_from)
  _tag_unpack_methods[39] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch.unpack_from)
  _tag_unpack_methods[40] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectAvailable.unpack_from)
  _tag_unpack_methods[41] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectUnavailable.unpack_from)
  _tag_unpack_methods[42] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FeatureToggles.unpack_from)
  _tag_unpack_methods[43] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GoingToSleep.unpack_from)
  _tag_unpack_methods[44] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus.unpack_from)
  _tag_unpack_methods[45] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CurrentCameraParams.unpack_from)
  _tag_unpack_methods[46] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PerRobotSettings.unpack_from)
  _tag_unpack_methods[47] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotState.unpack_from)
  _tag_unpack_methods[48] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDelocalized.unpack_from)
  _tag_unpack_methods[49] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotPoked.unpack_from)
  _tag_unpack_methods[50] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotStopped.unpack_from)
  _tag_unpack_methods[51] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged.unpack_from)
  _tag_unpack_methods[52] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCliffEventFinished.unpack_from)
  _tag_unpack_methods[53] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent.unpack_from)
  _tag_unpack_methods[54] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ChargerEvent.unpack_from)
  _tag_unpack_methods[55] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnexpectedMovement.unpack_from)
  _tag_unpack_methods[56] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotStatus.unpack_from)
  _tag_unpack_methods[57] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotOptions.unpack_from)
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugString.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAnimationString.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotProcessedImage.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedObject.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedFace.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPet.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedMotion.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedObject.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ObjectStates.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[11] = lambda : Anki.Cozmo.ObjectDiscovered
  _type_by_tag_value[12] = lambda : Anki.Cozmo.ObjectConnectionState
  _type_by_tag_value[13] = lambda : Anki.Cozmo.ObjectConnectionStateToRobot
  _type_by_tag_value[14] = lambda : Anki.Cozmo.ObjectMoved
  _type_by_tag_value[15] = lambda : Anki.Cozmo.ObjectStoppedMoving
  _type_by_tag_value[16] = lambda : Anki.Cozmo.ObjectUpAxisChanged
  _type_by_tag_value[17] = lambda : Anki.Cozmo.ObjectTappedFiltered
  _type_by_tag_value[18] = lambda : Anki.Cozmo.ObjectTapped
  _type_by_tag_value[19] = lambda : Anki.Cozmo.ObjectPowerLevel
  _type_by_tag_value[20] = lambda : Anki.Cozmo.ObjectAccel
  _type_by_tag_value[21] = lambda : Anki.Cozmo.FactoryTestResultEntry
  _type_by_tag_value[22] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[23] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[24] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[25] = lambda : Anki.Cozmo.IMURequest
  _type_by_tag_value[26] = lambda : Anki.Vision.LoadedKnownFace
  _type_by_tag_value[27] = lambda : Anki.Vision.RobotRenamedEnrolledFace
  _type_by_tag_value[28] = lambda : Anki.Cozmo.MotorCalibration
  _type_by_tag_value[29] = lambda : Anki.Cozmo.MotorAutoEnabled
  _type_by_tag_value[30] = lambda : Anki.Cozmo.CliffEvent
  _type_by_tag_value[31] = lambda : Anki.Cozmo.PotentialCliff
  _type_by_tag_value[32] = lambda : Anki.Cozmo.ProxObstacle
  _type_by_tag_value[33] = lambda : Anki.Cozmo.CarryStateUpdate
  _type_by_tag_value[34] = lambda : Anki.Cozmo.SetBodyRadioMode
  _type_by_tag_value[35] = lambda : Anki.Cozmo.RobotInterface.AnimationState
  _type_by_tag_value[36] = lambda : Anki.Cozmo.ExternalInterface.UiDeviceAvailable
  _type_by_tag_value[37] = lambda : Anki.Cozmo.ExternalInterface.RobotConnectionResponse
  _type_by_tag_value[38] = lambda : Anki.Cozmo.ExternalInterface.RobotDisconnected
  _type_by_tag_value[39] = lambda : Anki.Cozmo.ExternalInterface.EngineRobotCLADVersionMismatch
  _type_by_tag_value[40] = lambda : Anki.Cozmo.ExternalInterface.ObjectAvailable
  _type_by_tag_value[41] = lambda : Anki.Cozmo.ExternalInterface.ObjectUnavailable
  _type_by_tag_value[42] = lambda : Anki.Cozmo.ExternalInterface.FeatureToggles
  _type_by_tag_value[43] = lambda : Anki.Cozmo.ExternalInterface.GoingToSleep
  _type_by_tag_value[44] = lambda : Anki.Cozmo.ExternalInterface.EngineLoadingDataStatus
  _type_by_tag_value[45] = lambda : Anki.Cozmo.ExternalInterface.CurrentCameraParams
  _type_by_tag_value[46] = lambda : Anki.Cozmo.ExternalInterface.PerRobotSettings
  _type_by_tag_value[47] = lambda : Anki.Cozmo.ExternalInterface.RobotState
  _type_by_tag_value[48] = lambda : Anki.Cozmo.ExternalInterface.RobotDelocalized
  _type_by_tag_value[49] = lambda : Anki.Cozmo.ExternalInterface.RobotPoked
  _type_by_tag_value[50] = lambda : Anki.Cozmo.ExternalInterface.RobotStopped
  _type_by_tag_value[51] = lambda : Anki.Cozmo.ExternalInterface.RobotOffTreadsStateChanged
  _type_by_tag_value[52] = lambda : Anki.Cozmo.ExternalInterface.RobotCliffEventFinished
  _type_by_tag_value[53] = lambda : Anki.Cozmo.ExternalInterface.RobotOnChargerPlatformEvent
  _type_by_tag_value[54] = lambda : Anki.Cozmo.ExternalInterface.ChargerEvent
  _type_by_tag_value[55] = lambda : Anki.Cozmo.ExternalInterface.UnexpectedMovement
  _type_by_tag_value[56] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotStatus
  _type_by_tag_value[57] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotOptions
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.DebugString
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.DebugAnimationString
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.RobotProcessedImage
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedObject
  _type_by_tag_value[62] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPossibleObject
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ExternalInterface.ObjectProjectsIntoFOV
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedFace
  _type_by_tag_value[65] = lambda : Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
  _type_by_tag_value[66] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPet
  _type_by_tag_value[67] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedMotion
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedObject
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllObjects
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.ObjectStates
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage

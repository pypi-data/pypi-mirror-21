...
class RobotObservedObject(object):
  ...
  def __init__(self, robotID=0, timestamp=0, objectFamily=Anki.Cozmo.ObjectFamily.Invalid, objectType=Anki.Cozmo.ObjectType.InvalidObject, objectID=0, img_rect=Anki.CladRect(), pose=Anki.PoseStruct3d(), topFaceOrientation_rad=0.0, isActive=0):
    self.robotID = robotID
    self.timestamp = timestamp
...
class RobotDeletedLocatedObject(object):
  ...
  def robotID(self, value):
    self._robotID = msgbuffers.validate_integer(
      'RobotDeletedLocatedObject.robotID', value, 0, 4294967295)
...
class MessageEngineToGame(object):
  ...
  class Tag(object):
    ...
    ProxObsDetection               = 0x20 # Anki.Cozmo.ProxObsDetection
    ...
    RobotObservedFace              = 0x3f # Anki.Cozmo.ExternalInterface.RobotObservedFace
    RobotChangedObservedFaceID     = 0x40 # Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
    RobotObservedPet               = 0x41 # Anki.Cozmo.ExternalInterface.RobotObservedPet
    RobotObservedMotion            = 0x42 # Anki.Cozmo.ExternalInterface.RobotObservedMotion
    RobotDeletedFace               = 0x43 # Anki.Cozmo.ExternalInterface.RobotDeletedFace
    RobotDeletedLocatedObject      = 0x44 # Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
    RobotDeletedAllCustomObjects   = 0x45 # Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
    CreatedFixedCustomObject       = 0x46 # Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
    DefinedCustomObject            = 0x47 # Anki.Cozmo.ExternalInterface.DefinedCustomObject
    RobotMarkedObjectPoseUnknown   = 0x48 # Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
    LocatedObjectStates            = 0x49 # Anki.Cozmo.ExternalInterface.LocatedObjectStates
    ConnectedObjectStates          = 0x4a # Anki.Cozmo.ExternalInterface.ConnectedObjectStates
    RobotReadToolCode              = 0x4b # Anki.Cozmo.ExternalInterface.RobotReadToolCode
    FaceEnrollmentCompleted        = 0x4c # Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
    RobotErasedEnrolledFace        = 0x4d # Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
    RobotErasedAllEnrolledFaces    = 0x4e # Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
    RobotCompletedFactoryDotTest   = 0x4f # Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
    RobotCompletedAction           = 0x50 # Anki.Cozmo.ExternalInterface.RobotCompletedAction
    BlockPickedUp                  = 0x51 # Anki.Cozmo.ExternalInterface.BlockPickedUp
    BlockPlaced                    = 0x52 # Anki.Cozmo.ExternalInterface.BlockPlaced
    AnimationAvailable             = 0x53 # Anki.Cozmo.ExternalInterface.AnimationAvailable
    AnimationGroupAvailable        = 0x54 # Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
    AnimationAborted               = 0x55 # Anki.Cozmo.ExternalInterface.AnimationAborted
    AnimationEvent                 = 0x56 # Anki.Cozmo.ExternalInterface.AnimationEvent
    MoodState                      = 0x57 # Anki.Cozmo.ExternalInterface.MoodState
    RequestSetUnlockResult         = 0x58 # Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
    UnlockStatus                   = 0x59 # Anki.Cozmo.ExternalInterface.UnlockStatus
    UnlockedDefaults               = 0x5a # Anki.Cozmo.ExternalInterface.UnlockedDefaults
    InitDebugConsoleVarMessage     = 0x5b # Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
    JsonDasLogMessage              = 0x5c # Anki.Cozmo.ExternalInterface.JsonDasLogMessage
    JsonDasLogAllSentMessage       = 0x5d # Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
    VerifyDebugConsoleFuncMessage  = 0x5e # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
    VerifyDebugConsoleVarMessage   = 0x5f # Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
    DebugAppendConsoleLogLine      = 0x60 # Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
    LatencyMessage                 = 0x61 # Anki.Cozmo.ExternalInterface.LatencyMessage
    DeviceDataMessage              = 0x62 # Anki.Cozmo.ExternalInterface.DeviceDataMessage
    BlockTapFilterStatus           = 0x63 # Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
    UpdateEngineState              = 0x64 # Anki.Cozmo.ExternalInterface.UpdateEngineState
    EngineErrorCodeMessage         = 0x65 # Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
    CubeLightsStateTransition      = 0x66 # Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
    BlockPoolDataMessage           = 0x67 # Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
    NVStorageOpResult              = 0x68 # Anki.Cozmo.ExternalInterface.NVStorageOpResult
    FirmwareUpdateProgress         = 0x69 # Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
    FirmwareUpdateComplete         = 0x6a # Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
    RequestGameStart               = 0x6b # Anki.Cozmo.ExternalInterface.RequestGameStart
    HardSparkEndedByEngine         = 0x6c # Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
    SdkConnectionStatus            = 0x6d # Anki.Cozmo.ExternalInterface.SdkConnectionStatus
    SdkStatus                      = 0x6e # Anki.Cozmo.ExternalInterface.SdkStatus
    BehaviorTransition             = 0x6f # Anki.Cozmo.ExternalInterface.BehaviorTransition
    ReactionTriggerTransition      = 0x70 # Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
    RespondEnabledBehaviorList     = 0x71 # Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
    BehaviorObjectiveAchieved      = 0x72 # Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
    BuildPyramidPreReqsChanged     = 0x73 # Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
    OnboardingState                = 0x74 # Anki.Cozmo.ExternalInterface.OnboardingState
    MemoryMapMessageBegin          = 0x75 # Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
    MemoryMapMessage               = 0x76 # Anki.Cozmo.ExternalInterface.MemoryMapMessage
    MemoryMapMessageEnd            = 0x77 # Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
    SupportInfo                    = 0x78 # Anki.Cozmo.ExternalInterface.SupportInfo
    EndOfMessage                   = 0x79 # Anki.Cozmo.ExternalInterface.EndOfMessage
  ...
  @property
  def ProxObsDetection(self):
    "Anki.Cozmo.ProxObsDetection ProxObsDetection union property."
    msgbuffers.safety_check_tag('ProxObsDetection', self._tag, self.Tag.ProxObsDetection, self._tags_by_value)
    return self._data

  @ProxObsDetection.setter
  def ProxObsDetection(self, value):
    self._data = msgbuffers.validate_object(
      'MessageEngineToGame.ProxObsDetection', value, Anki.Cozmo.ProxObsDetection)
    self._tag = self.Tag.ProxObsDetection
  ...
  _tags_by_name = dict(
    ...
    RobotObservedFace=63,
    RobotChangedObservedFaceID=64,
    RobotObservedPet=65,
    RobotObservedMotion=66,
    RobotDeletedFace=67,
    RobotDeletedLocatedObject=68,
    RobotDeletedAllCustomObjects=69,
    CreatedFixedCustomObject=70,
    DefinedCustomObject=71,
    RobotMarkedObjectPoseUnknown=72,
    LocatedObjectStates=73,
    ConnectedObjectStates=74,
    RobotReadToolCode=75,
    FaceEnrollmentCompleted=76,
    RobotErasedEnrolledFace=77,
    RobotErasedAllEnrolledFaces=78,
    RobotCompletedFactoryDotTest=79,
    RobotCompletedAction=80,
    BlockPickedUp=81,
    BlockPlaced=82,
    AnimationAvailable=83,
    AnimationGroupAvailable=84,
    AnimationAborted=85,
    AnimationEvent=86,
    MoodState=87,
    RequestSetUnlockResult=88,
    UnlockStatus=89,
    UnlockedDefaults=90,
    InitDebugConsoleVarMessage=91,
    JsonDasLogMessage=92,
    JsonDasLogAllSentMessage=93,
    VerifyDebugConsoleFuncMessage=94,
    VerifyDebugConsoleVarMessage=95,
    DebugAppendConsoleLogLine=96,
    LatencyMessage=97,
    DeviceDataMessage=98,
    BlockTapFilterStatus=99,
    UpdateEngineState=100,
    EngineErrorCodeMessage=101,
    CubeLightsStateTransition=102,
    BlockPoolDataMessage=103,
    NVStorageOpResult=104,
    FirmwareUpdateProgress=105,
    FirmwareUpdateComplete=106,
    RequestGameStart=107,
    HardSparkEndedByEngine=108,
    SdkConnectionStatus=109,
    SdkStatus=110,
    BehaviorTransition=111,
    ReactionTriggerTransition=112,
    RespondEnabledBehaviorList=113,
    BehaviorObjectiveAchieved=114,
    BuildPyramidPreReqsChanged=115,
    OnboardingState=116,
    MemoryMapMessageBegin=117,
    MemoryMapMessage=118,
    MemoryMapMessageEnd=119,
    SupportInfo=120,
    EndOfMessage=121,
  )
  ...
  _tags_by_value[32] = 'ProxObsDetection'
  ...
  _tags_by_value[63] = 'RobotObservedFace'
  _tags_by_value[64] = 'RobotChangedObservedFaceID'
  _tags_by_value[65] = 'RobotObservedPet'
  _tags_by_value[66] = 'RobotObservedMotion'
  _tags_by_value[67] = 'RobotDeletedFace'
  _tags_by_value[68] = 'RobotDeletedLocatedObject'
  _tags_by_value[69] = 'RobotDeletedAllCustomObjects'
  _tags_by_value[70] = 'CreatedFixedCustomObject'
  _tags_by_value[71] = 'DefinedCustomObject'
  _tags_by_value[72] = 'RobotMarkedObjectPoseUnknown'
  _tags_by_value[73] = 'LocatedObjectStates'
  _tags_by_value[74] = 'ConnectedObjectStates'
  _tags_by_value[75] = 'RobotReadToolCode'
  _tags_by_value[76] = 'FaceEnrollmentCompleted'
  _tags_by_value[77] = 'RobotErasedEnrolledFace'
  _tags_by_value[78] = 'RobotErasedAllEnrolledFaces'
  _tags_by_value[79] = 'RobotCompletedFactoryDotTest'
  _tags_by_value[80] = 'RobotCompletedAction'
  _tags_by_value[81] = 'BlockPickedUp'
  _tags_by_value[82] = 'BlockPlaced'
  _tags_by_value[83] = 'AnimationAvailable'
  _tags_by_value[84] = 'AnimationGroupAvailable'
  _tags_by_value[85] = 'AnimationAborted'
  _tags_by_value[86] = 'AnimationEvent'
  _tags_by_value[87] = 'MoodState'
  _tags_by_value[88] = 'RequestSetUnlockResult'
  _tags_by_value[89] = 'UnlockStatus'
  _tags_by_value[90] = 'UnlockedDefaults'
  _tags_by_value[91] = 'InitDebugConsoleVarMessage'
  _tags_by_value[92] = 'JsonDasLogMessage'
  _tags_by_value[93] = 'JsonDasLogAllSentMessage'
  _tags_by_value[94] = 'VerifyDebugConsoleFuncMessage'
  _tags_by_value[95] = 'VerifyDebugConsoleVarMessage'
  _tags_by_value[96] = 'DebugAppendConsoleLogLine'
  _tags_by_value[97] = 'LatencyMessage'
  _tags_by_value[98] = 'DeviceDataMessage'
  _tags_by_value[99] = 'BlockTapFilterStatus'
  _tags_by_value[100] = 'UpdateEngineState'
  _tags_by_value[101] = 'EngineErrorCodeMessage'
  _tags_by_value[102] = 'CubeLightsStateTransition'
  _tags_by_value[103] = 'BlockPoolDataMessage'
  _tags_by_value[104] = 'NVStorageOpResult'
  _tags_by_value[105] = 'FirmwareUpdateProgress'
  _tags_by_value[106] = 'FirmwareUpdateComplete'
  _tags_by_value[107] = 'RequestGameStart'
  _tags_by_value[108] = 'HardSparkEndedByEngine'
  _tags_by_value[109] = 'SdkConnectionStatus'
  _tags_by_value[110] = 'SdkStatus'
  _tags_by_value[111] = 'BehaviorTransition'
  _tags_by_value[112] = 'ReactionTriggerTransition'
  _tags_by_value[113] = 'RespondEnabledBehaviorList'
  _tags_by_value[114] = 'BehaviorObjectiveAchieved'
  _tags_by_value[115] = 'BuildPyramidPreReqsChanged'
  _tags_by_value[116] = 'OnboardingState'
  _tags_by_value[117] = 'MemoryMapMessageBegin'
  _tags_by_value[118] = 'MemoryMapMessage'
  _tags_by_value[119] = 'MemoryMapMessageEnd'
  _tags_by_value[120] = 'SupportInfo'
  _tags_by_value[121] = 'EndOfMessage'
  ...
  _tag_unpack_methods[32] = lambda reader: reader.read_object(Anki.Cozmo.ProxObsDetection.unpack_from)
  ...
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedFace.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedPet.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotObservedMotion.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedFace.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefinedCustomObject.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LocatedObjectStates.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectedObjectStates.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotReadToolCode.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RobotCompletedAction.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPickedUp.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPlaced.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAvailable.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationGroupAvailable.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationAborted.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AnimationEvent.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodState.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlockResult.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockStatus.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UnlockedDefaults.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogMessage.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LatencyMessage.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceDataMessage.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEngineState.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CubeLightsStateTransition.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolDataMessage.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageOpResult.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestGameStart.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkConnectionStatus.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SdkStatus.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorTransition.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReactionTriggerTransition.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.OnboardingState.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessage.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SupportInfo.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EndOfMessage.unpack_from)
  ...
  _type_by_tag_value[32] = lambda : Anki.Cozmo.ProxObsDetection
  ...
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedFace
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ExternalInterface.RobotChangedObservedFaceID
  _type_by_tag_value[65] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedPet
  _type_by_tag_value[66] = lambda : Anki.Cozmo.ExternalInterface.RobotObservedMotion
  _type_by_tag_value[67] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedFace
  _type_by_tag_value[68] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedLocatedObject
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.RobotDeletedAllCustomObjects
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.CreatedFixedCustomObject
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.DefinedCustomObject
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.RobotMarkedObjectPoseUnknown
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.LocatedObjectStates
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.ConnectedObjectStates
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.RobotReadToolCode
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.FaceEnrollmentCompleted
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedEnrolledFace
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.RobotErasedAllEnrolledFaces
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedFactoryDotTest
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.RobotCompletedAction
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.BlockPickedUp
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.BlockPlaced
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.AnimationAvailable
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.AnimationGroupAvailable
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.AnimationAborted
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.AnimationEvent
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.MoodState
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlockResult
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.UnlockStatus
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.UnlockedDefaults
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.InitDebugConsoleVarMessage
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogMessage
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.JsonDasLogAllSentMessage
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleFuncMessage
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.VerifyDebugConsoleVarMessage
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.DebugAppendConsoleLogLine
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.LatencyMessage
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.DeviceDataMessage
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.BlockTapFilterStatus
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.UpdateEngineState
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.EngineErrorCodeMessage
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.CubeLightsStateTransition
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolDataMessage
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.NVStorageOpResult
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateProgress
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.FirmwareUpdateComplete
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.RequestGameStart
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.HardSparkEndedByEngine
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.SdkConnectionStatus
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.SdkStatus
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.BehaviorTransition
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.ReactionTriggerTransition
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.RespondEnabledBehaviorList
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.BehaviorObjectiveAchieved
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.BuildPyramidPreReqsChanged
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.OnboardingState
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageBegin
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessage
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.MemoryMapMessageEnd
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.SupportInfo
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.EndOfMessage

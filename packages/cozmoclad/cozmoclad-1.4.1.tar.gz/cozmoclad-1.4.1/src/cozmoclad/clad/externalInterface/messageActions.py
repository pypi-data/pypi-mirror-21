...
class PlayCubeAnimationTrigger(object):
  ...
  def robotID(self, value):
    self._robotID = msgbuffers.validate_integer(
      'PlayCubeAnimationTrigger.robotID', value, 0, 255)
  ...
  def __init__(self, robotID=0, objectID=0, trigger=Anki.Cozmo.CubeAnimationTrigger.Carrying):
    self.robotID = robotID
    self.objectID = objectID
    self.trigger = trigger
  ...
  def unpack_from(cls, reader):
    ...
    _objectID = reader.read('I')
    _trigger = reader.read('i')
    return cls(_robotID, _objectID, _trigger)
  ...
  def __str__(self):
    return '{type}(robotID={robotID}, objectID={objectID}, trigger={trigger})'.format(
      type=type(self).__name__,
      robotID=self._robotID,
      objectID=self._objectID,
      trigger=self._trigger)

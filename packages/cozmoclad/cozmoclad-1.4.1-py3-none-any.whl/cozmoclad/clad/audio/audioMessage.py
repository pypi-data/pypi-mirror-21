...
class PostAudioGameState(object):
  ...
  def __init__(self, stateGroup=Anki.AudioMetaData.GameState.StateGroupType.External_Name, stateValue=Anki.AudioMetaData.GameState.GenericState.Invalid):
...
class PostAudioSwitchState(object):
  ...
  def __init__(self, switchStateGroup=Anki.AudioMetaData.SwitchState.SwitchGroupType.Cozmo_Voice_Processing, switchStateValue=Anki.AudioMetaData.SwitchState.GenericSwitch.Invalid, gameObject=Anki.AudioMetaData.GameObjectType.Invalid):
...
class PostAudioParameter(object):
  ...
  def __init__(self, parameter=Anki.AudioMetaData.GameParameter.ParameterType.Cozmo_Singing_Vibrato, parameterValue=0.0, gameObject=Anki.AudioMetaData.GameObjectType.Invalid, timeInMilliSeconds=0, curve=Anki.AudioEngine.Multiplexer.CurveType.Linear):

...
Full command line: ../tools/message-buffers/emitters/Python_emitter.py -C ./src/ -I ../robot/clad/src/ ../coretech/vision/clad/src/ ../coretech/common/clad/src/ -o ../generated/cladPython// clad/types/actionTypes.clad
"""
...
class RobotActionType(object):
  ...
  PLAY_ANIMATION                    = 26
  PLAY_CUBE_ANIMATION               = 27
  POP_A_WHEELIE                     = 28
  READ_TOOL_CODE                    = 29
  ROLL_OBJECT_LOW                   = 30
  SAY_TEXT                          = 31
  SEARCH_FOR_NEARBY_OBJECT          = 32
  TRACK_OBJECT                      = 33
  TRACK_FACE                        = 34
  TRACK_MOTION                      = 35
  TRACK_PET_FACE                    = 36
  TRAVERSE_OBJECT                   = 37
  TURN_IN_PLACE                     = 38
  TURN_TOWARDS_FACE                 = 39
  TURN_TOWARDS_IMAGE_POINT          = 40
  TURN_TOWARDS_LAST_FACE_POSE       = 41
  TURN_TOWARDS_OBJECT               = 42
  TURN_TOWARDS_POSE                 = 43
  VISUALLY_VERIFY_OBJECT            = 44
  VISUALLY_VERIFY_FACE              = 45
  VISUALLY_VERIFY_NO_OBJECT_AT_POSE = 46
  WAIT                              = 47
  WAIT_FOR_IMAGES                   = 48
  WAIT_FOR_LAMBDA                   = 49
...
class ObjectInteractionCompleted(object):
  ...
  def __init__(self, objectIDs=(0,) * 5, numObjects=0):
  ...
  def unpack_from(cls, reader):
    ...
    return cls(_objectIDs, _numObjects)
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return (self._objectIDs == other._objectIDs and
        self._numObjects == other._numObjects)
    else:
  ...
  def __str__(self):
    return '{type}(objectIDs={objectIDs}, numObjects={numObjects})'.format(
...
class DeviceAudioCompleted(object):
  ...
  def __init__(self, audioEvent=Anki.Cozmo.Audio.GameEvent.GenericEvent.Invalid):
...
class ActionCompletedUnion(object):
  ...
  class Tag(object):
    ...
    defaultCompleted           = 5 # Anki.Cozmo.DefaultCompleted
  ...
  _tags_by_value[5] = 'defaultCompleted'
  ...
  _tag_unpack_methods[5] = lambda reader: reader.read_object(Anki.Cozmo.DefaultCompleted.unpack_from)
  ...
  _type_by_tag_value[5] = lambda : Anki.Cozmo.DefaultCompleted

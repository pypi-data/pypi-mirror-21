...
class StartEngine(object):
  ...
  def __eq__(self, other):
    if type(self) is type(other):
      return self._random_seed == other._random_seed
    else:
      return NotImplemented
  ...
  def __str__(self):
    return '{type}(random_seed={random_seed})'.format(
      type=type(self).__name__,
...
class SetFeatureToggle(object):
  ...
  def __init__(self, feature=Anki.Cozmo.FeatureType.ObjectTapInteractions, value=False):
...
class DefineCustomCube(object):
  ...
  def __init__(self, customType=Anki.Cozmo.ObjectType.Invalid, marker=Anki.Cozmo.CustomObjectMarker.Circles2, size_mm=0.0, markerWidth_mm=0.0, markerHeight_mm=0.0, isUnique=False):
    self.customType = customType
    self.marker = marker
...
class DefineCustomWall(object):
  ...
  def __init__(self, customType=Anki.Cozmo.ObjectType.Invalid, marker=Anki.Cozmo.CustomObjectMarker.Circles2, width_mm=0.0, height_mm=0.0, markerWidth_mm=0.0, markerHeight_mm=0.0, isUnique=False):
    self.customType = customType
    self.marker = marker
...
class RequestEnableReactionTrigger(object):
  "Generated message-passing message."
  ...
  def requesterID(self, value):
    self._requesterID = msgbuffers.validate_string(
      'RequestEnableReactionTrigger.requesterID', value, 255)
  ...
  def trigger(self, value):
    self._trigger = msgbuffers.validate_integer(
      'RequestEnableReactionTrigger.trigger', value, 0, 255)
  ...
  def enable(self, value):
    self._enable = msgbuffers.validate_bool(
      'RequestEnableReactionTrigger.enable', value)

  def __init__(self, requesterID='', trigger=Anki.Cozmo.ReactionTrigger.NoneTrigger, enable=False):
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new RequestEnableReactionTrigger from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('RequestEnableReactionTrigger.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new RequestEnableReactionTrigger from the given BinaryReader."
    _requesterID = reader.read_string('B')
    _trigger = reader.read('B')
    _enable = bool(reader.read('b'))
    return cls(_requesterID, _trigger, _enable)

  def pack(self):
    "Writes the current RequestEnableReactionTrigger, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current RequestEnableReactionTrigger to the given BinaryWriter."
  ...
  def __len__(self):
    return (msgbuffers.size_string(self._requesterID, 'B') +
      msgbuffers.size(self._trigger, 'B') +
      msgbuffers.size(self._enable, 'b'))

  def __str__(self):
    return '{type}(requesterID={requesterID}, trigger={trigger}, enable={enable})'.format(
      type=type(self).__name__,
...
Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger = RequestEnableReactionTrigger
del RequestEnableReactionTrigger
...
class RequestObjectStates(object):
  "Generated message-passing message."
  ...
  def connectedObjectsOnly(self, value):
    self._connectedObjectsOnly = msgbuffers.validate_bool(
      'RequestObjectStates.connectedObjectsOnly', value)
  ...
  @classmethod
  def unpack(cls, buffer):
    "Reads a new RequestObjectStates from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('RequestObjectStates.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new RequestObjectStates from the given BinaryReader."
    _connectedObjectsOnly = bool(reader.read('b'))
    return cls(_connectedObjectsOnly)

  def pack(self):
    "Writes the current RequestObjectStates, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current RequestObjectStates to the given BinaryWriter."
...
Anki.Cozmo.ExternalInterface.RequestObjectStates = RequestObjectStates
del RequestObjectStates
...
class EnableAllReactionTriggers(object):
  "Generated message-passing message."

  __slots__ = (
    '_enableID', # string[uint_8]
    '_enabled',  # bool
  )

  @property
  def enableID(self):
    "string[uint_8] enableID struct property."
    return self._enableID

  @enableID.setter
  def enableID(self, value):
    self._enableID = msgbuffers.validate_string(
      'EnableAllReactionTriggers.enableID', value, 255)
  ...
  def enabled(self, value):
    self._enabled = msgbuffers.validate_bool(
      'EnableAllReactionTriggers.enabled', value)

  def __init__(self, enableID='', enabled=False):
    self.enableID = enableID
    self.enabled = enabled

  @classmethod
  def unpack(cls, buffer):
    "Reads a new EnableAllReactionTriggers from the given buffer."
    reader = msgbuffers.BinaryReader(buffer)
    value = cls.unpack_from(reader)
    if reader.tell() != len(reader):
      raise msgbuffers.ReadError(
        ('EnableAllReactionTriggers.unpack received a buffer of length {length}, ' +
        'but only {position} bytes were read.').format(
        length=len(reader), position=reader.tell()))
    return value
  ...
  @classmethod
  def unpack_from(cls, reader):
    "Reads a new EnableAllReactionTriggers from the given BinaryReader."
    _enableID = reader.read_string('B')
    _enabled = bool(reader.read('b'))
    return cls(_enableID, _enabled)

  def pack(self):
    "Writes the current EnableAllReactionTriggers, returning bytes."
    writer = msgbuffers.BinaryWriter()
    self.pack_to(writer)
    return writer.dumps()

  def pack_to(self, writer):
    "Writes the current EnableAllReactionTriggers to the given BinaryWriter."
    writer.write_string(self._enableID, 'B')
    writer.write(int(self._enabled), 'b')

  def __eq__(self, other):
    if type(self) is type(other):
      return (self._enableID == other._enableID and
  ...
  def __len__(self):
    return (msgbuffers.size_string(self._enableID, 'B') +
      msgbuffers.size(self._enabled, 'b'))

  def __str__(self):
    return '{type}(enableID={enableID}, enabled={enabled})'.format(
      type=type(self).__name__,
      enableID=msgbuffers.shorten_string(self._enableID),
      enabled=self._enabled)

  def __repr__(self):
    return '{type}(enableID={enableID}, enabled={enabled})'.format(
      type=type(self).__name__,
      enableID=repr(self._enableID),
      enabled=repr(self._enabled))

Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers = EnableAllReactionTriggers
del EnableAllReactionTriggers
...
class MessageGameToEngine(object):
  ...
  class Tag(object):
    ...
    DeviceAccelerometerValuesRaw            = 0x39 # Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw
    DeviceAccelerometerValuesUser           = 0x3a # Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser
    DeviceGyroValues                        = 0x3b # Anki.Cozmo.ExternalInterface.DeviceGyroValues
    EnableDeviceIMUData                     = 0x3c # Anki.Cozmo.ExternalInterface.EnableDeviceIMUData
    IsDeviceIMUSupported                    = 0x3d # Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported
    SetVizOrigin                            = 0x3e # Anki.Cozmo.SetVizOrigin
    ImageChunk                              = 0x3f # Anki.Cozmo.ImageChunk
    ImageImuData                            = 0x40 # Anki.Cozmo.ImageImuData
    CameraCalibration                       = 0x41 # Anki.Cozmo.CameraCalibration
    IMURequest                              = 0x42 # Anki.Cozmo.IMURequest
    StartControllerTestMode                 = 0x43 # Anki.Cozmo.StartControllerTestMode
    RawPWM                                  = 0x44 # Anki.Cozmo.RawPWM
    UiDeviceConnectionSuccess               = 0x45 # Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess
    ConnectToRobot                          = 0x46 # Anki.Cozmo.ExternalInterface.ConnectToRobot
    ConnectToUiDevice                       = 0x47 # Anki.Cozmo.ExternalInterface.ConnectToUiDevice
    DisconnectFromUiDevice                  = 0x48 # Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice
    StartEngine                             = 0x49 # Anki.Cozmo.ExternalInterface.StartEngine
    ReliableTransportRunMode                = 0x4a # Anki.Cozmo.ExternalInterface.ReliableTransportRunMode
    RequestFeatureToggles                   = 0x4b # Anki.Cozmo.ExternalInterface.RequestFeatureToggles
    SetFeatureToggle                        = 0x4c # Anki.Cozmo.ExternalInterface.SetFeatureToggle
    StartIdleTimeout                        = 0x4d # Anki.Cozmo.ExternalInterface.StartIdleTimeout
    CancelIdleTimeout                       = 0x4e # Anki.Cozmo.ExternalInterface.CancelIdleTimeout
    SetGameBeingPaused                      = 0x4f # Anki.Cozmo.ExternalInterface.SetGameBeingPaused
    UpdateFirmware                          = 0x50 # Anki.Cozmo.ExternalInterface.UpdateFirmware
    ResetFirmware                           = 0x51 # Anki.Cozmo.ExternalInterface.ResetFirmware
    DriveWheels                             = 0x52 # Anki.Cozmo.ExternalInterface.DriveWheels
    DriveArc                                = 0x53 # Anki.Cozmo.ExternalInterface.DriveArc
    MoveHead                                = 0x54 # Anki.Cozmo.ExternalInterface.MoveHead
    MoveLift                                = 0x55 # Anki.Cozmo.ExternalInterface.MoveLift
    EnableLiftPower                         = 0x56 # Anki.Cozmo.ExternalInterface.EnableLiftPower
    EnableCliffSensor                       = 0x57 # Anki.Cozmo.ExternalInterface.EnableCliffSensor
    EnableBlockTapFilter                    = 0x58 # Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
    GetBlockTapFilterStatus                 = 0x59 # Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
    StopAllMotors                           = 0x5a # Anki.Cozmo.ExternalInterface.StopAllMotors
    ControllerGains                         = 0x5b # Anki.Cozmo.ExternalInterface.ControllerGains
    RollActionParams                        = 0x5c # Anki.Cozmo.ExternalInterface.RollActionParams
    SetMotionModelParams                    = 0x5d # Anki.Cozmo.ExternalInterface.SetMotionModelParams
    SetRobotVolume                          = 0x5e # Anki.Cozmo.ExternalInterface.SetRobotVolume
    SetRobotAudioOutputSource               = 0x5f # Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
    ForceDelocalizeRobot                    = 0x60 # Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
    RestoreRobotFromBackup                  = 0x61 # Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
    RequestRobotRestoreData                 = 0x62 # Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
    WipeRobotGameData                       = 0x63 # Anki.Cozmo.ExternalInterface.WipeRobotGameData
    RequestUnlockDataFromBackup             = 0x64 # Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
    CancelAction                            = 0x65 # Anki.Cozmo.ExternalInterface.CancelAction
    CancelActionByIdTag                     = 0x66 # Anki.Cozmo.ExternalInterface.CancelActionByIdTag
    QueueSingleAction                       = 0x67 # Anki.Cozmo.ExternalInterface.QueueSingleAction
    QueueCompoundAction                     = 0x68 # Anki.Cozmo.ExternalInterface.QueueCompoundAction
    ImageRequest                            = 0x69 # Anki.Cozmo.ExternalInterface.ImageRequest
    SetRobotImageSendMode                   = 0x6a # Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
    SaveImages                              = 0x6b # Anki.Cozmo.ExternalInterface.SaveImages
    EnableColorImages                       = 0x6c # Anki.Cozmo.ExternalInterface.EnableColorImages
    SaveRobotState                          = 0x6d # Anki.Cozmo.ExternalInterface.SaveRobotState
    EnableDisplay                           = 0x6e # Anki.Cozmo.ExternalInterface.EnableDisplay
    ExecuteTestPlan                         = 0x6f # Anki.Cozmo.ExternalInterface.ExecuteTestPlan
    PlannerRunMode                          = 0x70 # Anki.Cozmo.ExternalInterface.PlannerRunMode
    SelectNextObject                        = 0x71 # Anki.Cozmo.ExternalInterface.SelectNextObject
    SetRobotCarryingObject                  = 0x72 # Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
    ClearAllBlocks                          = 0x73 # Anki.Cozmo.ExternalInterface.ClearAllBlocks
    ClearAllObjects                         = 0x74 # Anki.Cozmo.ExternalInterface.ClearAllObjects
    DeleteAllObjects                        = 0x75 # Anki.Cozmo.ExternalInterface.DeleteAllObjects
    DeleteAllCustomObjects                  = 0x76 # Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
    CreateFixedCustomObject                 = 0x77 # Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
    DefineCustomBox                         = 0x78 # Anki.Cozmo.ExternalInterface.DefineCustomBox
    DefineCustomCube                        = 0x79 # Anki.Cozmo.ExternalInterface.DefineCustomCube
    DefineCustomWall                        = 0x7a # Anki.Cozmo.ExternalInterface.DefineCustomWall
    SetObjectAdditionAndDeletion            = 0x7b # Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion
    VisionWhileMoving                       = 0x7c # Anki.Cozmo.ExternalInterface.VisionWhileMoving
    SetFaceToEnroll                         = 0x7d # Anki.Cozmo.ExternalInterface.SetFaceToEnroll
    CancelFaceEnrollment                    = 0x7e # Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
    EraseEnrolledFaceByID                   = 0x7f # Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
    EraseAllEnrolledFaces                   = 0x80 # Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
    EnableVisionMode                        = 0x81 # Anki.Cozmo.ExternalInterface.EnableVisionMode
    UpdateEnrolledFaceByID                  = 0x82 # Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
    VisionRunMode                           = 0x83 # Anki.Cozmo.ExternalInterface.VisionRunMode
    SaveFaceAlbumToFile                     = 0x84 # Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
    LoadFaceAlbumFromFile                   = 0x85 # Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
    SetMemoryMapRenderEnabled               = 0x86 # Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
    SetMemoryMapBroadcastFrequency_sec      = 0x87 # Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
    ActivateBehaviorChooser                 = 0x88 # Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
    ExecuteBehaviorByExecutableType         = 0x89 # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
    ExecuteBehaviorByName                   = 0x8a # Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
    SetLiftLoadTestAsRunnable               = 0x8b # Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
    BehaviorManagerMessage                  = 0x8c # Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
    AbortPath                               = 0x8d # Anki.Cozmo.ExternalInterface.AbortPath
    AbortAll                                = 0x8e # Anki.Cozmo.ExternalInterface.AbortAll
    StartTestMode                           = 0x8f # Anki.Cozmo.ExternalInterface.StartTestMode
    RequestEnabledBehaviorList              = 0x90 # Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
    RequestEnableReactionTrigger            = 0x91 # Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger
    SetDefaultHeadAndLiftState              = 0x92 # Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
    RequestObjectStates                     = 0x93 # Anki.Cozmo.ExternalInterface.RequestObjectStates
    DrawPoseMarker                          = 0x94 # Anki.Cozmo.ExternalInterface.DrawPoseMarker
    ErasePoseMarker                         = 0x95 # Anki.Cozmo.ExternalInterface.ErasePoseMarker
    VisualizeQuad                           = 0x96 # Anki.Cozmo.ExternalInterface.VisualizeQuad
    EraseQuad                               = 0x97 # Anki.Cozmo.ExternalInterface.EraseQuad
    ReplayLastAnimation                     = 0x98 # Anki.Cozmo.ExternalInterface.ReplayLastAnimation
    SetIdleAnimation                        = 0x99 # Anki.Cozmo.ExternalInterface.SetIdleAnimation
    PushIdleAnimation                       = 0x9a # Anki.Cozmo.ExternalInterface.PushIdleAnimation
    PopIdleAnimation                        = 0x9b # Anki.Cozmo.ExternalInterface.PopIdleAnimation
    ReadFaceAnimationDir                    = 0x9c # Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
    ReadAnimationFile                       = 0x9d # Anki.Cozmo.ExternalInterface.ReadAnimationFile
    RequestAvailableAnimations              = 0x9e # Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
    RequestAvailableAnimationGroups         = 0x9f # Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
    SetLiveIdleAnimationParameters          = 0xa0 # Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
    PushDrivingAnimations                   = 0xa1 # Anki.Cozmo.ExternalInterface.PushDrivingAnimations
    PopDrivingAnimations                    = 0xa2 # Anki.Cozmo.ExternalInterface.PopDrivingAnimations
    SetHeadlight                            = 0xa3 # Anki.Cozmo.ExternalInterface.SetHeadlight
    SetActiveObjectLEDs                     = 0xa4 # Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
    SetAllActiveObjectLEDs                  = 0xa5 # Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
    SetBackpackLEDs                         = 0xa6 # Anki.Cozmo.ExternalInterface.SetBackpackLEDs
    EnableLightStates                       = 0xa7 # Anki.Cozmo.ExternalInterface.EnableLightStates
    EnableCubeSleep                         = 0xa8 # Anki.Cozmo.ExternalInterface.EnableCubeSleep
    EnableCubeLightsStateTransitionMessages = 0xa9 # Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
    FlashCurrentLightsState                 = 0xaa # Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
    PlayCubeAnim                            = 0xab # Anki.Cozmo.ExternalInterface.PlayCubeAnim
    StopCubeAnim                            = 0xac # Anki.Cozmo.ExternalInterface.StopCubeAnim
    StreamObjectAccel                       = 0xad # Anki.Cozmo.ExternalInterface.StreamObjectAccel
    TransitionToNextOnboardingState         = 0xae # Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
    MoodMessage                             = 0xaf # Anki.Cozmo.ExternalInterface.MoodMessage
    ProgressionMessage                      = 0xb0 # Anki.Cozmo.ExternalInterface.ProgressionMessage
    RequestSetUnlock                        = 0xb1 # Anki.Cozmo.ExternalInterface.RequestSetUnlock
    RequestDeviceData                       = 0xb2 # Anki.Cozmo.ExternalInterface.RequestDeviceData
    SetDebugConsoleVarMessage               = 0xb3 # Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
    RunDebugConsoleFuncMessage              = 0xb4 # Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
    GetDebugConsoleVarMessage               = 0xb5 # Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
    GetAllDebugConsoleVarMessage            = 0xb6 # Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
    GetJsonDasLogsMessage                   = 0xb7 # Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
    EnableAllReactionTriggers               = 0xb8 # Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers
    SetEnableSpeedChooser                   = 0xb9 # Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
    BlockPoolEnabledMessage                 = 0xba # Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
    BlockSelectedMessage                    = 0xbb # Anki.Cozmo.ExternalInterface.BlockSelectedMessage
    GetBlockPoolMessage                     = 0xbc # Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
    SendAvailableObjects                    = 0xbd # Anki.Cozmo.ExternalInterface.SendAvailableObjects
    BlockPoolResetMessage                   = 0xbe # Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
    SaveCalibrationImage                    = 0xbf # Anki.Cozmo.ExternalInterface.SaveCalibrationImage
    ClearCalibrationImages                  = 0xc0 # Anki.Cozmo.ExternalInterface.ClearCalibrationImages
    ComputeCameraCalibration                = 0xc1 # Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
    ContinueFreeplayFromIdle                = 0xc2 # Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
    EnableDroneMode                         = 0xc3 # Anki.Cozmo.ExternalInterface.EnableDroneMode
    EnterSdkMode                            = 0xc4 # Anki.Cozmo.ExternalInterface.EnterSdkMode
    ExitSdkMode                             = 0xc5 # Anki.Cozmo.ExternalInterface.ExitSdkMode
    SetStopRobotOnSdkDisconnect             = 0xc6 # Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
    StopRobotForSdk                         = 0xc7 # Anki.Cozmo.ExternalInterface.StopRobotForSdk
    TransferFile                            = 0xc8 # Anki.Cozmo.ExternalInterface.TransferFile
    NVStorageEraseEntry                     = 0xc9 # Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
    NVStorageWipeAll                        = 0xca # Anki.Cozmo.ExternalInterface.NVStorageWipeAll
    NVStorageWriteEntry                     = 0xcb # Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
    NVStorageClearPartialPendingWriteEntry  = 0xcc # Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
    NVStorageReadEntry                      = 0xcd # Anki.Cozmo.ExternalInterface.NVStorageReadEntry
    SetCameraSettings                       = 0xce # Anki.Cozmo.ExternalInterface.SetCameraSettings
    RequestRobotSettings                    = 0xcf # Anki.Cozmo.ExternalInterface.RequestRobotSettings
  ...
  @property
  def RequestEnableReactionTrigger(self):
    "Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger RequestEnableReactionTrigger union property."
    msgbuffers.safety_check_tag('RequestEnableReactionTrigger', self._tag, self.Tag.RequestEnableReactionTrigger, self._tags_by_value)
    return self._data

  @RequestEnableReactionTrigger.setter
  def RequestEnableReactionTrigger(self, value):
    self._data = msgbuffers.validate_object(
      'MessageGameToEngine.RequestEnableReactionTrigger', value, Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger)
    self._tag = self.Tag.RequestEnableReactionTrigger
  ...
  @property
  def RequestObjectStates(self):
    "Anki.Cozmo.ExternalInterface.RequestObjectStates RequestObjectStates union property."
    msgbuffers.safety_check_tag('RequestObjectStates', self._tag, self.Tag.RequestObjectStates, self._tags_by_value)
    return self._data

  @RequestObjectStates.setter
  def RequestObjectStates(self, value):
    self._data = msgbuffers.validate_object(
      'MessageGameToEngine.RequestObjectStates', value, Anki.Cozmo.ExternalInterface.RequestObjectStates)
    self._tag = self.Tag.RequestObjectStates
  ...
  @property
  def EnableAllReactionTriggers(self):
    "Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers EnableAllReactionTriggers union property."
    msgbuffers.safety_check_tag('EnableAllReactionTriggers', self._tag, self.Tag.EnableAllReactionTriggers, self._tags_by_value)
    return self._data

  @EnableAllReactionTriggers.setter
  def EnableAllReactionTriggers(self, value):
    self._data = msgbuffers.validate_object(
      'MessageGameToEngine.EnableAllReactionTriggers', value, Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers)
    self._tag = self.Tag.EnableAllReactionTriggers
  ...
  _tags_by_name = dict(
    ...
    Ping=55,
    DenyGameStart=56,
    DeviceAccelerometerValuesRaw=57,
    DeviceAccelerometerValuesUser=58,
    DeviceGyroValues=59,
    EnableDeviceIMUData=60,
    IsDeviceIMUSupported=61,
    SetVizOrigin=62,
    ImageChunk=63,
    ImageImuData=64,
    CameraCalibration=65,
    IMURequest=66,
    StartControllerTestMode=67,
    RawPWM=68,
    UiDeviceConnectionSuccess=69,
    ConnectToRobot=70,
    ConnectToUiDevice=71,
    DisconnectFromUiDevice=72,
    StartEngine=73,
    ReliableTransportRunMode=74,
    RequestFeatureToggles=75,
    SetFeatureToggle=76,
    StartIdleTimeout=77,
    CancelIdleTimeout=78,
    SetGameBeingPaused=79,
    UpdateFirmware=80,
    ResetFirmware=81,
    DriveWheels=82,
    DriveArc=83,
    ...
    MoveLift=85,
    EnableLiftPower=86,
    EnableCliffSensor=87,
    EnableBlockTapFilter=88,
    GetBlockTapFilterStatus=89,
    StopAllMotors=90,
    ControllerGains=91,
    RollActionParams=92,
    SetMotionModelParams=93,
    SetRobotVolume=94,
    SetRobotAudioOutputSource=95,
    ForceDelocalizeRobot=96,
    RestoreRobotFromBackup=97,
    RequestRobotRestoreData=98,
    WipeRobotGameData=99,
    RequestUnlockDataFromBackup=100,
    CancelAction=101,
    CancelActionByIdTag=102,
    QueueSingleAction=103,
    QueueCompoundAction=104,
    ImageRequest=105,
    SetRobotImageSendMode=106,
    SaveImages=107,
    EnableColorImages=108,
    SaveRobotState=109,
    EnableDisplay=110,
    ExecuteTestPlan=111,
    PlannerRunMode=112,
    SelectNextObject=113,
    SetRobotCarryingObject=114,
    ClearAllBlocks=115,
    ClearAllObjects=116,
    DeleteAllObjects=117,
    DeleteAllCustomObjects=118,
    CreateFixedCustomObject=119,
    DefineCustomBox=120,
    DefineCustomCube=121,
    DefineCustomWall=122,
    SetObjectAdditionAndDeletion=123,
    VisionWhileMoving=124,
    SetFaceToEnroll=125,
    CancelFaceEnrollment=126,
    EraseEnrolledFaceByID=127,
    EraseAllEnrolledFaces=128,
    EnableVisionMode=129,
    UpdateEnrolledFaceByID=130,
    VisionRunMode=131,
    SaveFaceAlbumToFile=132,
    LoadFaceAlbumFromFile=133,
    SetMemoryMapRenderEnabled=134,
    SetMemoryMapBroadcastFrequency_sec=135,
    ActivateBehaviorChooser=136,
    ExecuteBehaviorByExecutableType=137,
    ExecuteBehaviorByName=138,
    SetLiftLoadTestAsRunnable=139,
    BehaviorManagerMessage=140,
    AbortPath=141,
    AbortAll=142,
    StartTestMode=143,
    RequestEnabledBehaviorList=144,
    RequestEnableReactionTrigger=145,
    SetDefaultHeadAndLiftState=146,
    RequestObjectStates=147,
    DrawPoseMarker=148,
    ErasePoseMarker=149,
    VisualizeQuad=150,
    EraseQuad=151,
    ReplayLastAnimation=152,
    SetIdleAnimation=153,
    PushIdleAnimation=154,
    PopIdleAnimation=155,
    ReadFaceAnimationDir=156,
    ReadAnimationFile=157,
    RequestAvailableAnimations=158,
    RequestAvailableAnimationGroups=159,
    SetLiveIdleAnimationParameters=160,
    PushDrivingAnimations=161,
    PopDrivingAnimations=162,
    SetHeadlight=163,
    SetActiveObjectLEDs=164,
    SetAllActiveObjectLEDs=165,
    SetBackpackLEDs=166,
    EnableLightStates=167,
    EnableCubeSleep=168,
    EnableCubeLightsStateTransitionMessages=169,
    FlashCurrentLightsState=170,
    PlayCubeAnim=171,
    StopCubeAnim=172,
    StreamObjectAccel=173,
    TransitionToNextOnboardingState=174,
    MoodMessage=175,
    ProgressionMessage=176,
    RequestSetUnlock=177,
    RequestDeviceData=178,
    SetDebugConsoleVarMessage=179,
    RunDebugConsoleFuncMessage=180,
    GetDebugConsoleVarMessage=181,
    GetAllDebugConsoleVarMessage=182,
    GetJsonDasLogsMessage=183,
    EnableAllReactionTriggers=184,
    SetEnableSpeedChooser=185,
    BlockPoolEnabledMessage=186,
    BlockSelectedMessage=187,
    GetBlockPoolMessage=188,
    SendAvailableObjects=189,
    BlockPoolResetMessage=190,
    SaveCalibrationImage=191,
    ClearCalibrationImages=192,
    ComputeCameraCalibration=193,
    ContinueFreeplayFromIdle=194,
    EnableDroneMode=195,
    EnterSdkMode=196,
    ExitSdkMode=197,
    SetStopRobotOnSdkDisconnect=198,
    StopRobotForSdk=199,
    TransferFile=200,
    NVStorageEraseEntry=201,
    NVStorageWipeAll=202,
    NVStorageWriteEntry=203,
    NVStorageClearPartialPendingWriteEntry=204,
    NVStorageReadEntry=205,
    SetCameraSettings=206,
    RequestRobotSettings=207,
  )
  ...
  _tags_by_value[57] = 'DeviceAccelerometerValuesRaw'
  _tags_by_value[58] = 'DeviceAccelerometerValuesUser'
  _tags_by_value[59] = 'DeviceGyroValues'
  _tags_by_value[60] = 'EnableDeviceIMUData'
  _tags_by_value[61] = 'IsDeviceIMUSupported'
  _tags_by_value[62] = 'SetVizOrigin'
  _tags_by_value[63] = 'ImageChunk'
  _tags_by_value[64] = 'ImageImuData'
  _tags_by_value[65] = 'CameraCalibration'
  _tags_by_value[66] = 'IMURequest'
  _tags_by_value[67] = 'StartControllerTestMode'
  _tags_by_value[68] = 'RawPWM'
  _tags_by_value[69] = 'UiDeviceConnectionSuccess'
  _tags_by_value[70] = 'ConnectToRobot'
  _tags_by_value[71] = 'ConnectToUiDevice'
  _tags_by_value[72] = 'DisconnectFromUiDevice'
  _tags_by_value[73] = 'StartEngine'
  _tags_by_value[74] = 'ReliableTransportRunMode'
  _tags_by_value[75] = 'RequestFeatureToggles'
  _tags_by_value[76] = 'SetFeatureToggle'
  _tags_by_value[77] = 'StartIdleTimeout'
  _tags_by_value[78] = 'CancelIdleTimeout'
  _tags_by_value[79] = 'SetGameBeingPaused'
  _tags_by_value[80] = 'UpdateFirmware'
  _tags_by_value[81] = 'ResetFirmware'
  _tags_by_value[82] = 'DriveWheels'
  _tags_by_value[83] = 'DriveArc'
  _tags_by_value[84] = 'MoveHead'
  _tags_by_value[85] = 'MoveLift'
  _tags_by_value[86] = 'EnableLiftPower'
  _tags_by_value[87] = 'EnableCliffSensor'
  _tags_by_value[88] = 'EnableBlockTapFilter'
  _tags_by_value[89] = 'GetBlockTapFilterStatus'
  _tags_by_value[90] = 'StopAllMotors'
  _tags_by_value[91] = 'ControllerGains'
  _tags_by_value[92] = 'RollActionParams'
  _tags_by_value[93] = 'SetMotionModelParams'
  _tags_by_value[94] = 'SetRobotVolume'
  _tags_by_value[95] = 'SetRobotAudioOutputSource'
  _tags_by_value[96] = 'ForceDelocalizeRobot'
  _tags_by_value[97] = 'RestoreRobotFromBackup'
  _tags_by_value[98] = 'RequestRobotRestoreData'
  _tags_by_value[99] = 'WipeRobotGameData'
  _tags_by_value[100] = 'RequestUnlockDataFromBackup'
  _tags_by_value[101] = 'CancelAction'
  _tags_by_value[102] = 'CancelActionByIdTag'
  _tags_by_value[103] = 'QueueSingleAction'
  _tags_by_value[104] = 'QueueCompoundAction'
  _tags_by_value[105] = 'ImageRequest'
  _tags_by_value[106] = 'SetRobotImageSendMode'
  _tags_by_value[107] = 'SaveImages'
  _tags_by_value[108] = 'EnableColorImages'
  _tags_by_value[109] = 'SaveRobotState'
  _tags_by_value[110] = 'EnableDisplay'
  _tags_by_value[111] = 'ExecuteTestPlan'
  _tags_by_value[112] = 'PlannerRunMode'
  _tags_by_value[113] = 'SelectNextObject'
  _tags_by_value[114] = 'SetRobotCarryingObject'
  _tags_by_value[115] = 'ClearAllBlocks'
  _tags_by_value[116] = 'ClearAllObjects'
  _tags_by_value[117] = 'DeleteAllObjects'
  _tags_by_value[118] = 'DeleteAllCustomObjects'
  _tags_by_value[119] = 'CreateFixedCustomObject'
  _tags_by_value[120] = 'DefineCustomBox'
  _tags_by_value[121] = 'DefineCustomCube'
  _tags_by_value[122] = 'DefineCustomWall'
  _tags_by_value[123] = 'SetObjectAdditionAndDeletion'
  _tags_by_value[124] = 'VisionWhileMoving'
  _tags_by_value[125] = 'SetFaceToEnroll'
  _tags_by_value[126] = 'CancelFaceEnrollment'
  _tags_by_value[127] = 'EraseEnrolledFaceByID'
  _tags_by_value[128] = 'EraseAllEnrolledFaces'
  _tags_by_value[129] = 'EnableVisionMode'
  _tags_by_value[130] = 'UpdateEnrolledFaceByID'
  _tags_by_value[131] = 'VisionRunMode'
  _tags_by_value[132] = 'SaveFaceAlbumToFile'
  _tags_by_value[133] = 'LoadFaceAlbumFromFile'
  _tags_by_value[134] = 'SetMemoryMapRenderEnabled'
  _tags_by_value[135] = 'SetMemoryMapBroadcastFrequency_sec'
  _tags_by_value[136] = 'ActivateBehaviorChooser'
  _tags_by_value[137] = 'ExecuteBehaviorByExecutableType'
  _tags_by_value[138] = 'ExecuteBehaviorByName'
  _tags_by_value[139] = 'SetLiftLoadTestAsRunnable'
  _tags_by_value[140] = 'BehaviorManagerMessage'
  _tags_by_value[141] = 'AbortPath'
  _tags_by_value[142] = 'AbortAll'
  _tags_by_value[143] = 'StartTestMode'
  _tags_by_value[144] = 'RequestEnabledBehaviorList'
  _tags_by_value[145] = 'RequestEnableReactionTrigger'
  _tags_by_value[146] = 'SetDefaultHeadAndLiftState'
  _tags_by_value[147] = 'RequestObjectStates'
  _tags_by_value[148] = 'DrawPoseMarker'
  _tags_by_value[149] = 'ErasePoseMarker'
  _tags_by_value[150] = 'VisualizeQuad'
  _tags_by_value[151] = 'EraseQuad'
  _tags_by_value[152] = 'ReplayLastAnimation'
  _tags_by_value[153] = 'SetIdleAnimation'
  _tags_by_value[154] = 'PushIdleAnimation'
  _tags_by_value[155] = 'PopIdleAnimation'
  _tags_by_value[156] = 'ReadFaceAnimationDir'
  _tags_by_value[157] = 'ReadAnimationFile'
  _tags_by_value[158] = 'RequestAvailableAnimations'
  _tags_by_value[159] = 'RequestAvailableAnimationGroups'
  _tags_by_value[160] = 'SetLiveIdleAnimationParameters'
  _tags_by_value[161] = 'PushDrivingAnimations'
  _tags_by_value[162] = 'PopDrivingAnimations'
  _tags_by_value[163] = 'SetHeadlight'
  _tags_by_value[164] = 'SetActiveObjectLEDs'
  _tags_by_value[165] = 'SetAllActiveObjectLEDs'
  _tags_by_value[166] = 'SetBackpackLEDs'
  _tags_by_value[167] = 'EnableLightStates'
  _tags_by_value[168] = 'EnableCubeSleep'
  _tags_by_value[169] = 'EnableCubeLightsStateTransitionMessages'
  _tags_by_value[170] = 'FlashCurrentLightsState'
  _tags_by_value[171] = 'PlayCubeAnim'
  _tags_by_value[172] = 'StopCubeAnim'
  _tags_by_value[173] = 'StreamObjectAccel'
  _tags_by_value[174] = 'TransitionToNextOnboardingState'
  _tags_by_value[175] = 'MoodMessage'
  _tags_by_value[176] = 'ProgressionMessage'
  _tags_by_value[177] = 'RequestSetUnlock'
  _tags_by_value[178] = 'RequestDeviceData'
  _tags_by_value[179] = 'SetDebugConsoleVarMessage'
  _tags_by_value[180] = 'RunDebugConsoleFuncMessage'
  _tags_by_value[181] = 'GetDebugConsoleVarMessage'
  _tags_by_value[182] = 'GetAllDebugConsoleVarMessage'
  _tags_by_value[183] = 'GetJsonDasLogsMessage'
  _tags_by_value[184] = 'EnableAllReactionTriggers'
  _tags_by_value[185] = 'SetEnableSpeedChooser'
  _tags_by_value[186] = 'BlockPoolEnabledMessage'
  _tags_by_value[187] = 'BlockSelectedMessage'
  _tags_by_value[188] = 'GetBlockPoolMessage'
  _tags_by_value[189] = 'SendAvailableObjects'
  _tags_by_value[190] = 'BlockPoolResetMessage'
  _tags_by_value[191] = 'SaveCalibrationImage'
  _tags_by_value[192] = 'ClearCalibrationImages'
  _tags_by_value[193] = 'ComputeCameraCalibration'
  _tags_by_value[194] = 'ContinueFreeplayFromIdle'
  _tags_by_value[195] = 'EnableDroneMode'
  _tags_by_value[196] = 'EnterSdkMode'
  _tags_by_value[197] = 'ExitSdkMode'
  _tags_by_value[198] = 'SetStopRobotOnSdkDisconnect'
  _tags_by_value[199] = 'StopRobotForSdk'
  _tags_by_value[200] = 'TransferFile'
  _tags_by_value[201] = 'NVStorageEraseEntry'
  _tags_by_value[202] = 'NVStorageWipeAll'
  _tags_by_value[203] = 'NVStorageWriteEntry'
  _tags_by_value[204] = 'NVStorageClearPartialPendingWriteEntry'
  _tags_by_value[205] = 'NVStorageReadEntry'
  _tags_by_value[206] = 'SetCameraSettings'
  _tags_by_value[207] = 'RequestRobotSettings'
  ...
  _tag_unpack_methods[57] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw.unpack_from)
  _tag_unpack_methods[58] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser.unpack_from)
  _tag_unpack_methods[59] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeviceGyroValues.unpack_from)
  _tag_unpack_methods[60] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDeviceIMUData.unpack_from)
  _tag_unpack_methods[61] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported.unpack_from)
  _tag_unpack_methods[62] = lambda reader: reader.read_object(Anki.Cozmo.SetVizOrigin.unpack_from)
  _tag_unpack_methods[63] = lambda reader: reader.read_object(Anki.Cozmo.ImageChunk.unpack_from)
  _tag_unpack_methods[64] = lambda reader: reader.read_object(Anki.Cozmo.ImageImuData.unpack_from)
  _tag_unpack_methods[65] = lambda reader: reader.read_object(Anki.Cozmo.CameraCalibration.unpack_from)
  _tag_unpack_methods[66] = lambda reader: reader.read_object(Anki.Cozmo.IMURequest.unpack_from)
  _tag_unpack_methods[67] = lambda reader: reader.read_object(Anki.Cozmo.StartControllerTestMode.unpack_from)
  _tag_unpack_methods[68] = lambda reader: reader.read_object(Anki.Cozmo.RawPWM.unpack_from)
  _tag_unpack_methods[69] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess.unpack_from)
  _tag_unpack_methods[70] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectToRobot.unpack_from)
  _tag_unpack_methods[71] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ConnectToUiDevice.unpack_from)
  _tag_unpack_methods[72] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice.unpack_from)
  _tag_unpack_methods[73] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartEngine.unpack_from)
  _tag_unpack_methods[74] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReliableTransportRunMode.unpack_from)
  _tag_unpack_methods[75] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestFeatureToggles.unpack_from)
  _tag_unpack_methods[76] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFeatureToggle.unpack_from)
  _tag_unpack_methods[77] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartIdleTimeout.unpack_from)
  _tag_unpack_methods[78] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelIdleTimeout.unpack_from)
  _tag_unpack_methods[79] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetGameBeingPaused.unpack_from)
  _tag_unpack_methods[80] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateFirmware.unpack_from)
  _tag_unpack_methods[81] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ResetFirmware.unpack_from)
  _tag_unpack_methods[82] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveWheels.unpack_from)
  _tag_unpack_methods[83] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DriveArc.unpack_from)
  _tag_unpack_methods[84] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveHead.unpack_from)
  _tag_unpack_methods[85] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoveLift.unpack_from)
  _tag_unpack_methods[86] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLiftPower.unpack_from)
  _tag_unpack_methods[87] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCliffSensor.unpack_from)
  _tag_unpack_methods[88] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableBlockTapFilter.unpack_from)
  _tag_unpack_methods[89] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus.unpack_from)
  _tag_unpack_methods[90] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopAllMotors.unpack_from)
  _tag_unpack_methods[91] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ControllerGains.unpack_from)
  _tag_unpack_methods[92] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RollActionParams.unpack_from)
  _tag_unpack_methods[93] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMotionModelParams.unpack_from)
  _tag_unpack_methods[94] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotVolume.unpack_from)
  _tag_unpack_methods[95] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource.unpack_from)
  _tag_unpack_methods[96] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot.unpack_from)
  _tag_unpack_methods[97] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup.unpack_from)
  _tag_unpack_methods[98] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotRestoreData.unpack_from)
  _tag_unpack_methods[99] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.WipeRobotGameData.unpack_from)
  _tag_unpack_methods[100] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup.unpack_from)
  _tag_unpack_methods[101] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelAction.unpack_from)
  _tag_unpack_methods[102] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelActionByIdTag.unpack_from)
  _tag_unpack_methods[103] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueSingleAction.unpack_from)
  _tag_unpack_methods[104] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.QueueCompoundAction.unpack_from)
  _tag_unpack_methods[105] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ImageRequest.unpack_from)
  _tag_unpack_methods[106] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotImageSendMode.unpack_from)
  _tag_unpack_methods[107] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveImages.unpack_from)
  _tag_unpack_methods[108] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableColorImages.unpack_from)
  _tag_unpack_methods[109] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveRobotState.unpack_from)
  _tag_unpack_methods[110] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDisplay.unpack_from)
  _tag_unpack_methods[111] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteTestPlan.unpack_from)
  _tag_unpack_methods[112] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlannerRunMode.unpack_from)
  _tag_unpack_methods[113] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SelectNextObject.unpack_from)
  _tag_unpack_methods[114] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetRobotCarryingObject.unpack_from)
  _tag_unpack_methods[115] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearAllBlocks.unpack_from)
  _tag_unpack_methods[116] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearAllObjects.unpack_from)
  _tag_unpack_methods[117] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllObjects.unpack_from)
  _tag_unpack_methods[118] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects.unpack_from)
  _tag_unpack_methods[119] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CreateFixedCustomObject.unpack_from)
  _tag_unpack_methods[120] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomBox.unpack_from)
  _tag_unpack_methods[121] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomCube.unpack_from)
  _tag_unpack_methods[122] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DefineCustomWall.unpack_from)
  _tag_unpack_methods[123] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion.unpack_from)
  _tag_unpack_methods[124] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionWhileMoving.unpack_from)
  _tag_unpack_methods[125] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetFaceToEnroll.unpack_from)
  _tag_unpack_methods[126] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.CancelFaceEnrollment.unpack_from)
  _tag_unpack_methods[127] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[128] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces.unpack_from)
  _tag_unpack_methods[129] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableVisionMode.unpack_from)
  _tag_unpack_methods[130] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID.unpack_from)
  _tag_unpack_methods[131] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisionRunMode.unpack_from)
  _tag_unpack_methods[132] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile.unpack_from)
  _tag_unpack_methods[133] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile.unpack_from)
  _tag_unpack_methods[134] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled.unpack_from)
  _tag_unpack_methods[135] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec.unpack_from)
  _tag_unpack_methods[136] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser.unpack_from)
  _tag_unpack_methods[137] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType.unpack_from)
  _tag_unpack_methods[138] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName.unpack_from)
  _tag_unpack_methods[139] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable.unpack_from)
  _tag_unpack_methods[140] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BehaviorManagerMessage.unpack_from)
  _tag_unpack_methods[141] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortPath.unpack_from)
  _tag_unpack_methods[142] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.AbortAll.unpack_from)
  _tag_unpack_methods[143] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StartTestMode.unpack_from)
  _tag_unpack_methods[144] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList.unpack_from)
  _tag_unpack_methods[145] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger.unpack_from)
  _tag_unpack_methods[146] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState.unpack_from)
  _tag_unpack_methods[147] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestObjectStates.unpack_from)
  _tag_unpack_methods[148] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.DrawPoseMarker.unpack_from)
  _tag_unpack_methods[149] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ErasePoseMarker.unpack_from)
  _tag_unpack_methods[150] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.VisualizeQuad.unpack_from)
  _tag_unpack_methods[151] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EraseQuad.unpack_from)
  _tag_unpack_methods[152] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReplayLastAnimation.unpack_from)
  _tag_unpack_methods[153] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetIdleAnimation.unpack_from)
  _tag_unpack_methods[154] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushIdleAnimation.unpack_from)
  _tag_unpack_methods[155] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopIdleAnimation.unpack_from)
  _tag_unpack_methods[156] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir.unpack_from)
  _tag_unpack_methods[157] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ReadAnimationFile.unpack_from)
  _tag_unpack_methods[158] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimations.unpack_from)
  _tag_unpack_methods[159] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups.unpack_from)
  _tag_unpack_methods[160] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters.unpack_from)
  _tag_unpack_methods[161] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PushDrivingAnimations.unpack_from)
  _tag_unpack_methods[162] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PopDrivingAnimations.unpack_from)
  _tag_unpack_methods[163] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetHeadlight.unpack_from)
  _tag_unpack_methods[164] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[165] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs.unpack_from)
  _tag_unpack_methods[166] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetBackpackLEDs.unpack_from)
  _tag_unpack_methods[167] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableLightStates.unpack_from)
  _tag_unpack_methods[168] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeSleep.unpack_from)
  _tag_unpack_methods[169] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages.unpack_from)
  _tag_unpack_methods[170] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.FlashCurrentLightsState.unpack_from)
  _tag_unpack_methods[171] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.PlayCubeAnim.unpack_from)
  _tag_unpack_methods[172] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopCubeAnim.unpack_from)
  _tag_unpack_methods[173] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StreamObjectAccel.unpack_from)
  _tag_unpack_methods[174] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState.unpack_from)
  _tag_unpack_methods[175] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.MoodMessage.unpack_from)
  _tag_unpack_methods[176] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ProgressionMessage.unpack_from)
  _tag_unpack_methods[177] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestSetUnlock.unpack_from)
  _tag_unpack_methods[178] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestDeviceData.unpack_from)
  _tag_unpack_methods[179] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[180] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage.unpack_from)
  _tag_unpack_methods[181] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[182] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage.unpack_from)
  _tag_unpack_methods[183] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage.unpack_from)
  _tag_unpack_methods[184] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers.unpack_from)
  _tag_unpack_methods[185] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser.unpack_from)
  _tag_unpack_methods[186] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage.unpack_from)
  _tag_unpack_methods[187] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockSelectedMessage.unpack_from)
  _tag_unpack_methods[188] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.GetBlockPoolMessage.unpack_from)
  _tag_unpack_methods[189] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SendAvailableObjects.unpack_from)
  _tag_unpack_methods[190] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.BlockPoolResetMessage.unpack_from)
  _tag_unpack_methods[191] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SaveCalibrationImage.unpack_from)
  _tag_unpack_methods[192] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ClearCalibrationImages.unpack_from)
  _tag_unpack_methods[193] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ComputeCameraCalibration.unpack_from)
  _tag_unpack_methods[194] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle.unpack_from)
  _tag_unpack_methods[195] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnableDroneMode.unpack_from)
  _tag_unpack_methods[196] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.EnterSdkMode.unpack_from)
  _tag_unpack_methods[197] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.ExitSdkMode.unpack_from)
  _tag_unpack_methods[198] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect.unpack_from)
  _tag_unpack_methods[199] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.StopRobotForSdk.unpack_from)
  _tag_unpack_methods[200] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.TransferFile.unpack_from)
  _tag_unpack_methods[201] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageEraseEntry.unpack_from)
  _tag_unpack_methods[202] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWipeAll.unpack_from)
  _tag_unpack_methods[203] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageWriteEntry.unpack_from)
  _tag_unpack_methods[204] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry.unpack_from)
  _tag_unpack_methods[205] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.NVStorageReadEntry.unpack_from)
  _tag_unpack_methods[206] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.SetCameraSettings.unpack_from)
  _tag_unpack_methods[207] = lambda reader: reader.read_object(Anki.Cozmo.ExternalInterface.RequestRobotSettings.unpack_from)
  ...
  _type_by_tag_value[57] = lambda : Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesRaw
  _type_by_tag_value[58] = lambda : Anki.Cozmo.ExternalInterface.DeviceAccelerometerValuesUser
  _type_by_tag_value[59] = lambda : Anki.Cozmo.ExternalInterface.DeviceGyroValues
  _type_by_tag_value[60] = lambda : Anki.Cozmo.ExternalInterface.EnableDeviceIMUData
  _type_by_tag_value[61] = lambda : Anki.Cozmo.ExternalInterface.IsDeviceIMUSupported
  _type_by_tag_value[62] = lambda : Anki.Cozmo.SetVizOrigin
  _type_by_tag_value[63] = lambda : Anki.Cozmo.ImageChunk
  _type_by_tag_value[64] = lambda : Anki.Cozmo.ImageImuData
  _type_by_tag_value[65] = lambda : Anki.Cozmo.CameraCalibration
  _type_by_tag_value[66] = lambda : Anki.Cozmo.IMURequest
  _type_by_tag_value[67] = lambda : Anki.Cozmo.StartControllerTestMode
  _type_by_tag_value[68] = lambda : Anki.Cozmo.RawPWM
  _type_by_tag_value[69] = lambda : Anki.Cozmo.ExternalInterface.UiDeviceConnectionSuccess
  _type_by_tag_value[70] = lambda : Anki.Cozmo.ExternalInterface.ConnectToRobot
  _type_by_tag_value[71] = lambda : Anki.Cozmo.ExternalInterface.ConnectToUiDevice
  _type_by_tag_value[72] = lambda : Anki.Cozmo.ExternalInterface.DisconnectFromUiDevice
  _type_by_tag_value[73] = lambda : Anki.Cozmo.ExternalInterface.StartEngine
  _type_by_tag_value[74] = lambda : Anki.Cozmo.ExternalInterface.ReliableTransportRunMode
  _type_by_tag_value[75] = lambda : Anki.Cozmo.ExternalInterface.RequestFeatureToggles
  _type_by_tag_value[76] = lambda : Anki.Cozmo.ExternalInterface.SetFeatureToggle
  _type_by_tag_value[77] = lambda : Anki.Cozmo.ExternalInterface.StartIdleTimeout
  _type_by_tag_value[78] = lambda : Anki.Cozmo.ExternalInterface.CancelIdleTimeout
  _type_by_tag_value[79] = lambda : Anki.Cozmo.ExternalInterface.SetGameBeingPaused
  _type_by_tag_value[80] = lambda : Anki.Cozmo.ExternalInterface.UpdateFirmware
  _type_by_tag_value[81] = lambda : Anki.Cozmo.ExternalInterface.ResetFirmware
  _type_by_tag_value[82] = lambda : Anki.Cozmo.ExternalInterface.DriveWheels
  _type_by_tag_value[83] = lambda : Anki.Cozmo.ExternalInterface.DriveArc
  _type_by_tag_value[84] = lambda : Anki.Cozmo.ExternalInterface.MoveHead
  _type_by_tag_value[85] = lambda : Anki.Cozmo.ExternalInterface.MoveLift
  _type_by_tag_value[86] = lambda : Anki.Cozmo.ExternalInterface.EnableLiftPower
  _type_by_tag_value[87] = lambda : Anki.Cozmo.ExternalInterface.EnableCliffSensor
  _type_by_tag_value[88] = lambda : Anki.Cozmo.ExternalInterface.EnableBlockTapFilter
  _type_by_tag_value[89] = lambda : Anki.Cozmo.ExternalInterface.GetBlockTapFilterStatus
  _type_by_tag_value[90] = lambda : Anki.Cozmo.ExternalInterface.StopAllMotors
  _type_by_tag_value[91] = lambda : Anki.Cozmo.ExternalInterface.ControllerGains
  _type_by_tag_value[92] = lambda : Anki.Cozmo.ExternalInterface.RollActionParams
  _type_by_tag_value[93] = lambda : Anki.Cozmo.ExternalInterface.SetMotionModelParams
  _type_by_tag_value[94] = lambda : Anki.Cozmo.ExternalInterface.SetRobotVolume
  _type_by_tag_value[95] = lambda : Anki.Cozmo.ExternalInterface.SetRobotAudioOutputSource
  _type_by_tag_value[96] = lambda : Anki.Cozmo.ExternalInterface.ForceDelocalizeRobot
  _type_by_tag_value[97] = lambda : Anki.Cozmo.ExternalInterface.RestoreRobotFromBackup
  _type_by_tag_value[98] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotRestoreData
  _type_by_tag_value[99] = lambda : Anki.Cozmo.ExternalInterface.WipeRobotGameData
  _type_by_tag_value[100] = lambda : Anki.Cozmo.ExternalInterface.RequestUnlockDataFromBackup
  _type_by_tag_value[101] = lambda : Anki.Cozmo.ExternalInterface.CancelAction
  _type_by_tag_value[102] = lambda : Anki.Cozmo.ExternalInterface.CancelActionByIdTag
  _type_by_tag_value[103] = lambda : Anki.Cozmo.ExternalInterface.QueueSingleAction
  _type_by_tag_value[104] = lambda : Anki.Cozmo.ExternalInterface.QueueCompoundAction
  _type_by_tag_value[105] = lambda : Anki.Cozmo.ExternalInterface.ImageRequest
  _type_by_tag_value[106] = lambda : Anki.Cozmo.ExternalInterface.SetRobotImageSendMode
  _type_by_tag_value[107] = lambda : Anki.Cozmo.ExternalInterface.SaveImages
  _type_by_tag_value[108] = lambda : Anki.Cozmo.ExternalInterface.EnableColorImages
  _type_by_tag_value[109] = lambda : Anki.Cozmo.ExternalInterface.SaveRobotState
  _type_by_tag_value[110] = lambda : Anki.Cozmo.ExternalInterface.EnableDisplay
  _type_by_tag_value[111] = lambda : Anki.Cozmo.ExternalInterface.ExecuteTestPlan
  _type_by_tag_value[112] = lambda : Anki.Cozmo.ExternalInterface.PlannerRunMode
  _type_by_tag_value[113] = lambda : Anki.Cozmo.ExternalInterface.SelectNextObject
  _type_by_tag_value[114] = lambda : Anki.Cozmo.ExternalInterface.SetRobotCarryingObject
  _type_by_tag_value[115] = lambda : Anki.Cozmo.ExternalInterface.ClearAllBlocks
  _type_by_tag_value[116] = lambda : Anki.Cozmo.ExternalInterface.ClearAllObjects
  _type_by_tag_value[117] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllObjects
  _type_by_tag_value[118] = lambda : Anki.Cozmo.ExternalInterface.DeleteAllCustomObjects
  _type_by_tag_value[119] = lambda : Anki.Cozmo.ExternalInterface.CreateFixedCustomObject
  _type_by_tag_value[120] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomBox
  _type_by_tag_value[121] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomCube
  _type_by_tag_value[122] = lambda : Anki.Cozmo.ExternalInterface.DefineCustomWall
  _type_by_tag_value[123] = lambda : Anki.Cozmo.ExternalInterface.SetObjectAdditionAndDeletion
  _type_by_tag_value[124] = lambda : Anki.Cozmo.ExternalInterface.VisionWhileMoving
  _type_by_tag_value[125] = lambda : Anki.Cozmo.ExternalInterface.SetFaceToEnroll
  _type_by_tag_value[126] = lambda : Anki.Cozmo.ExternalInterface.CancelFaceEnrollment
  _type_by_tag_value[127] = lambda : Anki.Cozmo.ExternalInterface.EraseEnrolledFaceByID
  _type_by_tag_value[128] = lambda : Anki.Cozmo.ExternalInterface.EraseAllEnrolledFaces
  _type_by_tag_value[129] = lambda : Anki.Cozmo.ExternalInterface.EnableVisionMode
  _type_by_tag_value[130] = lambda : Anki.Cozmo.ExternalInterface.UpdateEnrolledFaceByID
  _type_by_tag_value[131] = lambda : Anki.Cozmo.ExternalInterface.VisionRunMode
  _type_by_tag_value[132] = lambda : Anki.Cozmo.ExternalInterface.SaveFaceAlbumToFile
  _type_by_tag_value[133] = lambda : Anki.Cozmo.ExternalInterface.LoadFaceAlbumFromFile
  _type_by_tag_value[134] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapRenderEnabled
  _type_by_tag_value[135] = lambda : Anki.Cozmo.ExternalInterface.SetMemoryMapBroadcastFrequency_sec
  _type_by_tag_value[136] = lambda : Anki.Cozmo.ExternalInterface.ActivateBehaviorChooser
  _type_by_tag_value[137] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByExecutableType
  _type_by_tag_value[138] = lambda : Anki.Cozmo.ExternalInterface.ExecuteBehaviorByName
  _type_by_tag_value[139] = lambda : Anki.Cozmo.ExternalInterface.SetLiftLoadTestAsRunnable
  _type_by_tag_value[140] = lambda : Anki.Cozmo.ExternalInterface.BehaviorManagerMessage
  _type_by_tag_value[141] = lambda : Anki.Cozmo.ExternalInterface.AbortPath
  _type_by_tag_value[142] = lambda : Anki.Cozmo.ExternalInterface.AbortAll
  _type_by_tag_value[143] = lambda : Anki.Cozmo.ExternalInterface.StartTestMode
  _type_by_tag_value[144] = lambda : Anki.Cozmo.ExternalInterface.RequestEnabledBehaviorList
  _type_by_tag_value[145] = lambda : Anki.Cozmo.ExternalInterface.RequestEnableReactionTrigger
  _type_by_tag_value[146] = lambda : Anki.Cozmo.ExternalInterface.SetDefaultHeadAndLiftState
  _type_by_tag_value[147] = lambda : Anki.Cozmo.ExternalInterface.RequestObjectStates
  _type_by_tag_value[148] = lambda : Anki.Cozmo.ExternalInterface.DrawPoseMarker
  _type_by_tag_value[149] = lambda : Anki.Cozmo.ExternalInterface.ErasePoseMarker
  _type_by_tag_value[150] = lambda : Anki.Cozmo.ExternalInterface.VisualizeQuad
  _type_by_tag_value[151] = lambda : Anki.Cozmo.ExternalInterface.EraseQuad
  _type_by_tag_value[152] = lambda : Anki.Cozmo.ExternalInterface.ReplayLastAnimation
  _type_by_tag_value[153] = lambda : Anki.Cozmo.ExternalInterface.SetIdleAnimation
  _type_by_tag_value[154] = lambda : Anki.Cozmo.ExternalInterface.PushIdleAnimation
  _type_by_tag_value[155] = lambda : Anki.Cozmo.ExternalInterface.PopIdleAnimation
  _type_by_tag_value[156] = lambda : Anki.Cozmo.ExternalInterface.ReadFaceAnimationDir
  _type_by_tag_value[157] = lambda : Anki.Cozmo.ExternalInterface.ReadAnimationFile
  _type_by_tag_value[158] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimations
  _type_by_tag_value[159] = lambda : Anki.Cozmo.ExternalInterface.RequestAvailableAnimationGroups
  _type_by_tag_value[160] = lambda : Anki.Cozmo.ExternalInterface.SetLiveIdleAnimationParameters
  _type_by_tag_value[161] = lambda : Anki.Cozmo.ExternalInterface.PushDrivingAnimations
  _type_by_tag_value[162] = lambda : Anki.Cozmo.ExternalInterface.PopDrivingAnimations
  _type_by_tag_value[163] = lambda : Anki.Cozmo.ExternalInterface.SetHeadlight
  _type_by_tag_value[164] = lambda : Anki.Cozmo.ExternalInterface.SetActiveObjectLEDs
  _type_by_tag_value[165] = lambda : Anki.Cozmo.ExternalInterface.SetAllActiveObjectLEDs
  _type_by_tag_value[166] = lambda : Anki.Cozmo.ExternalInterface.SetBackpackLEDs
  _type_by_tag_value[167] = lambda : Anki.Cozmo.ExternalInterface.EnableLightStates
  _type_by_tag_value[168] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeSleep
  _type_by_tag_value[169] = lambda : Anki.Cozmo.ExternalInterface.EnableCubeLightsStateTransitionMessages
  _type_by_tag_value[170] = lambda : Anki.Cozmo.ExternalInterface.FlashCurrentLightsState
  _type_by_tag_value[171] = lambda : Anki.Cozmo.ExternalInterface.PlayCubeAnim
  _type_by_tag_value[172] = lambda : Anki.Cozmo.ExternalInterface.StopCubeAnim
  _type_by_tag_value[173] = lambda : Anki.Cozmo.ExternalInterface.StreamObjectAccel
  _type_by_tag_value[174] = lambda : Anki.Cozmo.ExternalInterface.TransitionToNextOnboardingState
  _type_by_tag_value[175] = lambda : Anki.Cozmo.ExternalInterface.MoodMessage
  _type_by_tag_value[176] = lambda : Anki.Cozmo.ExternalInterface.ProgressionMessage
  _type_by_tag_value[177] = lambda : Anki.Cozmo.ExternalInterface.RequestSetUnlock
  _type_by_tag_value[178] = lambda : Anki.Cozmo.ExternalInterface.RequestDeviceData
  _type_by_tag_value[179] = lambda : Anki.Cozmo.ExternalInterface.SetDebugConsoleVarMessage
  _type_by_tag_value[180] = lambda : Anki.Cozmo.ExternalInterface.RunDebugConsoleFuncMessage
  _type_by_tag_value[181] = lambda : Anki.Cozmo.ExternalInterface.GetDebugConsoleVarMessage
  _type_by_tag_value[182] = lambda : Anki.Cozmo.ExternalInterface.GetAllDebugConsoleVarMessage
  _type_by_tag_value[183] = lambda : Anki.Cozmo.ExternalInterface.GetJsonDasLogsMessage
  _type_by_tag_value[184] = lambda : Anki.Cozmo.ExternalInterface.EnableAllReactionTriggers
  _type_by_tag_value[185] = lambda : Anki.Cozmo.ExternalInterface.SetEnableSpeedChooser
  _type_by_tag_value[186] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolEnabledMessage
  _type_by_tag_value[187] = lambda : Anki.Cozmo.ExternalInterface.BlockSelectedMessage
  _type_by_tag_value[188] = lambda : Anki.Cozmo.ExternalInterface.GetBlockPoolMessage
  _type_by_tag_value[189] = lambda : Anki.Cozmo.ExternalInterface.SendAvailableObjects
  _type_by_tag_value[190] = lambda : Anki.Cozmo.ExternalInterface.BlockPoolResetMessage
  _type_by_tag_value[191] = lambda : Anki.Cozmo.ExternalInterface.SaveCalibrationImage
  _type_by_tag_value[192] = lambda : Anki.Cozmo.ExternalInterface.ClearCalibrationImages
  _type_by_tag_value[193] = lambda : Anki.Cozmo.ExternalInterface.ComputeCameraCalibration
  _type_by_tag_value[194] = lambda : Anki.Cozmo.ExternalInterface.ContinueFreeplayFromIdle
  _type_by_tag_value[195] = lambda : Anki.Cozmo.ExternalInterface.EnableDroneMode
  _type_by_tag_value[196] = lambda : Anki.Cozmo.ExternalInterface.EnterSdkMode
  _type_by_tag_value[197] = lambda : Anki.Cozmo.ExternalInterface.ExitSdkMode
  _type_by_tag_value[198] = lambda : Anki.Cozmo.ExternalInterface.SetStopRobotOnSdkDisconnect
  _type_by_tag_value[199] = lambda : Anki.Cozmo.ExternalInterface.StopRobotForSdk
  _type_by_tag_value[200] = lambda : Anki.Cozmo.ExternalInterface.TransferFile
  _type_by_tag_value[201] = lambda : Anki.Cozmo.ExternalInterface.NVStorageEraseEntry
  _type_by_tag_value[202] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWipeAll
  _type_by_tag_value[203] = lambda : Anki.Cozmo.ExternalInterface.NVStorageWriteEntry
  _type_by_tag_value[204] = lambda : Anki.Cozmo.ExternalInterface.NVStorageClearPartialPendingWriteEntry
  _type_by_tag_value[205] = lambda : Anki.Cozmo.ExternalInterface.NVStorageReadEntry
  _type_by_tag_value[206] = lambda : Anki.Cozmo.ExternalInterface.SetCameraSettings
  _type_by_tag_value[207] = lambda : Anki.Cozmo.ExternalInterface.RequestRobotSettings

...
class SnapshotTest(BaseCliTest):
    ...
    @patch( "fdscli.services.abstract_service.AbstractService.get_url_preamble", return_value="http://www.fds.com")
    @patch( "fdscli.services.rest_helper.RESTHelper.post", return_value=None)

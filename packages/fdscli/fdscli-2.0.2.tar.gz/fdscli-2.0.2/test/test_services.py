...
class TestServices(BaseCliTest):
    ...
    @author: nate
    '''
    @patch( "fdscli.services.node_service.NodeService.start_service", side_effect=mock_functions.startService)
    ...
    @patch( "fdscli.services.node_service.NodeService.stop_service", side_effect=mock_functions.stopService)
    @patch( "fdscli.services.node_service.NodeService.list_nodes", side_effect=mock_functions.listNodes)
    ...
    @patch( "fdscli.services.node_service.NodeService.remove_service", side_effect=mock_functions.removeService)        
    @patch( "fdscli.services.node_service.NodeService.list_nodes", side_effect=mock_functions.listNodes)
    ...
    @patch( "fdscli.services.node_service.NodeService.add_service", side_effect=mock_functions.addService)        
    @patch( "fdscli.services.node_service.NodeService.list_nodes", side_effect=mock_functions.listNodes)
    ...
    @patch( "fdscli.services.response_writer.ResponseWriter.writeJson", side_effect=mock_functions.writeJson)
    @patch( "fdscli.services.node_service.NodeService.list_nodes", side_effect=mock_functions.listNodes)

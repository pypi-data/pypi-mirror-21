...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfilingRecord.response_content_length'
        db.add_column('request_profiler_profilingrecord', 'response_content_length',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfilingRecord.response_content_length'
        db.delete_column('request_profiler_profilingrecord', 'response_content_length')
    ...
    models = {
        ...
        'request_profiler.profilingrecord': {
            ...
            'response_content_length': ('django.db.models.fields.IntegerField', [], {}),

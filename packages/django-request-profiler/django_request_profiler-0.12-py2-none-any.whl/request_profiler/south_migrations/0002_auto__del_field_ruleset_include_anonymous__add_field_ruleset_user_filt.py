...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('request_profiler_ruleset', 'include_anonymous')

        # Adding field 'RuleSet.user_filter_type'
        db.add_column('request_profiler_ruleset', 'user_filter_type',
    ...
    def backwards(self, orm):
        ...
        db.add_column('request_profiler_ruleset', 'include_anonymous',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'RuleSet.user_filter_type'
        db.delete_column('request_profiler_ruleset', 'user_filter_type')

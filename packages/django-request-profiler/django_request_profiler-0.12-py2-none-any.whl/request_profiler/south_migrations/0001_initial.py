...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('request_profiler_ruleset', (
        ...
        db.send_create_signal('request_profiler', ['RuleSet'])

        # Adding model 'ProfilingRecord'
        db.create_table('request_profiler_profilingrecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('request_profiler', ['ProfilingRecord'])


    def backwards(self, orm):
        # Deleting model 'RuleSet'
        db.delete_table('request_profiler_ruleset')

        # Deleting model 'ProfilingRecord'
        db.delete_table('request_profiler_profilingrecord')

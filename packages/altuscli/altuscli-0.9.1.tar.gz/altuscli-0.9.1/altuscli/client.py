...
class ClientCreator(object):
    ...
    def _get_client_args(self,
        ...
        endpoint = self._endpoint_creator.create_endpoint(
            ...
            timeout,
            self._retryhandler)
        signer = RequestSigner(RSAv1Auth.AUTH_METHOD_NAME, credentials)
        return {
...
class BaseClient(object):
    ...
    def get_paginator(self, operation_name, max_items=None):
        ...
        return Paginator(method, operation_model, max_items)

...
class ApplianceSsh(ApplianceConnection):
    ...
    def pre_cmd_handler(self, operation, **update_cmds):
        """
        :return: Command object with ssh_command attribute
        """
    ...
    def call(self, command_obj):
        ...
        :param command_obj: Instance of Command object
    ...
    def post_cmd_handler(self, command_obj):
        ...
        return super(ApplianceSsh, self).post_cmd_handler(command_obj)

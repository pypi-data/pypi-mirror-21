...
Yaff.View = Yaff.extend({
    ...
    register_event: function(event) {
        ...
        Array.prototype.forEach.call(elements, function(el) {
            el.addEventListener(event['event'], self[event['callback']]);
        });
...
Yaff.Utilities = Yaff.extend({
    ...
    restrict_tabbing: function(action, parent) {
        ...
        if (action === 'on') {
            ...
            first.addEventListener('keydown', first_keydown);
            last.addEventListener('keydown', last_keydown);
...
Yaff.mixins = {
    ...
    draggable: {
        ...
        down_start: function(e) {
            ...
            Yaff.drag_context['origin'] = e.originalEvent.type === 'mousedown' ? 'mouse' : 'touch';
        ...
        start_dragging: function(e) {
            ...
            if (Yaff.drag_context['origin'] === 'mouse') {
                window.addEventListener('mousemove', Yaff.drag_context.mousemove);
                window.addEventListener('mouseup', Yaff.drag_context.mouseup);
            } else {
                window.addEventListener('touchmove', Yaff.drag_context.mousemove);
                window.addEventListener('touchend', Yaff.drag_context.mouseup);
                window.addEventListener('touchcancel', Yaff.drag_context.mouseup);
            }

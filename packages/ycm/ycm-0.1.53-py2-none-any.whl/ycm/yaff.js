    ...
    draggable: {
        ...
        start_dragging: function(e) {
            ...
            var clone_style = 'border-style: dotted; border-color: #9e9e9e; border-width: 2px; ' +
                ...
                'top: ' + (rect.top - style.marginTop) + 'px; ' +
                'left: ' + (rect.left - style.marginLeft) + 'px; ' +
                'cursor: move;' +
                'pointer-events: none;';
        ...
        drag_move: function(e) {
            ...
            if (drag_type === 'vertical' || 'freeform') {
                cd['currentY'] = clientY - cd['mouseY'] - cd['margin_top'];
            } else if (drag_type === 'horizontal' || 'freeform') {
                cd['currentX'] = clientX - cd['mouseX'] - cd['margin_left'];
            }

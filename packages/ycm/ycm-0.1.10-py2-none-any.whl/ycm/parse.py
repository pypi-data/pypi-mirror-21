...
class YaffComponent(object):
    ...
    def parse_source_file(self):
        ...
        if os.path.isdir(source):
            ...
            files = [
                { 'file': filter(jsre.match, os.listdir(source)), 'header': '[js]' },
                { 'file': filter(htmlre.match, os.listdir(source)), 'header': '[html]' },
                { 'file': filter(cssre.match, os.listdir(source)), 'header': '[css]' },
                { 'file': filter(hdrre.match, os.listdir(source)), 'header': '[header]' },
            ]

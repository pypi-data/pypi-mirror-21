    ...
    draggable: {
        ...
        start_dragging: function(e) {
            ...
            var clone_style = { 'border-style': 'dotted', 'border-color': '#9e9e9e', 'border-width': '2px',
                           ...
                           'width':  this.drag_context['clone_details'].width + 'px',  //-parseInt($element.css('padding-left'))-parseInt($element.css('padding-right'))
                           'height':  this.drag_context['clone_details'].height + 'px', //-parseInt($element.css('padding-top'))-parseInt($element.css('padding-bottom'))
            ...
            var target_style = {'background-color': 'gray', 'height': this.drag_context['clone_details']['height'] + 'px'};

        ...
        reset_draggable: function() {
            Yaff.drag_context = {
                ...
                animate_move: function(timestamp) {
                    ...
                    $drag_clone.css('left', Yaff.drag_context['clone_details']['currentX']);
                    $drag_clone.css('top', Yaff.drag_context['clone_details']['currentY']);

                    Yaff.drag_context['anim_frame_ref'] = requestAnimationFrame(Yaff.drag_content.animate_move);
                }
            }
        },

...
class NginxConfigBuilder(object):
    ...
    def __init__(self, worker_processes='auto', worker_connections=1024,  error_log='logs/nginx.error.log', daemon=False):
        """
        :param workers int: number of nginx workers to start up (default: 1024)
        :param error_log str: path to nginx error log (default: logs/nginx.error.log)
        :param daemon str: whether or not to daemonize nginx (default: off)
        """

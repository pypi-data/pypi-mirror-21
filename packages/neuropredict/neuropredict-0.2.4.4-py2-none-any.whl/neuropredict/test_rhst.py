...
# out_dir = '/Users/Reddy/Downloads/exported_results_TBI2grop'
# res_path = os.path.join(out_dir, 'rhst_results.pkl')
# neuropredict.visualize_results(res_path, out_dir, ['1', '2'])
# neuropredict.export_results(res_path, out_dir)

out_dir = '/Users/Reddy/Downloads/pingyong'
rhst.run('/Users/Reddy/Downloads/pingyong/datasetlist.aseg_stats_subcortical_0_aseg_stats_whole_brain_1.txt',
         ['0', '1'], out_dir, train_perc=0.5, num_repetitions=20, positive_class='TBI')

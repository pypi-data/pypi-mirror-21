...
class EchoLayer(YowInterfaceLayer):
    ...
    def on_message(self, message_protocol_entity):
        ...
        if message_protocol_entity.getType() == u"text":
            ...
            if re.search(ur"[0-9]+-[0-9]+", message_protocol_entity.getFrom(False)):  # If group
            ...
            message = Message(u"", body, self.connection.user_contact, sender, group, timestamp)
    ...
    def send_media(self, path, number, caption, media_type):
        u"""
        Sends a media file

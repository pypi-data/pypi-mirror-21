...
class UnitTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        GlobalConfigHandler.config_location = u"test-kudu"
        GlobalConfigHandler.global_connection_config_location = os.path.join(u"test-kudu", u"connections.conf")
        GlobalConfigHandler.services_config_location = os.path.join(u"test-kudu", u"services.conf")
        GlobalConfigHandler.data_location = os.path.join(u"test-kudu", u"data")
        GlobalConfigHandler.specific_connection_config_location = os.path.join(u"test-kudu", u"connection_config")

        Connection.database_file_location = os.path.join(u"test-kudu", u"data")
        Connection.config_file_location = os.path.join(u"test-kudu", u"connection_config")
    ...
    def validate_config_directory(self):
        ...
        self.assertTrue(os.path.isdir(u"test-kudu"))
        self.assertTrue(os.path.isfile(os.path.join(u"test-kudu", u"services.conf")))
        self.assertTrue(os.path.isfile(os.path.join(u"test-kudu", u"connections.conf")))
        self.assertTrue(os.path.isdir(os.path.join(u"test-kudu", u"connection_config")))
        self.assertTrue(os.path.isdir(os.path.join(u"test-kudu", u"data")))
    ...
    def test_directory_validation(self):
        ...
        for element in [u"services.conf", u"connections.conf", u"data", u"connection_config"]:
            ...
            GlobalConfigHandler.generate_configuration(True)
            path = os.path.join(u"test-kudu", element)
    ...
    def test_connection_loading(self):
        ...
        with open(os.path.join(u"test-kudu", u"connections.conf"), u'w') as f:
    ...
    def test_service_loading(self):
        ...
        with open(os.path.join(u"test-kudu", u"services.conf"), u'w') as f:
    ...
    def test_importing(self):
        ...
        GlobalConfigHandler.generate_configuration(True)
        handler = GlobalConfigHandler()
        os_import = handler.__handle_import_statement__(u"import os")
        dict_import = handler.__handle_import_statement__(u"from typing import Dict")

...
class SimpleResponderService(Service):
    ...
    logger = logging.getLogger(u"kudubot.services.simple_responder.SimpleResponderService")
    ...
    rules = [
        ...
        ({u"Hello World!": u"01001000 01100101 01101100 01101100 01101111 00100000 "
                          u"01010111 01101111 01110010 01101100 01100100 00100001",
          u"Ping": u"Pong",
          u"ping": u"pong"},
    ...
    def is_applicable_to(self, message):
        ...
        """
        applicable = self.__check_rules__(message.message_body) != u""

        if applicable:
            self.logger.info(u"Service " + self.identifier + u" is applicable to message " +
                             repr(message.message_body) + u".")
        else:
            self.logger.debug(u"Service " + self.identifier + u" is not applicable to message.")
    ...
    def handle_message(self, message):
        ...
        :return: None
        """
        self.logger.info(u"Handling message " + repr(message.message_body) + u" from " + message.sender.address)
        ...
        if response != u"":
            ...
            self.connection.send_message(
                Message(u"Simple Response", response, target, self.connection.user_contact)
            )

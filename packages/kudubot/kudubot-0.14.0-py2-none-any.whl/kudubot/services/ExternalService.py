...
class ExternalService(Service):
    ...
    def download_executable(self):
        ...
        try:
            ...
            self.logger.info(u"Could not download executable. Disabling Service.")
    ...
    def is_applicable_to(self, message):
        ...
        return response[u"mode"] == u"is_applicable" and response[u"applicable"]
    ...
    # noinspection PyMethodMayBeStatic
    def resolve_github_release_asset_url(self, owner, repository, filename):
        u"""
        ...
        release_page = u"https://github.com/" + owner + u"/" + repository + u"/releases/latest"
        ...
        for download in downloads.select(u"a"):
            name = download.select(u"strong")[0]

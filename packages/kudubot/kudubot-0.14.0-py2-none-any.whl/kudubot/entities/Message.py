...
class Message(object):
    ...
    def __init__(self, message_title, message_body, receiver, sender,
                 sender_group = None, timestamp = None):
        u"""
    ...
    def get_direct_response_contact(self):
        u"""
    ...
    def to_dict(self):
        ...
        return {
            u"message_title": self.message_title,
            u"message_body": self.message_body,
            u"sender": self.sender.to_dict(),
            u"sender_group": None if self.sender_group is None else self.sender_group.to_dict(),
            u"receiver": self.receiver.to_dict(),
...
def from_dict(data):
    ...
    return Message(
        data[u"message_title"],
        data[u"message_body"],
        contact_from_dict(data[u"receiver"]),
        contact_from_dict(data[u"sender"]),
        None if data[u"sender_group"] is None else contact_from_dict(data[u"sender_group"]),
        data[u"timestamp"]
    )

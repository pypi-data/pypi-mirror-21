...
class StandardConfigWriter(object):
    ...
    def write_standard_service_config(self):
        ...
        with open(self.service_config, u'w') as config:
            for service in \
                    [u"from kudubot.services.simple_responder.SimpleResponderService import SimpleResponderService",
                     u"from kudubot.services.reminder.ReminderService import ReminderService",
                     u"from kudubot.services.anime_reminder.AnimeReminderService import AnimeReminderService",
                     u"from kudubot.services.jokes.JokesService import JokesService",
                     u"from kudubot.services.external.hello_rust.HelloRustService import HelloRustService"]:

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledReport.email_subject'
        db.add_column(u'hidash_scheduledreport', 'email_subject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000),
                      keep_default=False)

        # Adding field 'ScheduledReport.last_run_at'
        db.add_column(u'hidash_scheduledreport', 'last_run_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScheduledReport.next_run_at'
        db.add_column(u'hidash_scheduledreport', 'next_run_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ScheduledReport.cron_expression'
        db.add_column(u'hidash_scheduledreport', 'cron_expression',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledReport.email_subject'
        db.delete_column(u'hidash_scheduledreport', 'email_subject')

        # Deleting field 'ScheduledReport.last_run_at'
        db.delete_column(u'hidash_scheduledreport', 'last_run_at')

        # Deleting field 'ScheduledReport.next_run_at'
        db.delete_column(u'hidash_scheduledreport', 'next_run_at')

        # Deleting field 'ScheduledReport.cron_expression'
        db.delete_column(u'hidash_scheduledreport', 'cron_expression')

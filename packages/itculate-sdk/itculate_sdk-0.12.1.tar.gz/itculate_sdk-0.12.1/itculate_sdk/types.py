...
class DataType(object):
    ...
    default_resampling_method = ResamplingMethods.LAST

    # Cache data type name
    type_name = None
    ...
    def __init__(self, **kwargs):
        ...
        :param bool resampling_method: method of aggregation when resampling this counter
        """
    ...
    def meta_data(self):
        ...
        props = ("type", "label", "description", "importance", "visible", "resampling_method", )
...
class CountDataType(DataTypeWithUnit):
    ...
    resampling_method = ResamplingMethods.SUM
...
class QueueSizeDataType(CountDataType):
    ...
    resampling_method = ResamplingMethods.MAX
...
class RateDataType(DataTypeWithUnit):
    ...
    resampling_method = ResamplingMethods.AVG
...
class CapacityDataType(DataTypeWithUnit):
    ...
    default_importance = 120
    resampling_method = ResamplingMethods.LAST

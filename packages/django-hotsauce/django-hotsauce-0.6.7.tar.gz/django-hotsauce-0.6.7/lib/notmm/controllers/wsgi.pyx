#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Copyright (C) 2007-2016 Etienne Robillard <tkadm30@yandex.ru>
# All rights reserved.
# <LICENSE=ISC>
"""BaseController API Version 0.6.7
...
_logger = logging.getLogger('notmm')
...
class BaseController(BaseControllerMixIn):
    ...
    def application(self, environ, start_response):
        ...
        self._request = self.init_request(environ)
        path_url = self._get_path_info(environ)

        return self.get_response(path_url, request=self.request)(environ, start_response)
    ...
    def init_request(self, environ, request_class=HTTPRequest):
        ...
        self._request = request_class(self._environ)

        #if request.environ != _locals.environ:
        #    self.logger.debug("updating environ object!")
        ...
        #return self.process_request(self.request)
    ...
    def get_response(self, path_url, request=None, method='GET', data={}):
        ...
        #    self.logger.debug("recreating WSGI request object...")
        #    self.init_request(environ=self.environ)
        ...
        try:
            ...
            # Check for APPEND_SLASH
            if self.settings.APPEND_SLASH:
            ...
            self.logger.info('Document not found=%s'%path_url)
...
class WSGIController(BaseController):
    ...
    def __init__(self,
        ...
        - ``app_conf``: Dict of connfiguration options. (optional)
        """
        ...
        #self._locals.environ = {}
        #self._locals.request = None
        self._environ = self._locals.environ = {}

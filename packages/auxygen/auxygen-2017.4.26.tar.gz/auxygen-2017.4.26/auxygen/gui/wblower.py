...
class WBlower(QtWidgets.QDialog, Ui_WBlower):
    ...
    def saveSettings(self):
        ...
        s.setValue('WBlower/motor', self.editMotor.text())
    ...
    def loadSettings(self):
        ...
        self.editMotor.setText(s.value('WBlower/motor', 'mblower'))
    ...
    def updateTemperature(self, value):
        ...
        try:
            error = float(self.editComTimout.text())
        except ValueError:
            error = utils.DEFAULT_ERROR
        if not self.paused and self.signalOnHold and abs(value - self.holdTemp) < error:
    ...
    def on_buttonConnect_clicked(self):
        ...
        motor = self.editMotor.text()
        counter = self.editCounter.text()
        cmd = self.editRamp.text()

...
from ..scripo import cryostream, blower, lakeshore,  motor


class WScriptEd(QtWidgets.QDialog, Ui_WScriptEd):
    sigClosed = QtCore.pyqtSignal()
    sigScript = QtCore.pyqtSignal(str)
    specialWords = cryostream.specialWords + blower.specialWords + motor.specialWords + lakeshore.specialWords
    ...
    def setEnv(self, userEnv, words=None):
        words = words or []
        keywords = list(userEnv.keys()) + self.specialWords + words

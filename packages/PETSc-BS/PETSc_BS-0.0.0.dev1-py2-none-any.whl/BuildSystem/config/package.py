...
class Package(config.base.Configure):
  ...
  def setupDependencies(self, framework):
    sys.path.insert(0, '/home/elijah/sfw/petsc/3.7.5/config/PETSc/')
    sys.path.insert(0, '/home/elijah/sfw/petsc/3.7.5/config/PETSc/options/')
    sys.path.insert(0, '/home/elijah/sfw/petsc/3.7.5/config/PETSc/options/sharedLibraries')

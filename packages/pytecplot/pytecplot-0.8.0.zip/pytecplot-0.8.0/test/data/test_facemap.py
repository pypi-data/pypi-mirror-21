...
class TestFacemapPolygons(unittest.TestCase):
    def setUp(self):
        ...
        self.z = z
        self.assertFalse(bool(self.z.facemap))
        self.assertFalse(self.z.facemap._has_data_backing)
        self.assertIsNone(self.z.facemap.node_c_type)
        self.assertIsNone(self.z.facemap.element_c_type)

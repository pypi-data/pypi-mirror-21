...
from tecplot.exception import TecplotValueError, TecplotOutOfDateEngineError
...
class TestView3D(PropertyTest, TestView):
    ...
    @unittest.skipIf(tp.sdk_version_info < (2017, 2), 'SDK out-of-date.')
    ...
    def test_projection_required_version(self):
        if __debug__:
            save_version_info = tp.plot.view.sdk_version_info
            tp.plot.view.sdk_version_info = (0, 0, 0)
            ...
            try:
                ...
                tp.plot.view.sdk_version_info = save_version_info

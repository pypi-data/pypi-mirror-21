...
class LineLegend(Legend):
    ...
    shown, but |Tecplot 360| removes redundant entries.
    ...
    .. code-block:: python
        ...
        datafile = os.path.join(examples_dir, 'XY', 'rainfall.plt')
        ...
        tecplot.export.save_png('legend_line.png', 600, supersample=4)

...
def interpolate_linear(destination_zone, source_zones=None, variables=None,
    ...
    Parameters:
        ...
        source_zones (`zones <data_access>` or `integers <int>`, optional):
            ...
            will be used.
        variables (`list` of `variables <Variable>` or `integers <int>`,
            optional): Variables (or variable indices) to interpolate. By
            default, all variables except those assigned to the axes will be
            used and is in general dependent on the active plot type of the
            frame.
...
@lock()
def interpolate_kriging(destination_zone, source_zones, variables=None,
    ...
    .. code-block:: python
        ...
        # perform linear interpolation from the source to the new zone
        tp.data.operate.interpolate_kriging(newzone, srczone)
...
@lock()
def interpolate_inverse_distance(destination_zone, source_zones, variables=None,
                                 exponent=3.5, min_radius=0.0,
    ...
    .. code-block:: python
        ...
        # perform linear interpolation from the source to the new zone
        tp.data.operate.interpolate_inverse_distance(newzone, srczone)

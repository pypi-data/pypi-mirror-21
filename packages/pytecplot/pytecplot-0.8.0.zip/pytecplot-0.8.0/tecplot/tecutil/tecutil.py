# 
# This file was auto-generated on Apr  7 2017 by gencode.
...
class TecUtil(object):
    def __init__(self, connector):
        ...
        self.handle = connector.tecutil_handle
        if self.handle is not None:
            ...
            # Boolean_t TecUtilDataAxialDuplicate(UniqueID_t DataSetID, Set_pa Zones, Boolean_t AddZonesToExistingStrands, double RotationInDegrees, double OffsetAngleInDegrees, EntIndex_t NumDuplicates, EntIndex_t NumXYZVars, const  EntIndex_t * XYZVarsArray, EntIndex_t NumUVWVars, const  EntIndex_t * UVWVarsArray, const  double * Origin, const  double * Normal)
            try:
                self.handle.tecUtilDataAxialDuplicate.argtypes = [c_int64, c_void_p, c_bool, c_double, c_double, c_int32, c_int32, POINTER(c_int32), c_int32, POINTER(c_int32), POINTER(c_double), POINTER(c_double)]
            ...
            # Boolean_t TecUtilDataRotate(UniqueID_t DataSetID, Set_pa Zones, double RotationInDegrees, EntIndex_t NumXYZVars, const  EntIndex_t * XYZVarsArray, EntIndex_t NumUVWVars, const  EntIndex_t * UVWVarsArray, const  double * Origin, const  double * Normal)
            try:
                self.handle.tecUtilDataRotate.argtypes = [c_int64, c_void_p, c_double, c_int32, POINTER(c_int32), c_int32, POINTER(c_int32), POINTER(c_double), POINTER(c_double)]
            ...
            try:
                ...
                error_list.append('TecUtilTecplotGetAppMode')
    ...
    # Boolean_t TecUtilDataAxialDuplicate(UniqueID_t DataSetID, Set_pa Zones, Boolean_t AddZonesToExistingStrands, double RotationInDegrees, double OffsetAngleInDegrees, EntIndex_t NumDuplicates, EntIndex_t NumXYZVars, const  EntIndex_t * XYZVarsArray, EntIndex_t NumUVWVars, const  EntIndex_t * UVWVarsArray, const  double * Origin, const  double * Normal)
    @tecutil_preamble
    def DataAxialDuplicate(self, data_set_id, zones, add_zones_to_existing_strands, rotation_in_degrees, offset_angle_in_degrees, num_duplicates, num_xyzvars, x_yzvars_array, num_uvwvars, u_vwvars_array, origin, normal):
        result = self.handle.tecUtilDataAxialDuplicate(data_set_id, zones, add_zones_to_existing_strands, rotation_in_degrees, offset_angle_in_degrees, num_duplicates, num_xyzvars, x_yzvars_array, num_uvwvars, u_vwvars_array, origin, normal)
        return result
    ...
    # Boolean_t TecUtilDataRotate(UniqueID_t DataSetID, Set_pa Zones, double RotationInDegrees, EntIndex_t NumXYZVars, const  EntIndex_t * XYZVarsArray, EntIndex_t NumUVWVars, const  EntIndex_t * UVWVarsArray, const  double * Origin, const  double * Normal)
    @tecutil_preamble
    def DataRotate(self, data_set_id, zones, rotation_in_degrees, num_xyzvars, x_yzvars_array, num_uvwvars, u_vwvars_array, origin, normal):
        result = self.handle.tecUtilDataRotate(data_set_id, zones, rotation_in_degrees, num_xyzvars, x_yzvars_array, num_uvwvars, u_vwvars_array, origin, normal)
        return result

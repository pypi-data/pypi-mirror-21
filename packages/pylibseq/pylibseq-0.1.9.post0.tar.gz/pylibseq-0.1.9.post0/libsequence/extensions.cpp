...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "libsequence.extensions"
}
END: Cython Metadata */
...
static PyObject *__pyx_tp_new_11libsequence_10extensions_SimDataVec(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  ...
  if (unlikely(__pyx_pw_11libsequence_10extensions_10SimDataVec_1__cinit__(o, __pyx_empty_tuple, NULL) < 0)) goto bad;
  return o;
  bad:
  Py_DECREF(o); o = 0;
  return NULL;
...
#endif
{
  ...
  /*--- Type import code ---*/
  __pyx_ptype_11libsequence_9polytable_PolyTable = __Pyx_ImportType("libsequence.polytable", "PolyTable", sizeof(struct __pyx_obj_11libsequence_9polytable_PolyTable), 1); if (unlikely(!__pyx_ptype_11libsequence_9polytable_PolyTable)) __PYX_ERR(2, 52, __pyx_L1_error)
  __pyx_vtabptr_11libsequence_9polytable_PolyTable = (struct __pyx_vtabstruct_11libsequence_9polytable_PolyTable*)__Pyx_GetVtable(__pyx_ptype_11libsequence_9polytable_PolyTable->tp_dict); if (unlikely(!__pyx_vtabptr_11libsequence_9polytable_PolyTable)) __PYX_ERR(2, 52, __pyx_L1_error)
  __pyx_ptype_11libsequence_9polytable_SimData = __Pyx_ImportType("libsequence.polytable", "SimData", sizeof(struct __pyx_obj_11libsequence_9polytable_SimData), 1); if (unlikely(!__pyx_ptype_11libsequence_9polytable_SimData)) __PYX_ERR(2, 62, __pyx_L1_error)
  __pyx_vtabptr_11libsequence_9polytable_SimData = (struct __pyx_vtabstruct_11libsequence_9polytable_SimData*)__Pyx_GetVtable(__pyx_ptype_11libsequence_9polytable_SimData->tp_dict); if (unlikely(!__pyx_vtabptr_11libsequence_9polytable_SimData)) __PYX_ERR(2, 62, __pyx_L1_error)
  __pyx_ptype_11libsequence_9polytable_PolySites = __Pyx_ImportType("libsequence.polytable", "PolySites", sizeof(struct __pyx_obj_11libsequence_9polytable_PolySites), 1); if (unlikely(!__pyx_ptype_11libsequence_9polytable_PolySites)) __PYX_ERR(2, 65, __pyx_L1_error)
  __pyx_vtabptr_11libsequence_9polytable_PolySites = (struct __pyx_vtabstruct_11libsequence_9polytable_PolySites*)__Pyx_GetVtable(__pyx_ptype_11libsequence_9polytable_PolySites->tp_dict); if (unlikely(!__pyx_vtabptr_11libsequence_9polytable_PolySites)) __PYX_ERR(2, 65, __pyx_L1_error)

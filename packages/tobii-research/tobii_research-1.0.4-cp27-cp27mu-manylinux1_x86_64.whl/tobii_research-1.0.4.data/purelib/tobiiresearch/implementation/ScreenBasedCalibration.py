...
class ScreenBasedCalibration(object):
    ...
    def enter_calibration_mode(self):
        ...
        '''
        tobii_pro.screen_based_calibration_enter_calibration_mode(self.__core_eyetracker)
    ...
    def leave_calibration_mode(self):
        ...
        EyeTrackerInternalError
        '''
        tobii_pro.screen_based_calibration_leave_calibration_mode(self.__core_eyetracker)

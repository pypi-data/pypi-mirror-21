...
class UserWeb(object):
    ...
    MANDATORY_PARAMS_INSERT = ['cpf', 'email', 'password', 'fullname', 'phone', 'celphone',
                               'dt_birthday', 'add_street', 'add_number', 'add_neighborhood',
                               'add_city', 'add_state', 'add_zipcode']

    MANDATORY_PARAMS_UPDATE = ['cpf', 'add_street', 'add_number', 'add_neighborhood']
    ...
    def update_email(cls, iduser, email):
        ...
        resp = UserWeb.update_user({'cpf': iduser, 'email': email})

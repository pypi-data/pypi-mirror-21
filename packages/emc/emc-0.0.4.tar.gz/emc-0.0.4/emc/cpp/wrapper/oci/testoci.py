...
It is a wrapper for the C++ op-code interpreter for the state machine Test.
'''

from collections import OrderedDict
from numpy import float32

from emc.cpp.swig.emcpp import TestOci


class TestOciWrapper(object):
    '''
    Wrapper for C++ op-code interpreter Test
    ...
    def __init__(self, memSizeInBytes, expectedOutputs, haltAllowed = False, maxCommandsRatio = 2.0):
        ...
        self.native = TestOci(self.ramSize, self.maxCommands, self.expectedOutputs, self.haltAllowed)
    ...
    def dptr(self): return self.native.dptr()
    def setDptr(self, dptr): self.native.setDptr(dptr)
    ...
    def stack(self): return self.native.stack(16)

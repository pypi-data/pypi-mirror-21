...
It is a wrapper for the C++ op-code interpreter for the state machine Indirect.
'''

from collections import OrderedDict
from numpy import float32

from emc.cpp.swig.emcpp import IndirectOci


class IndirectOciWrapper(object):
    '''
    Wrapper for C++ op-code interpreter Indirect
    ...
    def __init__(self, memSizeInBytes, expectedOutputs, haltAllowed = False, maxCommandsRatio = 2.0):
        ...
        self.native = IndirectOci(self.ramSize, self.maxCommands, self.expectedOutputs, self.haltAllowed)

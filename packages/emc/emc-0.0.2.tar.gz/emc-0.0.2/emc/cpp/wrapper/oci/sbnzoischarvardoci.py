...
It is a wrapper for the C++ op-code interpreter for the state machine SbnzOiscHarvard.
'''

from collections import OrderedDict
from numpy import float32

from emc.cpp.swig.emcpp import SbnzOiscHarvardOci


class SbnzOiscHarvardOciWrapper(object):
    '''
    Wrapper for C++ op-code interpreter SbnzOiscHarvard
    ...
    def __init__(self, memSizeInBytes, expectedOutputs, haltAllowed = False, maxCommandsRatio = 2.0):
        ...
        self.ramSize = self.memSizeInBytes / (2 * 2) # unitsize=2,numMems=2
        ...
        self.native = SbnzOiscHarvardOci(self.ramSize, self.romSize, self.maxCommands, self.expectedOutputs, self.haltAllowed)

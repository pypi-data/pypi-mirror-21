...
It is a wrapper for the C++ op-code interpreter for the state machine Immediate.
'''

from collections import OrderedDict
from numpy import float32

from emc.cpp.swig.emcpp import ImmediateOci


class ImmediateOciWrapper(object):
    '''
    Wrapper for C++ op-code interpreter Immediate
    ...
    def __init__(self, memSizeInBytes, expectedOutputs, haltAllowed = False, maxCommandsRatio = 2.0):
        ...
        self.native = ImmediateOci(self.ramSize, self.maxCommands, self.expectedOutputs, self.haltAllowed)

...
It is a wrapper for the C++ op-code interpreter for the state machine LoadStore.
'''

from collections import OrderedDict
from numpy import float32

from emc.cpp.swig.emcpp import LoadStoreOci


class LoadStoreOciWrapper(object):
    '''
    Wrapper for C++ op-code interpreter LoadStore
    Description: 
    '''
    ...
    def __init__(self, memSizeInBytes, expectedOutputs, haltAllowed = False, maxCommandsRatio = 2.0):
        ...
        self.ramSize = self.memSizeInBytes / (1 * 1) # unitsize=1,numMems=1
        ...
        self.native = LoadStoreOci(self.ramSize, self.maxCommands, self.expectedOutputs, self.haltAllowed)
    ...
    def a(self): return self.native.a()
    def setA(self, a): self.native.setA(a)
    def b(self): return self.native.b()
    def setB(self, b): self.native.setB(b)
    def flags(self): return self.native.flags()
    def setFlags(self, flags): self.native.setFlags(flags)
    def addr(self): return self.native.addr()
    def setAddr(self, addr): self.native.setAddr(addr)

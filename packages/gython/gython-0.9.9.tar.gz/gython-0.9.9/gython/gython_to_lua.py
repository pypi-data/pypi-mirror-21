...
class LuaGenerator(gython.JSGenerator):
    ...
    def visit_TryExcept(self, node):
        ...
        out.append(self.indent() +
                   'local __ok__, __exception__ = pcall(__try__)')
    ...
    def visit_ExceptHandler(self, node):
        ...
        out = []
        if node.type:
            out.append(self.indent() + '--exception: %s' %

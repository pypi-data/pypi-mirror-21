...
setup(
    name=u"conversionutil",  # The module name must match this!
    ...
    url=u'https://bitbucket.org/daycoder/conversionutil.git',  # Use the url to the git repo
    download_url=(u'https://bitbucket.org/daycoder/'
                  u'conversionutil.git/get/{version}.tar'
    ...
    description=u"A collection of conversion utilities.",

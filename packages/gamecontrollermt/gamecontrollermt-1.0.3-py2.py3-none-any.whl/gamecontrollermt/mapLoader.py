import sys
import pytmx
from gamecontrollermt.pgc import Actor
from actors import *
from gamecontrollermt.predefined_actors import *
...
class TiledMap:
    ...
    def _object_factory(self, objName, x, y, width=0, height=0, object_properties=[]):
        ...
        if(actor in subclasses):
            ...
            elif(pgc.IActor in superclasses):
            ...
            elif (pgc.Player in superclasses):

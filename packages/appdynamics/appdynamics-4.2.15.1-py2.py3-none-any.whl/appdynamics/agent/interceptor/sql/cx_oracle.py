...
try:
    ...
    # methods impossible.  We redefine the classes here and expose the methods
    # we need to intercept.  These classes are then exposed to the user via
    # `appdynamics.scripts.cx_oracle`.

...
def munge_exception_messages(iterable, context):
    ...
    try:
        ...
        def annotated_message(self):
            ...
            tb = ('{}"{}", line {}'.format('    ' * ix, f, l)
                    for ix, (f, l) in enumerate(locations))

            return ('{}\n'
                    'Exception originated in code starting at {}'
                    .format(saved_msg, '\n'.join(tb)))

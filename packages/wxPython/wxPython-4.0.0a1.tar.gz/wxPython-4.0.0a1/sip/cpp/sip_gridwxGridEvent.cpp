 ...
 ::wxEvent* sipwxGridEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__grid_62(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);
 ...
 ::wxEventCategory sipwxGridEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__grid_61(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__grid_61(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxGridEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS

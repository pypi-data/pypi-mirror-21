...
static void release_wxGridRowHeaderRendererDefault(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
extern "C" {static void assign_wxGridRowHeaderRendererDefault(void *, SIP_SSIZE_T, const void *);}
static void assign_wxGridRowHeaderRendererDefault(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxGridRowHeaderRendererDefault *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxGridRowHeaderRendererDefault *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxGridRowHeaderRendererDefault[] = {{35, 255, 1}};

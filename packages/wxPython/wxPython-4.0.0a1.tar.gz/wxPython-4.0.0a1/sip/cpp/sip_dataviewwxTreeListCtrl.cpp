...
static PyObject *meth_wxTreeListCtrl_GetCheckedState(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, NULL, "BJ9", &sipSelf, sipType_wxTreeListCtrl, &sipCpp, sipType_wxTreeListItem, &item))
        {
            ...
            return sipConvertFromEnum(sipRes,sipType_wxCheckBoxState);
        }
    }
...
static void release_wxTreeListCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxTreeListCtrl[] = {{35, 0, 1}};
...
static PyMethodDef methods_wxTreeListCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxTreeListCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxTreeListCtrl_SendDestroyEvent)},
...
sipVariableDef variables_wxTreeListCtrl[] = {
    {PropertyVariable, sipName_View, &methods_wxTreeListCtrl[51], NULL, NULL, NULL},
    {PropertyVariable, sipName_SortColumn, &methods_wxTreeListCtrl[50], &methods_wxTreeListCtrl[73], NULL, NULL},
    {PropertyVariable, sipName_Selections, &methods_wxTreeListCtrl[49], NULL, NULL, NULL},
    {PropertyVariable, sipName_Selection, &methods_wxTreeListCtrl[48], NULL, NULL, NULL},
    {PropertyVariable, sipName_RootItem, &methods_wxTreeListCtrl[47], NULL, NULL, NULL},
    {PropertyVariable, sipName_FirstItem, &methods_wxTreeListCtrl[40], NULL, NULL, NULL},
    {PropertyVariable, sipName_DataView, &methods_wxTreeListCtrl[36], NULL, NULL, NULL},
    {PropertyVariable, sipName_ColumnCount, &methods_wxTreeListCtrl[34], NULL, NULL, NULL},

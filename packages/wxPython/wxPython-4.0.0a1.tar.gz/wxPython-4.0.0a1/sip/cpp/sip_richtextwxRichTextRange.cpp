...
extern "C" {static void assign_wxRichTextRange(void *, SIP_SSIZE_T, const void *);}
static void assign_wxRichTextRange(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxRichTextRange *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxRichTextRange *>(sipSrc);
}

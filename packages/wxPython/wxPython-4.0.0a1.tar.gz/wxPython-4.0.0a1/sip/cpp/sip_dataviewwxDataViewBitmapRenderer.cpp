...
bool sipwxDataViewBitmapRenderer::GetValue( ::wxDVCVariant& value) const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewBitmapRenderer::SetValue(const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewBitmapRenderer::HasEditorCtrl() const
{
 ...
 ::wxWindow* sipwxDataViewBitmapRenderer::CreateEditorCtrl( ::wxWindow*parent, ::wxRect labelRect,const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewBitmapRenderer::GetValueFromEditorCtrl( ::wxWindow*editor, ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
static void release_wxDataViewBitmapRenderer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataViewBitmapRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetView), (PyCFunction)meth_wxDataViewBitmapRenderer_GetView, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewBitmapRenderer_GetView)},

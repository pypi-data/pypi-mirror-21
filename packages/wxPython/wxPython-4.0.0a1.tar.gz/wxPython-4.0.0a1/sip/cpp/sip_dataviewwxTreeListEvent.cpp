 ...
 ::wxEvent* sipwxTreeListEvent::Clone() const
{
    ...
    extern  ::wxEvent* sipVH__dataview_55(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__dataview_55(sipGILState, 0, sipPySelf, sipMeth);
}
 ...
 ::wxEventCategory sipwxTreeListEvent::GetEventCategory() const
{
    ...
    extern  ::wxEventCategory sipVH__dataview_54(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__dataview_54(sipGILState, 0, sipPySelf, sipMeth);
}
...
static void release_wxTreeListEvent(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS

...
static void release_wxDataViewListCtrl(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataViewListCtrl[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxDataViewListCtrl_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewListCtrl_SendDestroyEvent)},
...
sipVariableDef variables_wxDataViewListCtrl[] = {
    {PropertyVariable, sipName_Store, &methods_wxDataViewListCtrl[35], NULL, NULL, NULL},
    {PropertyVariable, sipName_SelectedRow, &methods_wxDataViewListCtrl[34], NULL, NULL, NULL},
    {PropertyVariable, sipName_ItemCount, &methods_wxDataViewListCtrl[31], NULL, NULL, NULL},
};

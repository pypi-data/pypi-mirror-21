...
bool sipwxDataViewCustomRenderer::GetValue( ::wxDVCVariant& value) const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewCustomRenderer::SetValue(const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewCustomRenderer::HasEditorCtrl() const
{
 ...
 ::wxWindow* sipwxDataViewCustomRenderer::CreateEditorCtrl( ::wxWindow*parent, ::wxRect labelRect,const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewCustomRenderer::GetValueFromEditorCtrl( ::wxWindow*editor, ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
static void release_wxDataViewCustomRenderer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataViewCustomRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetView), (PyCFunction)meth_wxDataViewCustomRenderer_GetView, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewCustomRenderer_GetView)},

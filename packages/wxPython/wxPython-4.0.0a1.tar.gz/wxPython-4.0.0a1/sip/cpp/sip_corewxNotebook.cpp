...
void sipwxNotebook::SetImageList( ::wxImageList*imageList)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[37],sipPySelf,NULL,sipName_SetImageList);
    ...
    extern void sipVH__core_131(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxImageList*);

    sipVH__core_131(sipGILState, 0, sipPySelf, sipMeth, imageList);
}
...
int sipwxNotebook::GetPageImage( ::size_t nPage) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[38]),sipPySelf,NULL,sipName_GetPageImage);

    if (!sipMeth)
        return  ::wxNotebook::GetPageImage(nPage);

    extern int sipVH__core_121(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_121(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxNotebook::SetPageImage( ::size_t page,int image)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[39],sipPySelf,NULL,sipName_SetPageImage);

    if (!sipMeth)
        return  ::wxNotebook::SetPageImage(page,image);

    extern bool sipVH__core_132(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t,int);

    return sipVH__core_132(sipGILState, 0, sipPySelf, sipMeth, page, image);
}
 ...
 ::wxString sipwxNotebook::GetPageText( ::size_t nPage) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[40]),sipPySelf,NULL,sipName_GetPageText);

    if (!sipMeth)
        return  ::wxNotebook::GetPageText(nPage);

    extern  ::wxString sipVH__core_133(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_133(sipGILState, 0, sipPySelf, sipMeth, nPage);
}
...
bool sipwxNotebook::SetPageText( ::size_t page,const  ::wxString& text)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[41],sipPySelf,NULL,sipName_SetPageText);

    if (!sipMeth)
        return  ::wxNotebook::SetPageText(page,text);

    extern bool sipVH__core_134(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t,const  ::wxString&);

    return sipVH__core_134(sipGILState, 0, sipPySelf, sipMeth, page, text);
}
...
int sipwxNotebook::GetSelection() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[42]),sipPySelf,NULL,sipName_GetSelection);

    if (!sipMeth)
        return  ::wxNotebook::GetSelection();

    extern int sipVH__core_90(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *);

    return sipVH__core_90(sipGILState, 0, sipPySelf, sipMeth);
}
...
int sipwxNotebook::SetSelection( ::size_t page)
{
    ...
    return sipVH__core_121(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
int sipwxNotebook::ChangeSelection( ::size_t page)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[44],sipPySelf,NULL,sipName_ChangeSelection);
...
bool sipwxNotebook::AddPage( ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[45],sipPySelf,NULL,sipName_AddPage);

    if (!sipMeth)
        return  ::wxNotebook::AddPage(page,text,select,imageId);

    extern bool sipVH__core_135(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_135(sipGILState, 0, sipPySelf, sipMeth, page, text, select, imageId);
}
...
bool sipwxNotebook::DeleteAllPages()
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[46],sipPySelf,NULL,sipName_DeleteAllPages);
...
bool sipwxNotebook::DeletePage( ::size_t page)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[47],sipPySelf,NULL,sipName_DeletePage);

    if (!sipMeth)
        return  ::wxNotebook::DeletePage(page);

    extern bool sipVH__core_136(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t);

    return sipVH__core_136(sipGILState, 0, sipPySelf, sipMeth, page);
}
...
bool sipwxNotebook::InsertPage( ::size_t index, ::wxWindow*page,const  ::wxString& text,bool select,int imageId)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[48],sipPySelf,NULL,sipName_InsertPage);

    if (!sipMeth)
        return  ::wxNotebook::InsertPage(index,page,text,select,imageId);

    extern bool sipVH__core_137(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *,  ::size_t, ::wxWindow*,const  ::wxString&,bool,int);

    return sipVH__core_137(sipGILState, 0, sipPySelf, sipMeth, index, page, text, select, imageId);
}
...
bool sipwxNotebook::RemovePage( ::size_t page)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[49],sipPySelf,NULL,sipName_RemovePage);
 ...
 ::size_t sipwxNotebook::GetPageCount() const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[50]),sipPySelf,NULL,sipName_GetPageCount);
...
void sipwxNotebook::SetPageSize(const  ::wxSize& size)
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,&sipPyMethods[51],sipPySelf,NULL,sipName_SetPageSize);
    ...
    extern void sipVH__core_138(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxSize&);

    sipVH__core_138(sipGILState, 0, sipPySelf, sipMeth, size);
}
...
int sipwxNotebook::HitTest(const  ::wxPoint& pt,long*flags) const
{
    ...
    sipMeth = sipIsPyMethod(&sipGILState,const_cast<char *>(&sipPyMethods[52]),sipPySelf,NULL,sipName_HitTest);

    if (!sipMeth)
        return  ::wxNotebook::HitTest(pt,flags);

    extern int sipVH__core_139(sip_gilstate_t, sipVirtErrorHandlerFunc, sipSimpleWrapper *, PyObject *, const  ::wxPoint&,long*);

    return sipVH__core_139(sipGILState, 0, sipPySelf, sipMeth, pt, flags);
}
...
static void release_wxNotebook(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static sipEncodedTypeDef supers_wxNotebook[] = {{33, 255, 1}};
...
static PyMethodDef methods_wxNotebook[] = {
    ...
    {SIP_MLNAME_CAST(sipName_SendDestroyEvent), (PyCFunction)meth_wxNotebook_SendDestroyEvent, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxNotebook_SendDestroyEvent)},
...
sipVariableDef variables_wxNotebook[] = {
    {PropertyVariable, sipName_ThemeBackgroundColour, &methods_wxNotebook[29], NULL, NULL, NULL},
    {PropertyVariable, sipName_Selection, &methods_wxNotebook[28], &methods_wxNotebook[43], NULL, NULL},
    {PropertyVariable, sipName_RowCount, &methods_wxNotebook[27], NULL, NULL, NULL},
};

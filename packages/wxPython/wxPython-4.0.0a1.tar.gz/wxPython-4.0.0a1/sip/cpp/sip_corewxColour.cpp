...
extern "C" {static void assign_wxColour(void *, SIP_SSIZE_T, const void *);}
static void assign_wxColour(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxColour *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxColour *>(sipSrc);
}
...
static sipEncodedTypeDef supers_wxColour[] = {{345, 255, 1}};

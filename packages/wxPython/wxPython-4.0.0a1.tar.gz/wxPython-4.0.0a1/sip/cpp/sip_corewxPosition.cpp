...
extern "C" {static void assign_wxPosition(void *, SIP_SSIZE_T, const void *);}
static void assign_wxPosition(void *sipDst, SIP_SSIZE_T sipDstIdx, const void *sipSrc)
{
    reinterpret_cast< ::wxPosition *>(sipDst)[sipDstIdx] = *reinterpret_cast<const  ::wxPosition *>(sipSrc);
}

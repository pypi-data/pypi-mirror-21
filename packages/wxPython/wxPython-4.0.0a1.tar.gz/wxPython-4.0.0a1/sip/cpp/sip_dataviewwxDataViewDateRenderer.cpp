...
bool sipwxDataViewDateRenderer::GetValue( ::wxDVCVariant& value) const
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewDateRenderer::SetValue(const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewDateRenderer::HasEditorCtrl() const
{
 ...
 ::wxWindow* sipwxDataViewDateRenderer::CreateEditorCtrl( ::wxWindow*parent, ::wxRect labelRect,const  ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
bool sipwxDataViewDateRenderer::GetValueFromEditorCtrl( ::wxWindow*editor, ::wxDVCVariant& value)
{
    sip_gilstate_t sipGILState;
    PyObject *sipMeth;
...
static void release_wxDataViewDateRenderer(void *sipCppV, int sipIsDerived)
{
    Py_BEGIN_ALLOW_THREADS
...
static PyMethodDef methods_wxDataViewDateRenderer[] = {
    ...
    {SIP_MLNAME_CAST(sipName_GetView), (PyCFunction)meth_wxDataViewDateRenderer_GetView, METH_VARARGS|METH_KEYWORDS, SIP_MLDOC_CAST(doc_wxDataViewDateRenderer_GetView)},

...
from harambe import (Harambe,
                   ...
                   recaptcha,
                   storage,
                   decorators as harambe_deco,
                   exceptions as harambe_exc,
                   exceptions,
                   utils,
                   paginate,
                   views,
...
from harambe.contrib.auth import (oauth,
                                is_authenticated,
                                not_authenticated,
    ...
    def update_info(self):
        ...
        try:
            ...
            if file:
                ...
                kwargs["profile_image"] = storage.upload(file,
                                                         name=utils.guid(),
                                                         prefix=prefix,
                                                         public=True,
                                                         allowed_extensions=[

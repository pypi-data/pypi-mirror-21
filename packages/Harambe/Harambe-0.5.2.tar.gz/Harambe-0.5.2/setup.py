...
Harambe is a Flask based framework to help quickly develop web applications, by
...
__about__ = {}
with open(os.path.join(base_dir, "harambe", "__about__.py")) as f:
...
setup(
    ...
    entry_points=dict(console_scripts=[
        'harambe=harambe.cli:cmd',
        'go=harambe.cli:cmd',
        'gorilla=harambe.cli:cmd',

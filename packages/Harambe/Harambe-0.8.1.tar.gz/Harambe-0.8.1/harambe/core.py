...
__all__ = [
            ...
            # For convenience when importing from harambe, but can use
            # the flask one
            "flash",
            "session",
            "request",
...
# By default harambe will load all the application/models.py models
models = type('', (), {})
...
def get_config(key, default=None):
    ...
    :returns mixed:
    """
    return Harambe._app.config.get(key, default) if Harambe._app else default
...
class Harambe(object):
    ...
    def render(cls, data={}, _template=None, _layout=None, **kwargs):
        ...
        # Add some global Harambe data in g, along with APPLICATION DATA
        vars = dict(
            __NAME__=__title__,

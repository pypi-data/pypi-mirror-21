...
try:
    ...
    long_description = open(os.path.join(os.path.abspath(__file__),'README.md')).read()
...
setup(
    ...
    download_url = 'https://github.com/aakash4525/py_link_preview/archive/v0.6.tar.gz', # git tagged tar.gz

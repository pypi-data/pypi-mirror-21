...
class EnvAndAPIs(object):
    ...
    def enviromnment_is_used_by_api(self,
                                    env):
...
class Endpoint(object):
    ...
    def __init__(self,
        ...
        if isinstance(self.methods, basestring):
...
class Endpoints(object):
    ...
    def __load_endpoints(self):
        ...
        for ep_name, ep in self.raw_endpoints.iteritems():
    ...
    def environment_and_api_are_used_by_an_endpoint(self,
                                                    api,
                                                    env):

...
If you're just getting started and looking for tutorial-style documentation, head on over to the :doc:`User Guide </user_guide>`. If you would prefer a comprehensive view of the tools tt provided, check out the autogenerated API docs:

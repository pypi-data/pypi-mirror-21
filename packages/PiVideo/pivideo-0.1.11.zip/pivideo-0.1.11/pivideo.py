...
#  Copyright(c) 2016, 2017 by Lintest Systems LLC
#
######################################################################
#
#  Revision History
...
#   0.1.8	Changes for control software update; display PiVideo version number on query
...
PiVideo_Version='PiVideo Version 1.11'
				...
				if (line[0:2]=="LT"):
					if (fccount==0):
						...
						if (uv1<=cv1):
							...
							success=False
							break
						print("DO NOT INTERRUPT THE SOFTWARE UPDATE PROCESS!")
						vid.update
						_clear_serial_buffer(vid)
					else:

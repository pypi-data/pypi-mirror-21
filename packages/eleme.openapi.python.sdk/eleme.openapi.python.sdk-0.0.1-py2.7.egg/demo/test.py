...
def batch_on_shelf(token):
    ...
    response = ProductService(client).create_item(category_id=26940000135,
                                                  properties={'name': "白切鸡", 'description': "香脆可口，外焦里嫩",
                                                              'image_hash': "3077080f760e7bf0fc985e23dd3e36e2",
                                                              'labels': {'is_featured': 1, 'is_gum': 0, 'is_new': 0,
                                                                         'is_spicy': 0}, 'specs': [
                                                          {'spec_id': 72970000222, 'name': "大份", 'price': 18.0,
                                                           'stock': 9000, 'max_stock': 10000, 'packing_fee': 3.0,
                                                           'on_shelf': 1, 'extend_code': "1234567890",
                                                           'bar_code': "X148948686356666", 'weight': 123}],
                                                              'selling_time': {'weeks': [
                                                                  {'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY',
                                                                   'FRIDAY', 'SATURDAY', 'SUNDAY'}],
                                                                               'begin_date': "2017-03-14",
                                                                               'end_date': "2017-06-22", 'times': [
                                                                      {'begin_time': "18:02", 'end_time': "19:02"}]},
                                                              'attributes': [
                                                                  {'name': "甜度", 'details': ["5分甜", "7分甜"]}]})
    print (response)

$( document ).ready(function() {
  ...
  $(".dropdown").on("keydown", function(e){
    if(e.which === 13){
      ...
      $('.sub-menu').attr("aria-hidden", function(index, attr) {return attr == "true" ? "false" : "true"});

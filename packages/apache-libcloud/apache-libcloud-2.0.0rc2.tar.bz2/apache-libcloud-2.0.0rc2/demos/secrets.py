...
GANDI_PARAMS = ('user',)
GCE_PARAMS = ('559721082575-compute@developer.gserviceaccount.com', 'libcloud-dev-42a9d4f9a487.json')  # Service Account Authentication
#GCE_PARAMS = ('client_id', 'client_secret')  # Installed App Authentication
GCE_KEYWORD_PARAMS = {'project': 'libcloud-dev'}

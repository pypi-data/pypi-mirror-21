...
class DaemonController(object):
    def __init__(self, settings, oauth_helper, daemon_manager_class, service_cls, notifier_class,
        ...
        self.notifier = notifier_class(settings, self.logger)
    ...
    def run_daemon(self):
        ...
        try:
            ...
            if notifications_dict and len(notifications_dict) > 0:

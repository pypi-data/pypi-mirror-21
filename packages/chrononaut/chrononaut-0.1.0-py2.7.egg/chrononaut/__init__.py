...
class Versioned(object):
    ...
    *all* columns are tracked. By default, change information includes a ``user_id``
    ...
    def diff(self, from_model, to_model=None):
        ...
        diff = {}
        for col_name in from_model.__mapper__.local_table.c:
            print getattr(to_model, col_name)

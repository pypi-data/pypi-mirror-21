...
{
    "distutils": {},
    "module_name": "atropos.trim._qualtrim"
}
END: Cython Metadata */
...
#define __PYX_HAVE__atropos__trim___qualtrim
#define __PYX_HAVE_API__atropos__trim___qualtrim
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'atropos.trim._qualtrim' */
#define __Pyx_MODULE_NAME "atropos.trim._qualtrim"
int __pyx_module_is_main_atropos__trim___qualtrim = 0;

/* Implementation of 'atropos.trim._qualtrim' */
...
static const char __pyx_k_atropos_trim__qualtrim[] = "atropos.trim._qualtrim";
static const char __pyx_k_Users_didionjp_projects_atropos[] = "/Users/didionjp/projects/atropos/atropos/trim/_qualtrim.pyx";
static PyObject *__pyx_n_s_G;
static PyObject *__pyx_kp_s_Users_didionjp_projects_atropos;
static PyObject *__pyx_n_s_atropos_trim__qualtrim;
...
static PyObject *__pyx_pf_7atropos_4trim_9_qualtrim_quality_trim_index(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_qualities, int __pyx_v_cutoff_front, int __pyx_v_cutoff_back, int __pyx_v_base); /* proto */
static PyObject *__pyx_pf_7atropos_4trim_9_qualtrim_2nextseq_trim_index(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sequence, int __pyx_v_cutoff, int __pyx_v_base); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_7atropos_4trim_9_qualtrim_1quality_trim_index(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7atropos_4trim_9_qualtrim_quality_trim_index[] = "\n    Find the positions at which to trim low-quality ends from a nucleotide sequence.\n    Return tuple (start, stop) that indicates the good-quality segment.\n\n    Qualities are assumed to be ASCII-encoded as chr(qual + base).\n\n    The algorithm is the same as the one used by BWA within the function\n    'bwa_trim_read':\n    - Subtract the cutoff value from all qualities.\n    - Compute partial sums from all indices to the end of the sequence.\n    - Trim sequence at the index at which the sum is minimal.\n    ";
static PyMethodDef __pyx_mdef_7atropos_4trim_9_qualtrim_1quality_trim_index = {"quality_trim_index", (PyCFunction)__pyx_pw_7atropos_4trim_9_qualtrim_1quality_trim_index, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7atropos_4trim_9_qualtrim_quality_trim_index};
static PyObject *__pyx_pw_7atropos_4trim_9_qualtrim_1quality_trim_index(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("atropos.trim._qualtrim.quality_trim_index", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_7atropos_4trim_9_qualtrim_quality_trim_index(__pyx_self, __pyx_v_qualities, __pyx_v_cutoff_front, __pyx_v_cutoff_back, __pyx_v_base);
...
static PyObject *__pyx_pf_7atropos_4trim_9_qualtrim_quality_trim_index(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_qualities, int __pyx_v_cutoff_front, int __pyx_v_cutoff_back, int __pyx_v_base) {
  int __pyx_v_s;
...
/* Python wrapper */
static PyObject *__pyx_pw_7atropos_4trim_9_qualtrim_3nextseq_trim_index(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7atropos_4trim_9_qualtrim_2nextseq_trim_index[] = "\n    Variant of the above quality trimming routine that works on NextSeq data.\n    With Illumina NextSeq, bases are encoded with two colors. 'No color' (a\n    dark cycle) usually means that a 'G' was sequenced, but that also occurs\n    when sequencing falls off the end of the fragment. The read then contains\n    a run of high-quality G bases in the end.\n\n    This routine works as the one above, but counts qualities belonging to 'G'\n    bases as being equal to cutoff - 1.\n    ";
static PyMethodDef __pyx_mdef_7atropos_4trim_9_qualtrim_3nextseq_trim_index = {"nextseq_trim_index", (PyCFunction)__pyx_pw_7atropos_4trim_9_qualtrim_3nextseq_trim_index, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7atropos_4trim_9_qualtrim_2nextseq_trim_index};
static PyObject *__pyx_pw_7atropos_4trim_9_qualtrim_3nextseq_trim_index(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("atropos.trim._qualtrim.nextseq_trim_index", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7atropos_4trim_9_qualtrim_2nextseq_trim_index(__pyx_self, __pyx_v_sequence, __pyx_v_cutoff, __pyx_v_base);
...
static PyObject *__pyx_pf_7atropos_4trim_9_qualtrim_2nextseq_trim_index(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_sequence, int __pyx_v_cutoff, int __pyx_v_base) {
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_atropos_trim__qualtrim, __pyx_k_atropos_trim__qualtrim, sizeof(__pyx_k_atropos_trim__qualtrim), 0, 0, 1, 1},
...
static int __Pyx_InitCachedConstants(void) {
  ...
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(4, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_didionjp_projects_atropos, __pyx_n_s_quality_trim_index, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 7, __pyx_L1_error)
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_atropos__trim___qualtrim) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "atropos.trim._qualtrim")) {
      if (unlikely(PyDict_SetItemString(modules, "atropos.trim._qualtrim", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7atropos_4trim_9_qualtrim_1quality_trim_index, NULL, __pyx_n_s_atropos_trim__qualtrim); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_quality_trim_index, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7atropos_4trim_9_qualtrim_3nextseq_trim_index, NULL, __pyx_n_s_atropos_trim__qualtrim); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init atropos.trim._qualtrim", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init atropos.trim._qualtrim");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3

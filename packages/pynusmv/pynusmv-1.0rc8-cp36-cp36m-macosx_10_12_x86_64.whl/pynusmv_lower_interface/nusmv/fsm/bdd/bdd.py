...
def compassionList2fairnessList(l: 'CompassionList_ptr') -> "FairnessList_ptr":
    """compassionList2fairnessList(CompassionList_ptr l) -> FairnessList_ptr"""
    return _bdd.compassionList2fairnessList(l)

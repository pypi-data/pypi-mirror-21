...
def scp_cmd(current_host, mode, local_file, remote_file, recursive=False, preserve_times=False, username=sm_username, keyfile=sm_key, port=sm_port):
    ...
    :type sm_username: string
    :param sm_username: the username to use when connecting
    :type sm_key: string
    :param sm_key: the absolute path to the private ssh key
    :type sm_port: intr
    :param sm_port: the port to connect on
...
def ssh_cmd_auto_check(current_host, command, sm_username=sm_username, sm_key=sm_key, sm_port=sm_port, print_stdout=True):
    ...
    :param print_stdout: Wether to print the stdout to terminal
    """
    ssh_cmd_output = ssh_cmd(current_host, command, sm_username=sm_username, sm_key=sm_key, sm_port=sm_port, print_stdout=True)

...
from manhattan.manage.views.assets.upload import upload_chains
...
class Manage:
    ...
    def manage_assets(self, root, backend, settings=None, path='/upload-asset'):
    ...
    def send_email(
        ...
        logo_url = '/images/logo-inverted.svg'
...
class ManageEmailTemplate(EmailTemplate):
    ...
    def get_jinja_env(self):
        # Return the environment for the current app

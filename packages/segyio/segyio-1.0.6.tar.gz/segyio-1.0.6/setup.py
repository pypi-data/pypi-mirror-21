...
setup(name='segyio',
      ...
      packages=['segyio'],
      #package_dir={'': ''},
      #package_data={'': ['/data/opm/segyio/License.md']},
      license='LGPL-3.0',
      ext_modules=[Extension('segyio._segyio',
                                                sources=['.//data/opm/segyio/python/segyio/_segyio.c','.//data/opm/segyio/lib/src/segy.c'],
                                                include_dirs=['include//data/opm/segyio/lib/src','include//data/opm/segyio/lib/include'],

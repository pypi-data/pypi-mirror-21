...
class TopologyPageInfo:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.topology_conf = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.topology_conf is not None:
      ...
      oprot.writeString(self.topology_conf)
      oprot.writeFieldEnd()
...
class ComponentPageInfo:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.topology_name = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.eventlog_host = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 13:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.topology_status = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.topology_name is not None:
      ...
      oprot.writeString(self.topology_name)
      oprot.writeFieldEnd()
    if self.num_executors is not None:
    ...
    if self.eventlog_host is not None:
      ...
      oprot.writeString(self.eventlog_host)
      oprot.writeFieldEnd()
    ...
    if self.topology_status is not None:
      ...
      oprot.writeString(self.topology_status)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def write(self, oprot):
    ...
    if self.node_host is not None:
      ...
      for kiter530,viter531 in self.node_host.items():
        oprot.writeString(kiter530)
        oprot.writeString(viter531)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class LogLevel:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.target_log_level = iprot.readString();
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I32:
        ...
        if ftype == TType.STRING:
          self.reset_log_level = iprot.readString();
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.target_log_level is not None:
      ...
      oprot.writeString(self.target_log_level)
      oprot.writeFieldEnd()
    ...
    if self.reset_log_level is not None:
      ...
      oprot.writeString(self.reset_log_level)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()

...
class RestApi:
    ...
    def get_header(self, method, uri):
        ...
        print(header['X-Timestamp'])
        print(header['X-Signature'])
    ...
    def get(self, uri, query={}):
        ...
        try:
            ...
            print("Http status_3.5.3: %s" % r.status_code)
            pprint(response)
            ...
            # print("X-API-KEY : "+ headers['X-API-KEY'])
            # print("X-Signature : "+ headers['X-Signature'])
            # print("X-Customer : "+ headers['X-Customer'])
    ...
    def put(self, uri, data, query={}):
        ...
        try:
            ...
            r = requests.put(url, data=data_str, headers=headers, verify=False)
            pprint(r.text)

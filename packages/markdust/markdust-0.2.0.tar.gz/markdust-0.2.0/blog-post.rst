...
This command pings the `ESV API <http://www.esvapi.org/api/>`_ and outputs the contents of the passage to the stdout along with a MD link back the passage online:

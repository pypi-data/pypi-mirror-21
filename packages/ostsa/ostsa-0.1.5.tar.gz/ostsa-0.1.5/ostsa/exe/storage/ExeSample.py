...
class ExeSample(Sample):
    ...
    @staticmethod
    def two_gram_assembly_list():
        """Get the list of all of the selected instruction two-grams that
        are to be used for the two-gram assembly feature
        """
    ...
    @abstractmethod
    @feature('Assmbly Bytes')
    def assembly_bytes(self):
        """Extract the first 800 bytes from the assembly file
        
        Total number of features: 800
        """
        return self.assembly_bytes()
    ...
    def two_gram_assembly_frequencies(self):
        """
        Extract the two grams from the assembly file.
        
        """
        
        return self.two_gram_assembly_frequencies()
    ...
    def four_gram_frequencies(self):
        """Extract the number of occurrences of all --- possible 

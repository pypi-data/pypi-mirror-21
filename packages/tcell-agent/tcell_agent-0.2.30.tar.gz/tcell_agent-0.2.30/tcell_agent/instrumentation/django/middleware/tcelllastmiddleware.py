...
def ensure_routes_sent():
    ...
    if tcell_agent.instrumentation.django._route_table_sent:
...
class TCellLastMiddleware(object):
    ...
    def __init__(self, get_response=None):
        ...
        if not tcell_agent.instrumentation.django._route_table_sent and not midVersionGreaterThanOrEqualTo("1.10"):
            tcell_agent.instrumentation.django._route_table_sent = True
            make_route_table()

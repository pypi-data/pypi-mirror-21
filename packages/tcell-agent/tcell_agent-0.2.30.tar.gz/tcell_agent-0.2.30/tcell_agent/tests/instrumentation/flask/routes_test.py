...
from tcell_agent.instrumentation.flask.routes import calculate_route_id, discover_route, get_methods
...
class RoutesTest(unittest.TestCase):
    ...
    def upper_case_method_calculate_route_id_test(self):
        self.assertEqual(str(hash('get|/')), calculate_route_id('GET', '/'))
    ...
    def dynamic_discover_route_test(self):
        ...
        with patch.object(TCellAgent, 'discover_route', return_value=None) as patched_discover_route:
            ...
            patched_discover_route.assert_called_once_with(
                route_url='/',
                route_method='GET',
                route_target='tcell_agent.tests.instrumentation.flask.routes_test.index',
    ...
    def bound_method_discover_route_test(self):
        ...
        with patch.object(TCellAgent, 'discover_route', return_value=None) as patched_discover_route:
            ...
            patched_discover_route.assert_called_once_with(
                route_url='/',
                route_method='GET',
                route_target='tcell_agent.tests.instrumentation.flask.routes_test.api',
                route_id=calculate_route_id('GET', '/'))

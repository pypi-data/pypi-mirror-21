...
from tcell_agent.instrumentation.flask.meta import create_meta, set_context_and_start_timer, update_meta_with_response
...
class MetaTest(unittest.TestCase):
    ...
    def set_context_and_start_timer_test(self):
        ...
        with patch('tcell_agent.instrumentation.flask.meta.start_timer') as patched_start_timer:
            ...
            self.assertEqual(str(hash('get|/')), context.route_id)

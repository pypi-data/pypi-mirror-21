...
SPURGEON_DEVOTIONAL_AM = 'AM' # Morning Devotional
SPURGEON_DEVOTIONAL_PM = 'PM' # Evening Devotional
SPURGEON_DEVOTIONAL_CHECKBOOK = 'CHECKBOOK' # Faith's Checkbook (note American spelling)
SPURGEON_DEVOTIONAL_TYPES = {SPURGEON_DEVOTIONAL_AM, SPURGEON_DEVOTIONAL_PM, SPURGEON_DEVOTIONAL_CHECKBOOK}
...
class SpurgeonDevotional(object):

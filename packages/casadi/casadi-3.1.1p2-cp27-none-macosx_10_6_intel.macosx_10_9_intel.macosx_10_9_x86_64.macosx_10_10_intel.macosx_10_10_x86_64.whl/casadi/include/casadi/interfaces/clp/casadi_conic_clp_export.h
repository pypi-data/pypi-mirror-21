...
#      define CASADI_CONIC_CLP_EXPORT __attribute__((visibility("default")))
#    else
...
#    define CASADI_CONIC_CLP_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef CASADI_CONIC_CLP_DEPRECATED
#  define CASADI_CONIC_CLP_DEPRECATED __attribute__ ((__deprecated__))
#endif
...
#  ifndef CASADI_CONIC_CLP_NO_DEPRECATED

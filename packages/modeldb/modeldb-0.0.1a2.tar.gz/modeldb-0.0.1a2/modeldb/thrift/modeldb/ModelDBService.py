            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i485 in range(_size481):
                        _elem486 = ProjectOverviewResponse()
                        _elem486.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i499 in range(_size495):
                        _elem500 = TransformEvent()
                        _elem500.read(iprot)
                        self.te.append(_elem500)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i506 in range(_size502):
                        _elem507 = TransformEventResponse()
                        _elem507.read(iprot)

...
__all__ = ["BaseXMLFeedSpider", "DataBaseXMLFeedSpider", "MongoXMLFeedSpider", "RedisXMLFeedSpider",
           "DataBaseAndRedisXMLFeedSpider", "MongoAndRedisXMLFeedSpider", "MongoAndDataBaseXMLFeedSpider",
           "DataBaseAndMongoAndRedisXMLFeedSpider", ]
...
class AbstractXMLFeedSpider(AbstractMixin, XMLFeedSpider):
    ...
    def start_requests(self):
        return super(AbstractXMLFeedSpider, self).start_requests()
...
class DataBaseXMLFeedSpider(DataBaseMixin, BaseXMLFeedSpider):
    pass
...
class DataBaseAndRedisXMLFeedSpider(DataBaseAndRedisMixin, BaseXMLFeedSpider):
    pass
...
class MongoAndDataBaseXMLFeedSpider(MongoAndDataBaseMixin, BaseXMLFeedSpider):
    pass


class DataBaseAndMongoAndRedisXMLFeedSpider(DataBaseAndMongoAndRedisMixin, BaseXMLFeedSpider):
    pass

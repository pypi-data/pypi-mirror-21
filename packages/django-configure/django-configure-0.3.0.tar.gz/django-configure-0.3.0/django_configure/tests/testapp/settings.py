...
config = django_configure.default('testapp', BASE_DIR, env_prefix='TESTAPP')
config.append({
    'Database': {'url': django_configure.type.Database(default='sqlite:///'+BASE_DIR+'/djangoconf.sqlite')}
})
...
STATIC_ROOT = config.get('Common.static_root')
MEDIA_ROOT = config.get('Common.media_root')
MEDIA_URL = config.get('Common.media_url')

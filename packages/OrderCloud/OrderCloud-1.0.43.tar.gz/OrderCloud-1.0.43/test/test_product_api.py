...
from OrderCloud.apis.product_api import ProductApi
...
class TestProductApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = OrderCloud.apis.product_api.ProductApi()
    ...
    def test_generate_variants(self):
        """
        Test case for generate_variants

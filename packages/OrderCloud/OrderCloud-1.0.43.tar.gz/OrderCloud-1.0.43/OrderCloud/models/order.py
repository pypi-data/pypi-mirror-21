...
class Order(object):
    ...
    """
    def __init__(self, id=None, type=None, from_company_id=None, from_user_id=None, from_user_first_name=None, from_user_last_name=None, billing_address_id=None, billing_address=None, shipping_address_id=None, comments=None, line_item_count=None, status=None, date_created=None, date_submitted=None, date_approved=None, date_declined=None, date_canceled=None, date_completed=None, subtotal=None, shipping_cost=None, tax_cost=None, promotion_discount=None, total=None, is_submitted=None, xp=None):
        """
        ...
        self.swagger_types = {
            ...
            'from_company_id': 'str',
            'from_user_id': 'str',
            'from_user_first_name': 'str',
            'from_user_last_name': 'str',
        ...
        self._from_user_first_name = from_user_first_name
        self._from_user_last_name = from_user_last_name
    ...
    def from_user_first_name(self):
        """
        Gets the from_user_first_name of this Order.


        :return: The from_user_first_name of this Order.
        :rtype: str
        """
        return self._from_user_first_name

    @from_user_first_name.setter
    def from_user_first_name(self, from_user_first_name):
        """
        Sets the from_user_first_name of this Order.


        :param from_user_first_name: The from_user_first_name of this Order.
        :type: str
        """
    ...
    def from_user_last_name(self):
        """
        Gets the from_user_last_name of this Order.


        :return: The from_user_last_name of this Order.
        :rtype: str
        """
        return self._from_user_last_name

    @from_user_last_name.setter
    def from_user_last_name(self, from_user_last_name):
        """
        Sets the from_user_last_name of this Order.


        :param from_user_last_name: The from_user_last_name of this Order.
        :type: str
        """

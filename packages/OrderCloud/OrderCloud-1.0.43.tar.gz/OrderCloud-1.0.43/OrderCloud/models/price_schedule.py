...
class PriceSchedule(object):
    ...
    """
    def __init__(self, id=None, name=None, apply_tax=None, apply_shipping=None, min_quantity=None, max_quantity=None, use_cumulative_quantity=None, restricted_quantity=None, order_type=None, price_breaks=None, xp=None):
        """

...
class Payment(object):
    ...
    """
    def __init__(self, id=None, type=None, date_created=None, credit_card_id=None, spending_account_id=None, description=None, amount=None, xp=None, transactions=None):
        """

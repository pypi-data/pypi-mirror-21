...
from configurationutil.cfg_objects.configuration_object import ConfigObject

logging = logging_helper.setup_logging()

TEMPLATE = u'yaml_config_default.yaml'
...
class YAMLConfig(ConfigObject):
    ...
    def _load_config(self,
        ...
        if not os.path.exists(self._config_file) and create:
            ...
            # Load the template
            template = yaml.load(open(self.DEFAULT_TEMPLATE))
        ...
        self._cfg = yaml.load(open(self._config_file))
    ...
    def __retrieve_item(self,
        ...
        elif current_item_key in obj and type(obj.get(current_item_key)) == dict:

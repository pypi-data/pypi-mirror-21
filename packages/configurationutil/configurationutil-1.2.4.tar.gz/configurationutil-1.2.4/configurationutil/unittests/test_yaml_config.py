...
import yaml
import unittest
from configurationutil.cfg_objects import yaml_config
...
class TestYAMLConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = yaml_config.YAMLConfig(config_file=self.cfg_file,
                                             create=True)
    ...
    def test_instantiation_invalid_config_file(self):
        with self.assertRaises(IOError):
            self.cfg_test = yaml_config.YAMLConfig(config_file=u'does_not_exist!')
    ...
    def test_instantiation_missing_default(self):
        ...
        default_template = yaml_config.YAMLConfig.DEFAULT_TEMPLATE
        del yaml_config.YAMLConfig.DEFAULT_TEMPLATE
        ...
        yaml_config.YAMLConfig.DEFAULT_TEMPLATE = default_template
    ...
    def test_save(self):
        ...
        f = yaml.load(open(self.cfg_file))

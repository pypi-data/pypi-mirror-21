...
class CfgItems(object):
    ...
    def __init__(self,
        ...
        if not self._has_active:
            # There is no active property so remove methods that are not required
            delattr(self, u'get_active_items')
            delattr(self, u'get_active_item')
    ...
    def get_items(self,
        ...
        for item_name, item_config in self.raw_items.iteritems():
            ...
            items.append(CfgItem(cfg_fn=self._cfg_fn,

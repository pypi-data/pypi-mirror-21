...
setup(
  name = 'prosodic',
  packages = ['prosodic','prosodic/lib','prosodic/lib/feats','prosodic/metricaltree','prosodic/dicts','prosodic/dicts/en','prosodic/dicts/en/pyphen','prosodic/dicts/fi','prosodic/meters'], # this must be the same as the name above
  version = '1.1.6',
  ...
  package_data={
        'prosodic': ['corpora/**/*.txt', 'dicts/**/.tsv','dicts/**/.txt','dicts/en/pyphen/dictionaries/*.dic','metricaltree/*.sh', 'metricaltree/*.md','tagged_samples/*.txt']
    },

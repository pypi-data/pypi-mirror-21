...
setup(
  name = 'prosodic',
  packages = ['prosodic','prosodic/lib','prosodic/lib/feats','prosodic/metricaltree','prosodic/corpora','prosodic/dicts','prosodic/dicts/en','prosodic/dicts/en/pyphen','prosodic/dicts/fi','prosodic/meters','prosodic/tagged_samples'], # this must be the same as the name above
  version = '1.1.2',

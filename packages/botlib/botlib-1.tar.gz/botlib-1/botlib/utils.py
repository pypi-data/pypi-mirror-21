...
def useragent(): return 'Mozilla/5.0 (X11; Linux x86_64) BOTLIB %s +https://bitbucket.org/bthate/botlib)' % botlib.__version__
...
def fnn(object):
    fn = object.f_code.co_filename
    return fn.split(os.sep)[-1][:-3]

def copyright():
    return "Copyright 2016,2017 Bart Thate"
...
def parse_cli(*args, **kwargs):
    from botlib.object import Config

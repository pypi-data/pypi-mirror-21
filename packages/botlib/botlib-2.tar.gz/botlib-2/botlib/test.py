...
examples.loglevel = "logleve info"
...
exclude = ["reboot", "real_reboot", "fetcher", "synchronize", "init", "shutdown", "nick", "wrongxml","mbox", "fetcher", "testcmnds", "runkernel", "getline", "start", "functest", "loglevel", "cmndrun"]

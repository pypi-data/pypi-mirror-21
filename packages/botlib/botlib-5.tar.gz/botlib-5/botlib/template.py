...
"""
    default cfg objects containing default values for various services and plugins.
...
kernel.banner = False
kernel.bootdir = os.path.join(os.path.abspath(os.path.expanduser("~")), ".botlib")
...
kernel.local = True
kernel.logdir = os.path.join(os.path.abspath(os.path.expanduser("~")), ".botlog")
kernel.loglevel = ""
kernel.owner = "root@shell"
kernel.match = "~/.botlog/bot.log"
kernel.mods = ""
...
kernel.reboot = False
kernel.tailfile = ""
kernel.txt = "Framework to program bot, JSON file backend, MIT license."
kernel.test = False
kernel.verbose = False
kernel.watch = os.path.join(os.path.abspath(os.path.expanduser("~")), ".botlog", "bot.log")
kernel.workdir = os.path.join(kernel.homedir, ".botdata")
kernel.workdirs = []
kernel.write = False
...
opts_defs = [
              ...
              ('-g', '--global', 'store_false', True, 'local', "use ~/.madsbot as workdir"),
              ...
              ('', '--scan', 'store_true', False, 'scan', "scan for workdirs in the homedir."),
          ]

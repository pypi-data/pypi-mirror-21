...
from anna import ActionParameter, Bool, Integer, PhysicalQuantity, String, \
    Choice, ComplementaryGroup, Configurable, parametrize, document_parameters
import injector
import numpy
...
tracked_particle_type_choices = Choice(String('TrackedParticleType'))
for specific_particle_type in specific_particle_types:
    tracked_particle_type_choices.add_option(specific_particle_type)
# noinspection PyTypeChecker
tracked_particle_type_parameter = ActionParameter(
    tracked_particle_type_choices,
...
@parametrize(
    ...
    tracked_particle_type_parameter,
    Bool(
...
class SimulationParameters(Configurable):
    ...
    def particle_type(self):
        ...
        """
        return self._tracked_particle_type

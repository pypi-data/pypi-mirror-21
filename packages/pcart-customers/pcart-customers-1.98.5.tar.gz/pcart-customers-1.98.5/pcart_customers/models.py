...
class ProductPageVisit(models.Model):
    ...
    customer = models.ForeignKey(
        Customer, verbose_name=_('Customer'), related_name='product_page_visits',
...
class WishListedProduct(models.Model):
    ...
    wish_list = models.ForeignKey(
        WishList, verbose_name=_('Wish list'), related_name='wishlisted_products',
        on_delete=models.CASCADE,
    )
    ...
    class Meta:
        verbose_name = _('Wishlisted product')
        verbose_name_plural = _('Wishlisted products')
        ordering = ['-added']
...
class ComparisonProduct(models.Model):
    ...
    customer = models.ForeignKey(
        Customer, verbose_name=_('Customer'), related_name='comparison_products',
        on_delete=models.CASCADE,
    )

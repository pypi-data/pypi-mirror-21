	...
	var imageDialog = function( editor, dialogType ) {
			...
			function commitContent() {
				...
				if(this.figureCaptionElement){
					this.figureCaptionElement.setHtml( this.imageElement.getAttribute( 'data-caption' ) );	
				}

				if(this.figureElement){
					//Set width and floating of figure based on image width
			...
			return {
				...
				onShow: function() {
					...
					this.figureElement = false;
					this.figureCaptionElement = false;

					// Default: create a new element.
					this.imageEditMode = false;
					this.linkEditMode = false;
					this.figureEditMode = false;
					...
					if ( this.imageEditMode ) {
						...
						this.imageElement.setAttribute( 'data-caption', "");

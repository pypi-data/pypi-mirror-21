# TODO: Velocipy legacy: to be cleaned, then moved under hyo.soundspeed.base
...
import hyo.soundspeed.profile
# 3rd party libs
import numpy
from hyo.soundspeed.profile import dicts
# our custom package
...
class Profile(numpy.recarray):
    ...
    def ConvertToSoundSpeedProfile(self):
        p = hyo.soundspeed.profile.profile.Profile()
        # translate metadata

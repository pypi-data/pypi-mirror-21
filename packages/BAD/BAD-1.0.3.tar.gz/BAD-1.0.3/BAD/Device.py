...
class Device(object):
    def __init__(self, dv_id=None, name=None):
        self.Width = None
        self.High = None
        self.Id = dv_id
        self.Name = name
        self._SurfaceStatsCollector = SurfaceStatsCollector(self)
        pass
    ...
    def getSurfaceStatsCollector(self):
        """
        :return SurfaceStatsCollector
        """
        return self._SurfaceStatsCollector
    ...
    def fps_stats_start(self, focuse_name=None):
        ...
        if focuse_name is not None:
            self._SurfaceStatsCollector._focuse_name = focuse_name
        self._SurfaceStatsCollector.DisableWarningAboutEmptyData()
        self._SurfaceStatsCollector.Start()

    def fps_stats_stop(self, result_name=None):
        """
        结束收集fps，并返回结果
        """
        self._SurfaceStatsCollector.Stop()
        results = self._SurfaceStatsCollector.GetResults()

...
class SampleEngine:
    def __init__(self, Monsoon,bulkProcessRate=128):
        ...
        self.__startTriggerSetting = triggers.Manual
        self.__startTriggerLevel = 0
        self.__startTriggerStyle = triggers.style_greaterThan
        self.__stopTriggerSetting = triggers.Manual
        self.__stopTriggerLevel = 0
        self.__stopTriggerStyle = triggers.style_lessThan
        #output writer
        self.__f = None

        pass

    def setStartTrigger(self, triggerSetting,triggerLevel,triggerStyle):
        pass
        ...
        while self.sampleCount < samples:
            ...
            if(granularity_index >= granularity):
                ...
                if(S >= self.bulkProcessRate):
                    ...
                    S = 0
                if(S % self.bulkProcessRate/2 == 0 and self.__CSVOutEnable and self.__triggered):
                    self.__outputToCSV()

...
.. code:: python
  ...
  if __name__ == "__main__": 
    ...
    skitai.mount ('/', __file__, 'app2')
    skitai.mount ('/', __file__, 'app3')
    skitai.mount ('/', /var/www/test/static)    
    skitai.run ()
...
Now app.py is like this:

.. code:: python

  import skitai
    
  skitai.mount ('/v1', 'static')
  skitai.mount ('/v1', 'app_v1')
  skitai.mount ('/v2', 'static')
...
Also you can set max-age for static file respone header.

...
- cluster_type: one of 'http', 'https', 'ws', 'wss', 'rpc', 'rpcs', 'grpc', 'grpcs', skitai.DB_POSTGRESQL, skitai.DB_PGSQL, skitai.DB_SQLITE3, skitai.DB_REDIS, skitai.DB_MONGODB
...
- ssl: use SSL connection or not, 'https', 'wss', 'rpcs' and 'grpcs' use SSL defaultly

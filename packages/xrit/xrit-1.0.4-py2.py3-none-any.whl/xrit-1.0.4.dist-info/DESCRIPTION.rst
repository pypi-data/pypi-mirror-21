...
Dumps the data section of a HRIT/LRIT file. PS: This does not convert or
process anything. It just saves the data section.
...
This also can be used as a python library by importing ``xrit``. The
documentation is still WIP. Please us the module executables as a
reference.

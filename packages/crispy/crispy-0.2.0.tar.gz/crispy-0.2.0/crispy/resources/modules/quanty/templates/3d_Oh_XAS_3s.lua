...
if H_coulomb == 1 then
    ...
    U_3s_3d_f  = $U(3s,3d)_f_value * $U(3s,3d)_f_scaling
...
if H_3d_Ld_hybridization == 1 then
    ...
    if H_coulomb == 1 then
        ...
        e_3d_f = (10 * Delta_3d_Ld_f - NElectrons_3d * (31 + NElectrons_3d) * U_3d_3d_f / 2 - 90 * U_3s_3d_f) / (12 + NElectrons_3d)
        e_Ld_f = ((1 + NElectrons_3d) * (NElectrons_3d * U_3d_3d_f / 2 + 6 * U_3s_3d_f) - (6 + NElectrons_3d) * Delta_3d_Ld_f) / (12 + NElectrons_3d)
...
Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_3s, N_3d}
header = '\nAnalysis of the initial Hamiltonian:\n'
header = header .. '==============================================================================================\n'
header = header .. '   i       <E>     <S^2>     <L^2>     <J^2>      <Sz>      <Lz>      <Jz>    <N_3s>    <N_3d>\n'
header = header .. '==============================================================================================\n'
footer = '==============================================================================================\n'

if H_3d_Ld_hybridization == 1 then
    Operators = {H_i, Ssqr, Lsqr, Jsqr, Sz, Lz, Jz, N_3s, N_3d, N_Ld}
    header = '\nAnalysis of the initial Hamiltonian:\n'
    header = header .. '========================================================================================================\n'

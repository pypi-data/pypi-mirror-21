...
Default is ``configdeck.schema.NO_DEFAULT``.
...
The :class:`~configdeck.Section` object where this option was
defined.
...
..  attribute:: ListOption.item
    ...
    *Required*.
    ...
    instance of a subclass of :class:`~configdeck.schema.Option`.
...
..  attribute:: DictOption.spec
    ...
    *Optional*.
    ...
    :class:`~configdeck.schema.Option`.

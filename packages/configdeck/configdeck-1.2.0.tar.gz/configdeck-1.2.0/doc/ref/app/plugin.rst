...
..  module:: configdeck.app.plugin
    :synopsis: Base classes for plugins and plugin managers.

..  currentmodule:: configdeck.app

This document contains details about the base classes provided by configdeck
...
integrate with your configdeck-enabled application.
...
..  attribute:: Plugin.schema
    ...
    By default a standard :class:`~configdeck.schema.Schema` is used.

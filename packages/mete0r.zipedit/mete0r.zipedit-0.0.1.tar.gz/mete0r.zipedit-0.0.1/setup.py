...
@setup_dir
def get_version():
    from mete0r_zipedit import __version__
    return __version__
...
setup_info = {
    ...
    # 'url': 'https://github.com/mete0r/mete0r.zipedit',

    'packages': [
        'mete0r_zipedit',
        'mete0r_zipedit.tests',
        'mete0r_zipedit.tests.fixtures',
        'mete0r_zipedit.tests.layers',
    ],

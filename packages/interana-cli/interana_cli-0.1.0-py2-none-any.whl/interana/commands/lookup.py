...
class LookupHandler(CommandHandler):
    ...
    def __init__(self):
        ...
        self.register_subcommand(LookupCreate())
        self.register_subcommand(LookupList())
        self.register_subcommand(LookupUpdate())
        self.register_subcommand(LookupDelete())
        self.register_subcommand(LookupRestore())
        self.register_subcommand(LookupAttach())
        self.register_subcommand(LookupDetach())

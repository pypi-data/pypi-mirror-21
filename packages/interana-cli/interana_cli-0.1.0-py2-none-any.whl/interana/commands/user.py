...
class UserHandler(CommandHandler):
    ...
    def __init__(self):
        ...
        self.register_subcommand(CreateUser())
        self.register_subcommand(EnableUser())
        self.register_subcommand(DisableUser())
        self.register_subcommand(ListUsers())
        self.register_subcommand(UpdateUser())
...
class ListUsers(SubCommandHandler):
    ...
    def do(self):
        ...
        return DoResult(entries=[[user['user_id'], user['username'], user['enabled'],
                                  ','.join(user['roles'])] for user in users_res],
                        headers=['User ID', 'Username', 'Enabled', 'Roles'])

...
from .sessionbuilder import SessionBuilder, ProjectAssistantAuthenticationError, default_app_data_dir
...
def build_session(environment = 'production', jwt_path = None):
    jwt_path = jwt_path or os.path.join(default_app_data_dir(), 'jwt')

...
setup(
    ...
    description='Tools for creating and managing manhattan projects.',
    long_description=long_description,

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_project',
    ...
    packages=find_packages('manhattan_project'),
    package_dir={'': 'manhattan_project'},
    ...
    entry_points='''
        [console_scripts]
        manhattan=manhattan.project:cli
        ''',
)

...
(0 minutes 1.839 seconds)



.. container:: sphx-glr-download

    **Download Python source code:** :download:`plot_adapt_rgb.py <plot_adapt_rgb.py>`


.. container:: sphx-glr-download

    **Download IPython notebook:** :download:`plot_adapt_rgb.ipynb <plot_adapt_rgb.ipynb>`

...
if __name__ == '__main__':
    ...
    groupA.add_argument(
        '--enable', '--on', metavar="IDX",
        help='Enable relais (comma separated of indices)',
        default=[], action='append', dest="relais_on")
    groupA.add_argument(
        '--disable', '--off', metavar="IDX",
        help='Disable relais (comma separated of indices)',
        default=[], action='append', dest="relais_off")

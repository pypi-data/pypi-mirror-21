...
class Folder(Widgets.QWidget):
    ...
    def __init__(self, parent=None, title='', animationDuration=100):
        ...
        toggleAnimation.addAnimation(
            QtCore.QPropertyAnimation(self, str("minimumHeight"))
        )
        toggleAnimation.addAnimation(
            QtCore.QPropertyAnimation(self, str("maximumHeight"))
        )
        toggleAnimation.addAnimation(
            QtCore.QPropertyAnimation(self.contentArea, str("maximumHeight"))
        )
        # don't waste space
